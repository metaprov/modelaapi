...
_CREATEDATAPRODUCTVERSIONREQUEST = _descriptor.Descriptor(
  ...
  nested_types=[_CREATEDATAPRODUCTVERSIONREQUEST_LABELSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_UPDATEDATAPRODUCTVERSIONREQUEST = _descriptor.Descriptor(
  ...
  nested_types=[_UPDATEDATAPRODUCTVERSIONREQUEST_LABELSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CREATEDATAPRODUCTVERSIONREQUEST_LABELSENTRY.containing_type = _CREATEDATAPRODUCTVERSIONREQUEST
_CREATEDATAPRODUCTVERSIONREQUEST.fields_by_name['labels'].message_type = _CREATEDATAPRODUCTVERSIONREQUEST_LABELSENTRY
_CREATEDATAPRODUCTVERSIONREQUEST.fields_by_name['spec'].message_type = github_dot_com_dot_metaprov_dot_modeldapi_dot_pkg_dot_apis_dot_data_dot_v1alpha1_dot_generated__pb2._DATAPRODUCTVERSIONSPEC
_UPDATEDATAPRODUCTVERSIONREQUEST_LABELSENTRY.containing_type = _UPDATEDATAPRODUCTVERSIONREQUEST
_UPDATEDATAPRODUCTVERSIONREQUEST.fields_by_name['labels'].message_type = _UPDATEDATAPRODUCTVERSIONREQUEST_LABELSENTRY
_UPDATEDATAPRODUCTVERSIONREQUEST.fields_by_name['spec'].message_type = github_dot_com_dot_metaprov_dot_modeldapi_dot_pkg_dot_apis_dot_data_dot_v1alpha1_dot_generated__pb2._DATAPRODUCTVERSIONSPEC
...
_CREATEDATAPRODUCTVERSIONREQUEST_LABELSENTRY._options = None
_UPDATEDATAPRODUCTVERSIONREQUEST_LABELSENTRY._options = None
