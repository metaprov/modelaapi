...
_PREDICTIONSINGESTREQUEST = _descriptor.Descriptor(
  ...
  full_name='github.com.metaprov.modeld.services.predictionstore.v1.PredictionsIngestRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='dataset', full_name='github.com.metaprov.modeld.services.predictionstore.v1.PredictionsIngestRequest.dataset', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='key', full_name='github.com.metaprov.modeld.services.predictionstore.v1.PredictionsIngestRequest.key', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='connection', full_name='github.com.metaprov.modeld.services.predictionstore.v1.PredictionsIngestRequest.connection', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='secret', full_name='github.com.metaprov.modeld.services.predictionstore.v1.PredictionsIngestRequest.secret', index=3,
...
_PREDICTIONINGESTRESPONSE = _descriptor.Descriptor(
  ...
  full_name='github.com.metaprov.modeld.services.predictionstore.v1.PredictionIngestResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
PredictionsIngestRequest = _reflection.GeneratedProtocolMessageType('PredictionsIngestRequest', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:github.com.metaprov.modeld.services.predictionstore.v1.PredictionsIngestRequest)
  })
...
PredictionIngestResponse = _reflection.GeneratedProtocolMessageType('PredictionIngestResponse', (_message.Message,), {
  ...
  '__module__' : 'github.com.metaprov.modeldapi.services.predictionstore.v1.predictionstore_pb2'
  # @@protoc_insertion_point(class_scope:github.com.metaprov.modeld.services.predictionstore.v1.PredictionIngestResponse)
  })
...
_PREDICTIONSTORESERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='github.com.metaprov.modeld.services.predictionstore.v1.PredictionStoreService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Ingest',
    full_name='github.com.metaprov.modeld.services.predictionstore.v1.PredictionStoreService.Ingest',
    index=0,
