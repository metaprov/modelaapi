...
_CRONPREDICTIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002-\032(/v1/cronpredictions/{item.metadata.name}:\001*',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002.\",/v1/cronpredictions/{item.metadata.name}:run',
    create_key=_descriptor._internal_create_key,
  ),
])
