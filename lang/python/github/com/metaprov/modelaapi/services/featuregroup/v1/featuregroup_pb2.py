...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z6github.com/metaprov/modelaapi/services/featuregroup/v1'
  _globals['_LISTFEATUREGROUPREQUEST_LABELSENTRY']._loaded_options = None
  _globals['_LISTFEATUREGROUPREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['ListFeatureGroups']._loaded_options = None
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['ListFeatureGroups']._serialized_options = b'\202\323\344\223\002\037\022\035/v1/featuregroups/{namespace}'
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['CreateFeatureGroup']._loaded_options = None
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['CreateFeatureGroup']._serialized_options = b'\202\323\344\223\002\026\"\021/v1/featuregroups:\001*'
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['GetFeatureGroup']._loaded_options = None
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['GetFeatureGroup']._serialized_options = b'\202\323\344\223\002&\022$/v1/featuregroups/{namespace}/{name}'
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['UpdateFeatureGroup']._loaded_options = None
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['UpdateFeatureGroup']._serialized_options = b'\202\323\344\223\002U\032P/v1/featuregroups/{featuregroup.metadata.namespace}/{featuregroup.metadata.name}:\001*'
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['DeleteFeatureGroup']._loaded_options = None
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['DeleteFeatureGroup']._serialized_options = b'\202\323\344\223\002&*$/v1/featuregroups/{namespace}/{name}'
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['PauseFeatureGroup']._loaded_options = None
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['PauseFeatureGroup']._serialized_options = b'\202\323\344\223\002,\"*/v1/featuregroups/{namespace}/{name}:pause'
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['ResumeFeatureGroup']._loaded_options = None
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['ResumeFeatureGroup']._serialized_options = b'\202\323\344\223\002-\"+/v1/featuregroups/{namespace}/{name}:resume'
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['IngestNow']._loaded_options = None
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['IngestNow']._serialized_options = b'\202\323\344\223\002,\"*/v1/modelclasses/{namespace}/{name}/ingest'
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['SyncNow']._loaded_options = None
  _globals['_FEATUREGROUPSERVICE'].methods_by_name['SyncNow']._serialized_options = b'\202\323\344\223\002*\"(/v1/modelclasses/{namespace}/{name}/sync'
