...
_MODELPIPELINESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0026\0321/api/v1alpha1/modelpipelines/{item.metadata.name}:\001*',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002K\"I/api/v1/modelpipelines/{item.metadata.namespace}/{item.metadata.name}:run',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
