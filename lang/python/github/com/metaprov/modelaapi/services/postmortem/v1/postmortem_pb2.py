...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'github.com.metaprov.modelaapi.services.postmortem.v1.postmortem_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'Z4github.com/metaprov/modelaapi/services/postmortem/v1'
  _globals['_LISTPOSTMORTEMSREQUEST_LABELSENTRY']._loaded_options = None
  _globals['_LISTPOSTMORTEMSREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_POSTMORTEMSERVICE'].methods_by_name['ListPostMortems']._loaded_options = None
  _globals['_POSTMORTEMSERVICE'].methods_by_name['ListPostMortems']._serialized_options = b'\202\323\344\223\002\035\022\033/v1/postmortems/{namespace}'
  _globals['_POSTMORTEMSERVICE'].methods_by_name['CreatePostMortem']._loaded_options = None
  _globals['_POSTMORTEMSERVICE'].methods_by_name['CreatePostMortem']._serialized_options = b'\202\323\344\223\002\024\"\017/v1/postmortems:\001*'
  _globals['_POSTMORTEMSERVICE'].methods_by_name['GetPostMortem']._loaded_options = None
  _globals['_POSTMORTEMSERVICE'].methods_by_name['GetPostMortem']._serialized_options = b'\202\323\344\223\002$\022\"/v1/postmortems/{namespace}/{name}'
  _globals['_POSTMORTEMSERVICE'].methods_by_name['UpdatePostMortem']._loaded_options = None
  _globals['_POSTMORTEMSERVICE'].methods_by_name['UpdatePostMortem']._serialized_options = b'\202\323\344\223\002O\032J/v1/postmortems/{postmortem.metadata.namespace}/{postmortem.metadata.name}:\001*'
  _globals['_POSTMORTEMSERVICE'].methods_by_name['DeletePostMortem']._loaded_options = None
  _globals['_POSTMORTEMSERVICE'].methods_by_name['DeletePostMortem']._serialized_options = b'\202\323\344\223\002$*\"/v1/postmortems/{namespace}/{name}'
  _globals['_LISTPOSTMORTEMSREQUEST']._serialized_start=262
  _globals['_LISTPOSTMORTEMSREQUEST']._serialized_end=515
  _globals['_LISTPOSTMORTEMSREQUEST_LABELSENTRY']._serialized_start=470
  _globals['_LISTPOSTMORTEMSREQUEST_LABELSENTRY']._serialized_end=515
  _globals['_LISTPOSTMORTEMSRESPONSE']._serialized_start=518
  _globals['_LISTPOSTMORTEMSRESPONSE']._serialized_end=659
  _globals['_CREATEPOSTMORTEMREQUEST']._serialized_start=661
  _globals['_CREATEPOSTMORTEMREQUEST']._serialized_end=772
  _globals['_CREATEPOSTMORTEMRESPONSE']._serialized_start=774
  _globals['_CREATEPOSTMORTEMRESPONSE']._serialized_end=800
  _globals['_UPDATEPOSTMORTEMREQUEST']._serialized_start=803
  _globals['_UPDATEPOSTMORTEMREQUEST']._serialized_end=962
  _globals['_UPDATEPOSTMORTEMRESPONSE']._serialized_start=964
  _globals['_UPDATEPOSTMORTEMRESPONSE']._serialized_end=990
  _globals['_GETPOSTMORTEMREQUEST']._serialized_start=992
  _globals['_GETPOSTMORTEMREQUEST']._serialized_end=1047
  _globals['_GETPOSTMORTEMRESPONSE']._serialized_start=1049
  _globals['_GETPOSTMORTEMRESPONSE']._serialized_end=1172
  _globals['_DELETEPOSTMORTEMREQUEST']._serialized_start=1174
  _globals['_DELETEPOSTMORTEMREQUEST']._serialized_end=1232
  _globals['_DELETEPOSTMORTEMRESPONSE']._serialized_start=1234
  _globals['_DELETEPOSTMORTEMRESPONSE']._serialized_end=1260
  _globals['_POSTMORTEMSERVICE']._serialized_start=1263
  _globals['_POSTMORTEMSERVICE']._serialized_end=2410
