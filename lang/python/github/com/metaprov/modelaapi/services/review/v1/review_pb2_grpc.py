...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in github.com/metaprov/modelaapi/services/review/v1/review_pb2_grpc.py depends on'
...
def add_ReviewServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('github.com.metaprov.modelaapi.services.review.v1.ReviewService', rpc_method_handlers)
