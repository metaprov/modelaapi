...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _DATASETSERVICE.methods_by_name['SnapshotDataset']._options = None
  _DATASETSERVICE.methods_by_name['SnapshotDataset']._serialized_options = b'\202\323\344\223\002*\"(/v1/datasets/{namespace}/{name}:snapshot'
