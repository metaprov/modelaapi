...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in github.com/metaprov/modelaapi/services/predictionstore/v1/predictionstore_pb2_grpc.py depends on'
...
def add_PredictionStoreServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('github.com.metaprov.modelaapi.services.predictionstore.v1.PredictionStoreService', rpc_method_handlers)
