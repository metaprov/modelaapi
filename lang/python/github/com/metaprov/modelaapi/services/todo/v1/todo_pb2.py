...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'github.com.metaprov.modelaapi.services.todo.v1.todo_pb2', _globals)
if _descriptor._USE_C_DESCRIPTORS == False:
  _globals['DESCRIPTOR']._options = None
  _globals['DESCRIPTOR']._serialized_options = b'Z.github.com/metaprov/modelaapi/services/todo/v1'
  _globals['_LISTTODOSREQUEST_LABELSENTRY']._options = None
  _globals['_LISTTODOSREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_TODOSERVICE'].methods_by_name['ListTodos']._options = None
  _globals['_TODOSERVICE'].methods_by_name['ListTodos']._serialized_options = b'\202\323\344\223\002\027\022\025/v1/todos/{namespace}'
  _globals['_TODOSERVICE'].methods_by_name['CreateTodo']._options = None
  _globals['_TODOSERVICE'].methods_by_name['CreateTodo']._serialized_options = b'\202\323\344\223\002\016\"\t/v1/todos:\001*'
  _globals['_TODOSERVICE'].methods_by_name['GetTodo']._options = None
  _globals['_TODOSERVICE'].methods_by_name['GetTodo']._serialized_options = b'\202\323\344\223\002\036\022\034/v1/todos/{namespace}/{name}'
  _globals['_TODOSERVICE'].methods_by_name['UpdateTodo']._options = None
  _globals['_TODOSERVICE'].methods_by_name['UpdateTodo']._serialized_options = b'\202\323\344\223\002=\0328/v1/todos/{todo.metadata.namespace}/{todo.metadata.name}:\001*'
  _globals['_TODOSERVICE'].methods_by_name['DeleteTodo']._options = None
  _globals['_TODOSERVICE'].methods_by_name['DeleteTodo']._serialized_options = b'\202\323\344\223\002\036*\034/v1/todos/{namespace}/{name}'
  _globals['_LISTTODOSREQUEST']._serialized_start=307
  _globals['_LISTTODOSREQUEST']._serialized_end=485
  _globals['_LISTTODOSREQUEST_LABELSENTRY']._serialized_start=440
  _globals['_LISTTODOSREQUEST_LABELSENTRY']._serialized_end=485
  _globals['_LISTTODOSRESPONSE']._serialized_start=487
  _globals['_LISTTODOSRESPONSE']._serialized_end=610
  _globals['_CREATETODOREQUEST']._serialized_start=612
  _globals['_CREATETODOREQUEST']._serialized_end=723
  _globals['_CREATETODORESPONSE']._serialized_start=725
  _globals['_CREATETODORESPONSE']._serialized_end=745
  _globals['_UPDATETODOREQUEST']._serialized_start=748
  _globals['_UPDATETODOREQUEST']._serialized_end=889
  _globals['_UPDATETODORESPONSE']._serialized_start=891
  _globals['_UPDATETODORESPONSE']._serialized_end=911
  _globals['_GETTODOREQUEST']._serialized_start=913
  _globals['_GETTODOREQUEST']._serialized_end=962
  _globals['_GETTODORESPONSE']._serialized_start=964
  _globals['_GETTODORESPONSE']._serialized_end=1069
  _globals['_DELETETODOREQUEST']._serialized_start=1071
  _globals['_DELETETODOREQUEST']._serialized_end=1123
  _globals['_DELETETODORESPONSE']._serialized_start=1125
  _globals['_DELETETODORESPONSE']._serialized_end=1145
  _globals['_TODOSERVICE']._serialized_start=1148
  _globals['_TODOSERVICE']._serialized_end=2097
