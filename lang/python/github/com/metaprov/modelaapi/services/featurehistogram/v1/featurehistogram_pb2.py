...
_FEATUREHISTOGRAMSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002b\032]/v1/featurehistograms/{featurehistorgram.metadata.namespace}/{featurehistogram.metadata.name}:\001*',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
