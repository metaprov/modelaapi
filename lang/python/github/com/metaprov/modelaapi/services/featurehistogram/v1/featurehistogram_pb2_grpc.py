...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in github.com/metaprov/modelaapi/services/featurehistogram/v1/featurehistogram_pb2_grpc.py depends on'
...
def add_FeatureHistogramServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('github.com.metaprov.modelaapi.services.featurehistogram.v1.FeatureHistogramService', rpc_method_handlers)
