...
_COLUMNPROFILE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='outliers', full_name='github.com.metaprov.modelaapi.services.common.v1.ColumnProfile.outliers', index=42,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='completeness', full_name='github.com.metaprov.modelaapi.services.common.v1.ColumnProfile.completeness', index=43,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='distinctValueCount', full_name='github.com.metaprov.modelaapi.services.common.v1.ColumnProfile.distinctValueCount', index=44,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mostFreqValuesRatio', full_name='github.com.metaprov.modelaapi.services.common.v1.ColumnProfile.mostFreqValuesRatio', index=45,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='indexOfPeculiarity', full_name='github.com.metaprov.modelaapi.services.common.v1.ColumnProfile.indexOfPeculiarity', index=46,
