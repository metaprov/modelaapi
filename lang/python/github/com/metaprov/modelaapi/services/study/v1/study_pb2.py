...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'github.com.metaprov.modelaapi.services.study.v1.study_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'Z/github.com/metaprov/modelaapi/services/study/v1'
  _globals['_LISTSTUDYREQUEST_LABELSENTRY']._loaded_options = None
  _globals['_LISTSTUDYREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_STUDYSERVICE'].methods_by_name['ListStudies']._loaded_options = None
  _globals['_STUDYSERVICE'].methods_by_name['ListStudies']._serialized_options = b'\202\323\344\223\002\031\022\027/v1/studies/{namespace}'
  _globals['_STUDYSERVICE'].methods_by_name['CreateStudy']._loaded_options = None
  _globals['_STUDYSERVICE'].methods_by_name['CreateStudy']._serialized_options = b'\202\323\344\223\002\020\"\013/v1/studies:\001*'
  _globals['_STUDYSERVICE'].methods_by_name['GetStudy']._loaded_options = None
  _globals['_STUDYSERVICE'].methods_by_name['GetStudy']._serialized_options = b'\202\323\344\223\002 \022\036/v1/studies/{namespace}/{name}'
  _globals['_STUDYSERVICE'].methods_by_name['GetStudyRun']._loaded_options = None
  _globals['_STUDYSERVICE'].methods_by_name['GetStudyRun']._serialized_options = b'\202\323\344\223\002=\022;/v1/datasets/{namespace}/{run.study}/versions/{run.version}'
  _globals['_STUDYSERVICE'].methods_by_name['UpdateStudy']._loaded_options = None
  _globals['_STUDYSERVICE'].methods_by_name['UpdateStudy']._serialized_options = b'\202\323\344\223\002A\032</v1/studies/{study.metadata.namespace}/{study.metadata.name}:\001*'
  _globals['_STUDYSERVICE'].methods_by_name['DeleteStudy']._loaded_options = None
  _globals['_STUDYSERVICE'].methods_by_name['DeleteStudy']._serialized_options = b'\202\323\344\223\002 *\036/v1/studies/{namespace}/{name}'
  _globals['_STUDYSERVICE'].methods_by_name['GetStudyProfile']._loaded_options = None
  _globals['_STUDYSERVICE'].methods_by_name['GetStudyProfile']._serialized_options = b'\202\323\344\223\002-\022+/v1/studies/{namespace}/{run.study}:profile'
  _globals['_STUDYSERVICE'].methods_by_name['AbortStudy']._loaded_options = None
  _globals['_STUDYSERVICE'].methods_by_name['AbortStudy']._serialized_options = b'\202\323\344\223\002+\")/v1/studies/{namespace}/{run.study}:abort'
  _globals['_STUDYSERVICE'].methods_by_name['PauseStudy']._loaded_options = None
  _globals['_STUDYSERVICE'].methods_by_name['PauseStudy']._serialized_options = b'\202\323\344\223\002+\")/v1/studies/{namespace}/{run.study}:pause'
  _globals['_STUDYSERVICE'].methods_by_name['ResumeStudy']._loaded_options = None
  _globals['_STUDYSERVICE'].methods_by_name['ResumeStudy']._serialized_options = b'\202\323\344\223\002,\"*/v1/studies/{namespace}/{run.study}:resume'
  _globals['_STUDYSERVICE'].methods_by_name['CompleteStudySearch']._loaded_options = None
  _globals['_STUDYSERVICE'].methods_by_name['CompleteStudySearch']._serialized_options = b'\202\323\344\223\002.\",/v1/studies/{namespace}/{run.study}:complete'
  _globals['_LISTSTUDYREQUEST']._serialized_start=387
  _globals['_LISTSTUDYREQUEST']._serialized_end=566
  _globals['_LISTSTUDYREQUEST_LABELSENTRY']._serialized_start=521
  _globals['_LISTSTUDYREQUEST_LABELSENTRY']._serialized_end=566
  _globals['_LISTSTUDYRESPONSE']._serialized_start=569
  _globals['_LISTSTUDYRESPONSE']._serialized_end=699
  _globals['_GETSTUDYREQUEST']._serialized_start=701
  _globals['_GETSTUDYREQUEST']._serialized_end=751
  _globals['_GETSTUDYRESPONSE']._serialized_start=753
  _globals['_GETSTUDYRESPONSE']._serialized_end=865
  _globals['_GETSTUDYRUNREFERENCEREQUEST']._serialized_start=868
  _globals['_GETSTUDYRUNREFERENCEREQUEST']._serialized_end=1005
  _globals['_GETSTUDYRUNREFERENCERESPONSE']._serialized_start=1007
  _globals['_GETSTUDYRUNREFERENCERESPONSE']._serialized_end=1118
  _globals['_DELETESTUDYREQUEST']._serialized_start=1120
  _globals['_DELETESTUDYREQUEST']._serialized_end=1173
  _globals['_DELETESTUDYRESPONSE']._serialized_start=1175
  _globals['_DELETESTUDYRESPONSE']._serialized_end=1196
  _globals['_CREATESTUDYREQUEST']._serialized_start=1198
  _globals['_CREATESTUDYREQUEST']._serialized_end=1298
  _globals['_CREATESTUDYRESPONSE']._serialized_start=1300
  _globals['_CREATESTUDYRESPONSE']._serialized_end=1321
  _globals['_UPDATESTUDYREQUEST']._serialized_start=1324
  _globals['_UPDATESTUDYREQUEST']._serialized_end=1472
  _globals['_UPDATESTUDYRESPONSE']._serialized_start=1474
  _globals['_UPDATESTUDYRESPONSE']._serialized_end=1495
  _globals['_GETSTUDYPROFILEREQUEST']._serialized_start=1498
  _globals['_GETSTUDYPROFILEREQUEST']._serialized_end=1646
  _globals['_GETSTUDYPROFILERESPONSE']._serialized_start=1649
  _globals['_GETSTUDYPROFILERESPONSE']._serialized_end=1842
  _globals['_ABORTSTUDYREQUEST']._serialized_start=1844
  _globals['_ABORTSTUDYREQUEST']._serialized_end=1971
  _globals['_ABORTSTUDYRESPONSE']._serialized_start=1973
  _globals['_ABORTSTUDYRESPONSE']._serialized_end=1993
  _globals['_PAUSESTUDYREQUEST']._serialized_start=1995
  _globals['_PAUSESTUDYREQUEST']._serialized_end=2122
  _globals['_PAUSESTUDYRESPONSE']._serialized_start=2124
  _globals['_PAUSESTUDYRESPONSE']._serialized_end=2161
  _globals['_RESUMESTUDYREQUEST']._serialized_start=2164
  _globals['_RESUMESTUDYREQUEST']._serialized_end=2292
  _globals['_RESUMESTUDYRESPONSE']._serialized_start=2294
  _globals['_RESUMESTUDYRESPONSE']._serialized_end=2315
  _globals['_COMPLETESTUDYSEARCHREQUEST']._serialized_start=2318
  _globals['_COMPLETESTUDYSEARCHREQUEST']._serialized_end=2454
  _globals['_COMPLETESTUDYSEARCHRESPONSE']._serialized_start=2456
  _globals['_COMPLETESTUDYSEARCHRESPONSE']._serialized_end=2502
  _globals['_STUDYSERVICE']._serialized_start=2505
  _globals['_STUDYSERVICE']._serialized_end=4799
