...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in github.com/metaprov/modelaapi/services/study/v1/study_pb2_grpc.py depends on'
...
def add_StudyServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('github.com.metaprov.modelaapi.services.study.v1.StudyService', rpc_method_handlers)
