...
class PublishModelRequest(_message.Message):
    __slots__ = ["dataproduct", "dataproductversion", "model", "study", "datasource", "dataset", "provider", "imagename", "imagenameWithVersion", "push", "bucket", "cloudConn", "cloudSecret", "dockerConnection", "dockerRegistrySecret", "kaniko"]
...
class PackageModelRequest(_message.Message):
    __slots__ = ["dataproduct", "dataproductversion", "model", "study", "datasource", "dataset", "bucket", "cloudConn", "cloudSecret"]
    class CloudSecretEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
