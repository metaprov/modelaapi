...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in github.com/metaprov/modelaapi/services/publisherd/v1/publisherd_pb2_grpc.py depends on'
...
def add_PublisherdServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('github.com.metaprov.modelaapi.services.publisherd.v1.PublisherdService', rpc_method_handlers)
