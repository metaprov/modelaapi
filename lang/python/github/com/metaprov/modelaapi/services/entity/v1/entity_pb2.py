...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'github.com.metaprov.modelaapi.services.entity.v1.entity_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'Z0github.com/metaprov/modelaapi/services/entity/v1'
  _globals['_LISTENTITIESREQUEST_LABELSENTRY']._loaded_options = None
  _globals['_LISTENTITIESREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_ENTITYSERVICE'].methods_by_name['ListEntities']._loaded_options = None
  _globals['_ENTITYSERVICE'].methods_by_name['ListEntities']._serialized_options = b'\202\323\344\223\002\032\022\030/v1/entities/{namespace}'
  _globals['_ENTITYSERVICE'].methods_by_name['CreateEntity']._loaded_options = None
  _globals['_ENTITYSERVICE'].methods_by_name['CreateEntity']._serialized_options = b'\202\323\344\223\002\021\"\014/v1/entities:\001*'
  _globals['_ENTITYSERVICE'].methods_by_name['GetEntity']._loaded_options = None
  _globals['_ENTITYSERVICE'].methods_by_name['GetEntity']._serialized_options = b'\202\323\344\223\002\025\022\023/v1/entities/{name}'
  _globals['_ENTITYSERVICE'].methods_by_name['UpdateEntity']._loaded_options = None
  _globals['_ENTITYSERVICE'].methods_by_name['UpdateEntity']._serialized_options = b'\202\323\344\223\002D\032?/v1/entities/{entity.metadata.namespace}/{entity.metadata.name}:\001*'
  _globals['_ENTITYSERVICE'].methods_by_name['DeleteEntity']._loaded_options = None
  _globals['_ENTITYSERVICE'].methods_by_name['DeleteEntity']._serialized_options = b'\202\323\344\223\002!*\037/v1/entities/{namespace}/{name}'
  _globals['_LISTENTITIESREQUEST']._serialized_start=250
  _globals['_LISTENTITIESREQUEST']._serialized_end=493
  _globals['_LISTENTITIESREQUEST_LABELSENTRY']._serialized_start=448
  _globals['_LISTENTITIESREQUEST_LABELSENTRY']._serialized_end=493
  _globals['_LISTENTITIESRESPONSE']._serialized_start=496
  _globals['_LISTENTITIESRESPONSE']._serialized_end=627
  _globals['_CREATEENTITYREQUEST']._serialized_start=629
  _globals['_CREATEENTITYREQUEST']._serialized_end=728
  _globals['_CREATEENTITYRESPONSE']._serialized_start=730
  _globals['_CREATEENTITYRESPONSE']._serialized_end=752
  _globals['_UPDATEENTITYREQUEST']._serialized_start=755
  _globals['_UPDATEENTITYREQUEST']._serialized_end=902
  _globals['_UPDATEENTITYRESPONSE']._serialized_start=904
  _globals['_UPDATEENTITYRESPONSE']._serialized_end=926
  _globals['_GETENTITYREQUEST']._serialized_start=928
  _globals['_GETENTITYREQUEST']._serialized_end=1027
  _globals['_GETENTITYRESPONSE']._serialized_start=1029
  _globals['_GETENTITYRESPONSE']._serialized_end=1140
  _globals['_DELETEENTITYREQUEST']._serialized_start=1142
  _globals['_DELETEENTITYREQUEST']._serialized_end=1196
  _globals['_DELETEENTITYRESPONSE']._serialized_start=1198
  _globals['_DELETEENTITYRESPONSE']._serialized_end=1220
  _globals['_ENTITYSERVICE']._serialized_start=1223
  _globals['_ENTITYSERVICE']._serialized_end=2234
