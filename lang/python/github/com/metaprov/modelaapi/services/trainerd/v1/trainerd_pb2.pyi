...
class TrainRequest(_message.Message):
    __slots__ = ["product", "bucket", "model", "study", "datasource", "dataset", "baseModels"]
...
class TrainDriftDetectorRequest(_message.Message):
    __slots__ = ["product", "bucket", "base", "model", "study", "datasource", "dataset"]
    PRODUCT_FIELD_NUMBER: _ClassVar[int]
    BUCKET_FIELD_NUMBER: _ClassVar[int]
...
class ForecastRequest(_message.Message):
    __slots__ = ["product", "bucket", "model", "study", "datasource", "dataset"]
    PRODUCT_FIELD_NUMBER: _ClassVar[int]
    BUCKET_FIELD_NUMBER: _ClassVar[int]
    MODEL_FIELD_NUMBER: _ClassVar[int]
    STUDY_FIELD_NUMBER: _ClassVar[int]
