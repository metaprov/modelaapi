...
_EXPLAINRESPONSE_SHAPFEATURESIMPORTANCEENTRY = _descriptor.Descriptor(
  name='ShapFeaturesImportanceEntry',
  full_name='github.com.metaprov.modelaapi.services.trainerd.v1.ExplainResponse.ShapFeaturesImportanceEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='github.com.metaprov.modelaapi.services.trainerd.v1.ExplainResponse.ShapFeaturesImportanceEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='github.com.metaprov.modelaapi.services.trainerd.v1.ExplainResponse.ShapFeaturesImportanceEntry.value', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXPLAINRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='explainerUri', full_name='github.com.metaprov.modelaapi.services.trainerd.v1.ExplainResponse.explainerUri', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='trainShapValuesUri', full_name='github.com.metaprov.modelaapi.services.trainerd.v1.ExplainResponse.trainShapValuesUri', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='testShapValuesUri', full_name='github.com.metaprov.modelaapi.services.trainerd.v1.ExplainResponse.testShapValuesUri', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='shapFeaturesImportance', full_name='github.com.metaprov.modelaapi.services.trainerd.v1.ExplainResponse.shapFeaturesImportance', index=3,
  ...
  nested_types=[_EXPLAINRESPONSE_SHAPFEATURESIMPORTANCEENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_EXPLAINRESPONSE_SHAPFEATURESIMPORTANCEENTRY.containing_type = _EXPLAINRESPONSE
_EXPLAINRESPONSE.fields_by_name['shapFeaturesImportance'].message_type = _EXPLAINRESPONSE_SHAPFEATURESIMPORTANCEENTRY
