...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in github.com/metaprov/modelaapi/services/genai/v1/genai_pb2_grpc.py depends on'
...
def add_GenAIServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('GenAIService', rpc_method_handlers)
