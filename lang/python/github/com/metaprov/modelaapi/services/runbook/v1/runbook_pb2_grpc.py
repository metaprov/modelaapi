...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in github.com/metaprov/modelaapi/services/runbook/v1/runbook_pb2_grpc.py depends on'
...
def add_RunBookServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('github.com.metaprov.modelaapi.services.runbook.v1.RunBookService', rpc_method_handlers)
