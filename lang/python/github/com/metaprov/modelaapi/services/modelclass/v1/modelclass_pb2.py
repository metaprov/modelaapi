...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_LISTMODELCLASSREQUEST_LABELSENTRY']._loaded_options = None
  _globals['_LISTMODELCLASSREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_MODELCLASSSERVICE'].methods_by_name['ListModelClasses']._loaded_options = None
  _globals['_MODELCLASSSERVICE'].methods_by_name['ListModelClasses']._serialized_options = b'\202\323\344\223\002\036\022\034/v1/modelclasses/{namespace}'
  _globals['_MODELCLASSSERVICE'].methods_by_name['CreateModelClass']._loaded_options = None
  _globals['_MODELCLASSSERVICE'].methods_by_name['CreateModelClass']._serialized_options = b'\202\323\344\223\002\025\"\020/v1/modelclasses:\001*'
  _globals['_MODELCLASSSERVICE'].methods_by_name['GetModelClass']._loaded_options = None
  _globals['_MODELCLASSSERVICE'].methods_by_name['GetModelClass']._serialized_options = b'\202\323\344\223\002%\022#/v1/modelclasses/{namespace}/{name}'
  _globals['_MODELCLASSSERVICE'].methods_by_name['UpdateModelClass']._loaded_options = None
  _globals['_MODELCLASSSERVICE'].methods_by_name['UpdateModelClass']._serialized_options = b'\202\323\344\223\002K\032F/v1/studies/{modelclass.metadata.namespace}/{modelclass.metadata.name}:\001*'
  _globals['_MODELCLASSSERVICE'].methods_by_name['DeleteModelClass']._loaded_options = None
  _globals['_MODELCLASSSERVICE'].methods_by_name['DeleteModelClass']._serialized_options = b'\202\323\344\223\002%*#/v1/modelclasses/{namespace}/{name}'
  _globals['_MODELCLASSSERVICE'].methods_by_name['CreateModelClassProfile']._loaded_options = None
  _globals['_MODELCLASSSERVICE'].methods_by_name['CreateModelClassProfile']._serialized_options = b'\202\323\344\223\002-\"+/v1/modelclasses/{namespace}/{name}/profile'
  _globals['_MODELCLASSSERVICE'].methods_by_name['TrainNow']._loaded_options = None
  _globals['_MODELCLASSSERVICE'].methods_by_name['TrainNow']._serialized_options = b'\202\323\344\223\002+\")/v1/modelclasses/{namespace}/{name}/train'
  _globals['_MODELCLASSSERVICE'].methods_by_name['PredictNow']._loaded_options = None
  _globals['_MODELCLASSSERVICE'].methods_by_name['PredictNow']._serialized_options = b'\202\323\344\223\002-\"+/v1/modelclasses/{namespace}/{name}/predict'
