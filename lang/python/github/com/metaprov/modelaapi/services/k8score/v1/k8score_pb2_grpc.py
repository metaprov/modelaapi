...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in github.com/metaprov/modelaapi/services/k8score/v1/k8score_pb2_grpc.py depends on'
...
def add_CoreK8sServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('github.com.metaprov.modelaapi.services.k8score.v1.CoreK8sService', rpc_method_handlers)
