...
class DataSplitSpec(_message.Message):
    __slots__ = ["method", "splitColumn", "test", "testDataset", "train", "trainDataset", "validation", "validationDataset"]
...
class FeatureEngineeringPipeline(_message.Message):
    __slots__ = ["columns", "datatype", "datetimeTransformation", "discretisation", "drop", "encoding", "imputation", "name", "outlierHandling", "passthrough", "scaling", "text", "variableTransformation"]
    ...
    def __init__(self, name: _Optional[str] = ..., datatype: _Optional[str] = ..., columns: _Optional[_Iterable[str]] = ..., imputation: _Optional[str] = ..., encoding: _Optional[str] = ..., scaling: _Optional[str] = ..., discretisation: _Optional[str] = ..., variableTransformation: _Optional[str] = ..., outlierHandling: _Optional[str] = ..., datetimeTransformation: _Optional[str] = ..., text: _Optional[_Union[TextPipelineSpec, _Mapping]] = ..., drop: bool = ..., passthrough: bool = ...) -> None: ...

class FeatureEngineeringSearchSpec(_message.Message):
    __slots__ = ["earlyStop", "enabled", "estimator", "featureSelection", "maxModels", "maxTime", "reuse", "trainers"]
    EARLYSTOP_FIELD_NUMBER: _ClassVar[int]
    ENABLED_FIELD_NUMBER: _ClassVar[int]
    ESTIMATOR_FIELD_NUMBER: _ClassVar[int]
    FEATURESELECTION_FIELD_NUMBER: _ClassVar[int]
    ...
    enabled: bool
    estimator: str
    featureSelection: FeatureSelectionSpec
    maxModels: int
    maxTime: int
    reuse: bool
    trainers: int
    def __init__(self, enabled: bool = ..., estimator: _Optional[str] = ..., maxModels: _Optional[int] = ..., maxTime: _Optional[int] = ..., trainers: _Optional[int] = ..., reuse: bool = ..., featureSelection: _Optional[_Union[FeatureSelectionSpec, _Mapping]] = ..., earlyStop: _Optional[_Union[EarlyStopSpec, _Mapping]] = ...) -> None: ...

class FeatureEngineeringSearchStatus(_message.Message):
    __slots__ = ["best"]
    BEST_FIELD_NUMBER: _ClassVar[int]
    best: FeatureEngineeringSpec
    def __init__(self, best: _Optional[_Union[FeatureEngineeringSpec, _Mapping]] = ...) -> None: ...

class FeatureEngineeringSpec(_message.Message):
    __slots__ = ["imbalance", "pipelines", "selection"]
    ...
    def __init__(self, pipelines: _Optional[_Iterable[_Union[FeatureEngineeringPipeline, _Mapping]]] = ..., imbalance: _Optional[str] = ..., selection: _Optional[_Union[FeatureSelectionSpec, _Mapping]] = ...) -> None: ...
...
class GroupSplitLocationsSpec(_message.Message):
    __slots__ = ["groupTestingDataFile", "groupTrainingDataFile"]
...
class SearchSpec(_message.Message):
    __slots__ = ["earlyStop", "goal", "maxModels", "maxScore", "maxTime", "objective", "pruner", "retainTop", "retainedFor", "sampler", "searchSpace", "secondaryObjective", "test", "trainers"]
    EARLYSTOP_FIELD_NUMBER: _ClassVar[int]
...
class StudySpec(_message.Message):
    __slots__ = ["abort", "artifactBucketName", "baseline", "datasetName", "description", "ensembles", "explain", "fast", "feSearch", "forecastTemplate", "gc", "groupLocations", "imbalanceHandler", "interpretability", "labRef", "modelClassName", "modelClassRunName", "modelVersion", "notification", "outlierModel", "owner", "pause", "profile", "report", "schedule", "search", "serving", "subtask", "task", "template", "timeout", "trainingTemplate", "unitTestsTemplate", "versionName"]
    ABORT_FIELD_NUMBER: _ClassVar[int]
    ARTIFACTBUCKETNAME_FIELD_NUMBER: _ClassVar[int]
    BASELINE_FIELD_NUMBER: _ClassVar[int]
    DATASETNAME_FIELD_NUMBER: _ClassVar[int]
    ...
    EXPLAIN_FIELD_NUMBER: _ClassVar[int]
    FAST_FIELD_NUMBER: _ClassVar[int]
    FESEARCH_FIELD_NUMBER: _ClassVar[int]
...
class StudyStatus(_message.Message):
    ...
    bestFeatureEngineering: FeatureEngineeringSpec
    bestModel: str
    bestModelScore: float
    completedAt: _generated_pb2_1_1_1.Time
    conditions: _containers.RepeatedCompositeFieldContainer[_generated_pb2_1_1_1.Condition]
    ...
    failureMessage: str
    failureReason: str
    featureEngineering: StudyPhaseStatus
...
class TrainingSpec(_message.Message):
    __slots__ = ["checkpoint", "cvtype", "evalMetrics", "featureImportance", "folds", "gpu", "labRef", "logLevel", "priority", "resources", "samplePct", "seed", "sh", "split", "timeout"]
