...
class ConnectionSpec(_message.Message):
    __slots__ = ("owner", "category", "provider", "secretData", "options")
    ...
    def __init__(self, owner: _Optional[str] = ..., category: _Optional[str] = ..., provider: _Optional[str] = ..., secretData: _Optional[_Mapping[str, str]] = ..., options: _Optional[_Mapping[str, str]] = ...) -> None: ...
