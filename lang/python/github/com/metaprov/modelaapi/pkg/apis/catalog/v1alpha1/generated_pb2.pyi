...
class RunSchedule(_message.Message):
    __slots__ = ["cron", "enabled", "maxRetryCount", "nextRunAt", "retryDelaySec", "timeoutSec", "timezone", "type"]
    CRON_FIELD_NUMBER: _ClassVar[int]
    ENABLED_FIELD_NUMBER: _ClassVar[int]
...
class RunScheduleStatus(_message.Message):
    __slots__ = ["failureMessage", "failureReason", "lastRunAt", "lastRunLogs", "lastRunName", "retryCount"]
    FAILUREMESSAGE_FIELD_NUMBER: _ClassVar[int]
    FAILUREREASON_FIELD_NUMBER: _ClassVar[int]
