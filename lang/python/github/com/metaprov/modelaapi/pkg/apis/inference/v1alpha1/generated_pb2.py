...
_PREDICTIVEAPPSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='workloadClassName', full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictiveAppSpec.workloadClassName', index=7,
      number=8, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='accessType', full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictiveAppSpec.accessType', index=8,
      number=9, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='productRef', full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictiveAppSpec.productRef', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='servingsiteRef', full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictiveAppSpec.servingsiteRef', index=10,
