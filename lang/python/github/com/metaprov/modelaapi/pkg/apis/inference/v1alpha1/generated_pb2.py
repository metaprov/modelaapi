...
_APPSPEC = _descriptor.Descriptor(
  name='AppSpec',
  full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.AppSpec',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='enabled', full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.AppSpec.enabled', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='port', full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.AppSpec.port', index=1,
...
_APPSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='enabled', full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.AppStatus.enabled', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PREDICTIONSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='conditions', full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictionStatus.conditions', index=8,
...
_PREDICTIVEAPPSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='query', full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictiveAppSpec.query', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PREDICTIVEAPPSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='lastRun', full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictiveAppStatus.lastRun', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='conditions', full_name='github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictiveAppStatus.conditions', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PREDICTIVEAPPSTATUS.fields_by_name['lastRun'].message_type = k8s_dot_io_dot_apimachinery_dot_pkg_dot_apis_dot_meta_dot_v1_dot_generated__pb2._TIME
