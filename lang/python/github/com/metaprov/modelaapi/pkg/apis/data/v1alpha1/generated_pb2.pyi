...
class Correlation(_message.Message):
    __slots__ = ["feature1", "feature2", "method", "value"]
...
class DatasetSpec(_message.Message):
    __slots__ = ["artifactBucketName", "correlation", "dataSourceName", "description", "displayName", "fast", "featureGroupName", "featureGroups", "featurize", "generateFeatureHistogram", "groupBy", "groupLocations", "key", "labRef", "location", "modelClassName", "modelClassRunName", "notification", "origin", "owner", "predictorRef", "report", "resources", "role", "sample", "servingDatasetRef", "subtask", "synthetic", "tags", "task", "timeout", "type", "unitTest", "unitTests", "versionName"]
...
class DatasetStatistics(_message.Message):
    __slots__ = ["cols", "columns", "correlationsWithTarget", "fileSize", "rows", "topCorrelations"]
    COLS_FIELD_NUMBER: _ClassVar[int]
...
class DatasetStatus(_message.Message):
    __slots__ = ["anomaliesLocation", "completedAt", "conditions", "failureMessage", "featureHistogramRef", "groupby", "hash", "images", "imbalanced", "lastStudyAt", "logs", "observedGeneration", "phase", "profileLocation", "progress", "reportLocation", "reportName", "statistics", "unitTestResults", "updatedAt"]
...
class GroupBySpec(_message.Message):
    __slots__ = ["aggr", "enabled", "freq", "groupby", "interval"]
    AGGR_FIELD_NUMBER: _ClassVar[int]
    ENABLED_FIELD_NUMBER: _ClassVar[int]
