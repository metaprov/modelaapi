...
_CREATEPERIODREPORTREQUEST_SECRETENTRY = _descriptor.Descriptor(
  name='SecretEntry',
  full_name='github.com.metaprov.modeldapi.services.data.v1.CreatePeriodReportRequest.SecretEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='github.com.metaprov.modeldapi.services.data.v1.CreatePeriodReportRequest.SecretEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='github.com.metaprov.modeldapi.services.data.v1.CreatePeriodReportRequest.SecretEntry.value', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATEPERIODREPORTREQUEST = _descriptor.Descriptor(
  name='CreatePeriodReportRequest',
  full_name='github.com.metaprov.modeldapi.services.data.v1.CreatePeriodReportRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='product', full_name='github.com.metaprov.modeldapi.services.data.v1.CreatePeriodReportRequest.product', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bucket', full_name='github.com.metaprov.modeldapi.services.data.v1.CreatePeriodReportRequest.bucket', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='connection', full_name='github.com.metaprov.modeldapi.services.data.v1.CreatePeriodReportRequest.connection', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='secret', full_name='github.com.metaprov.modeldapi.services.data.v1.CreatePeriodReportRequest.secret', index=3,
      number=9, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='report', full_name='github.com.metaprov.modeldapi.services.data.v1.CreatePeriodReportRequest.report', index=4,
      number=10, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_CREATEPERIODREPORTREQUEST_SECRETENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CREATEPERIODREPORTREQUEST_SECRETENTRY.containing_type = _CREATEPERIODREPORTREQUEST
_CREATEPERIODREPORTREQUEST.fields_by_name['product'].message_type = github_dot_com_dot_metaprov_dot_modeldapi_dot_pkg_dot_apis_dot_data_dot_v1alpha1_dot_generated__pb2._DATAPRODUCT
_CREATEPERIODREPORTREQUEST.fields_by_name['bucket'].message_type = github_dot_com_dot_metaprov_dot_modeldapi_dot_pkg_dot_apis_dot_infra_dot_v1alpha1_dot_generated__pb2._VIRTUALBUCKET
_CREATEPERIODREPORTREQUEST.fields_by_name['connection'].message_type = github_dot_com_dot_metaprov_dot_modeldapi_dot_pkg_dot_apis_dot_infra_dot_v1alpha1_dot_generated__pb2._CONNECTION
_CREATEPERIODREPORTREQUEST.fields_by_name['secret'].message_type = _CREATEPERIODREPORTREQUEST_SECRETENTRY
_CREATEPERIODREPORTREQUEST.fields_by_name['report'].message_type = github_dot_com_dot_metaprov_dot_modeldapi_dot_pkg_dot_apis_dot_training_dot_v1alpha1_dot_generated__pb2._REPORT
...
DESCRIPTOR.message_types_by_name['CreatePeriodReportRequest'] = _CREATEPERIODREPORTREQUEST
...
CreatePeriodReportRequest = _reflection.GeneratedProtocolMessageType('CreatePeriodReportRequest', (_message.Message,), {

  'SecretEntry' : _reflection.GeneratedProtocolMessageType('SecretEntry', (_message.Message,), {
    'DESCRIPTOR' : _CREATEPERIODREPORTREQUEST_SECRETENTRY,
    '__module__' : 'github.com.metaprov.modeldapi.services.data.v1.data_pb2'
    # @@protoc_insertion_point(class_scope:github.com.metaprov.modeldapi.services.data.v1.CreatePeriodReportRequest.SecretEntry)
    })
  ,
  'DESCRIPTOR' : _CREATEPERIODREPORTREQUEST,
  '__module__' : 'github.com.metaprov.modeldapi.services.data.v1.data_pb2'
  # @@protoc_insertion_point(class_scope:github.com.metaprov.modeldapi.services.data.v1.CreatePeriodReportRequest)
  })
_sym_db.RegisterMessage(CreatePeriodReportRequest)
_sym_db.RegisterMessage(CreatePeriodReportRequest.SecretEntry)
...
_CREATEPERIODREPORTREQUEST_SECRETENTRY._options = None
...
_DATASERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='CreatePreiodReport',
    full_name='github.com.metaprov.modeldapi.services.data.v1.DataService.CreatePreiodReport',
    index=22,
    containing_service=None,
    input_type=_CREATEPERIODREPORTREQUEST,
    output_type=_CREATEREPORTRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
