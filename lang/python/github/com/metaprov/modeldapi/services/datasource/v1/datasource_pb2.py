...
_INFERSCHEMAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='table', full_name='github.com.metaprov.modeldapi.services.datasource.v1.InferSchemaRequest.table', index=7,
...
_INFERSCHEMAREQUEST.fields_by_name['table'].message_type = github_dot_com_dot_metaprov_dot_modeldapi_dot_pkg_dot_apis_dot_data_dot_v1alpha1_dot_generated__pb2._TABLESPEC
