...
from github.com.metaprov.modeldapi.services.virtualcluster.v1 import virtualcluster_pb2 as github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_virtualcluster_dot_v1_dot_virtualcluster__pb2
...
def add_VirtualClusterServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListVirtualClusters': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_virtualcluster_dot_v1_dot_virtualcluster__pb2.ListVirtualClustersRequest.FromString,
                    response_serializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_virtualcluster_dot_v1_dot_virtualcluster__pb2.ListVirtualClustersResponse.SerializeToString,
            ),
            'CreateVirtualCluster': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateVirtualCluster,
                    request_deserializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_virtualcluster_dot_v1_dot_virtualcluster__pb2.CreateVirtualClusterRequest.FromString,
                    response_serializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_virtualcluster_dot_v1_dot_virtualcluster__pb2.CreateVirtualClusterResponse.SerializeToString,
            ),
            'GetVirtualCluster': grpc.unary_unary_rpc_method_handler(
                    servicer.GetVirtualCluster,
                    request_deserializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_virtualcluster_dot_v1_dot_virtualcluster__pb2.GetVirtualClusterRequest.FromString,
                    response_serializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_virtualcluster_dot_v1_dot_virtualcluster__pb2.GetVirtualClusterResponse.SerializeToString,
            ),
            'UpdateVirtualCluster': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateVirtualCluster,
                    request_deserializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_virtualcluster_dot_v1_dot_virtualcluster__pb2.UpdateVirtualClusterRequest.FromString,
                    response_serializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_virtualcluster_dot_v1_dot_virtualcluster__pb2.UpdateVirtualClusterResponse.SerializeToString,
            ),
            'DeleteVirtualCluster': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteVirtualCluster,
                    request_deserializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_virtualcluster_dot_v1_dot_virtualcluster__pb2.DeleteVirtualClusterRequest.FromString,
                    response_serializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_virtualcluster_dot_v1_dot_virtualcluster__pb2.DeleteVirtualClusterResponse.SerializeToString,
            ),
    }
