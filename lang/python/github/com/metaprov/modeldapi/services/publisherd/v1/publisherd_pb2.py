...
_TARMODELREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bucket', full_name='github.com.metaprov.modeldapi.services.publisherd.v1.TarModelRequest.bucket', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cloudConn', full_name='github.com.metaprov.modeldapi.services.publisherd.v1.TarModelRequest.cloudConn', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cloudSecret', full_name='github.com.metaprov.modeldapi.services.publisherd.v1.TarModelRequest.cloudSecret', index=8,
...
_TARMODELRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tarUri', full_name='github.com.metaprov.modeldapi.services.publisherd.v1.TarModelResponse.tarUri', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
