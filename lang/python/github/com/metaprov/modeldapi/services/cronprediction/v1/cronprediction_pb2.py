...
_PAUSECRONPREDICTIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='github.com.metaprov.modeldapi.services.cronprediction.v1.PauseCronPredictionRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='namespace', full_name='github.com.metaprov.modeldapi.services.cronprediction.v1.PauseCronPredictionRequest.namespace', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='github.com.metaprov.modeldapi.services.cronprediction.v1.PauseCronPredictionRequest.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PAUSECRONPREDICTIONRESPONSE = _descriptor.Descriptor(
  ...
  full_name='github.com.metaprov.modeldapi.services.cronprediction.v1.PauseCronPredictionResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_RESUMECRONPREDICTIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='github.com.metaprov.modeldapi.services.cronprediction.v1.ResumeCronPredictionRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='namespace', full_name='github.com.metaprov.modeldapi.services.cronprediction.v1.ResumeCronPredictionRequest.namespace', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='github.com.metaprov.modeldapi.services.cronprediction.v1.ResumeCronPredictionRequest.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESUMECRONPREDICTIONRESPONSE = _descriptor.Descriptor(
  ...
  full_name='github.com.metaprov.modeldapi.services.cronprediction.v1.ResumeCronPredictionResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
PauseCronPredictionRequest = _reflection.GeneratedProtocolMessageType('PauseCronPredictionRequest', (_message.Message,), {
  ...
  '__module__' : 'github.com.metaprov.modeldapi.services.cronprediction.v1.cronprediction_pb2'
  # @@protoc_insertion_point(class_scope:github.com.metaprov.modeldapi.services.cronprediction.v1.PauseCronPredictionRequest)
  })
...
PauseCronPredictionResponse = _reflection.GeneratedProtocolMessageType('PauseCronPredictionResponse', (_message.Message,), {
  ...
  '__module__' : 'github.com.metaprov.modeldapi.services.cronprediction.v1.cronprediction_pb2'
  # @@protoc_insertion_point(class_scope:github.com.metaprov.modeldapi.services.cronprediction.v1.PauseCronPredictionResponse)
  })
...
ResumeCronPredictionRequest = _reflection.GeneratedProtocolMessageType('ResumeCronPredictionRequest', (_message.Message,), {
  ...
  '__module__' : 'github.com.metaprov.modeldapi.services.cronprediction.v1.cronprediction_pb2'
  # @@protoc_insertion_point(class_scope:github.com.metaprov.modeldapi.services.cronprediction.v1.ResumeCronPredictionRequest)
  })
...
ResumeCronPredictionResponse = _reflection.GeneratedProtocolMessageType('ResumeCronPredictionResponse', (_message.Message,), {
  ...
  '__module__' : 'github.com.metaprov.modeldapi.services.cronprediction.v1.cronprediction_pb2'
  # @@protoc_insertion_point(class_scope:github.com.metaprov.modeldapi.services.cronprediction.v1.ResumeCronPredictionResponse)
  })
...
_CRONPREDICTIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='github.com.metaprov.modeldapi.services.cronprediction.v1.CronPredictionService.PauseCronPrediction',
    index=5,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='github.com.metaprov.modeldapi.services.cronprediction.v1.CronPredictionService.ResumeCronPrediction',
    index=6,
    containing_service=None,
