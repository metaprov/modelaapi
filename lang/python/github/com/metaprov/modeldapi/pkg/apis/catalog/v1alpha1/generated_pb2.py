...
_WORKLOADCLASSSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='vcpu', full_name='github.com.metaprov.modeldapi.pkg.apis.catalog.v1alpha1.WorkloadClassSpec.vcpu', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mem', full_name='github.com.metaprov.modeldapi.pkg.apis.catalog.v1alpha1.WorkloadClassSpec.mem', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='gpu', full_name='github.com.metaprov.modeldapi.pkg.apis.catalog.v1alpha1.WorkloadClassSpec.gpu', index=5,
      number=6, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='podTemplate', full_name='github.com.metaprov.modeldapi.pkg.apis.catalog.v1alpha1.WorkloadClassSpec.podTemplate', index=6,
