...
from github.com.metaprov.modeldapi.services.reciperun.v1 import reciperun_pb2 as github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_reciperun_dot_v1_dot_reciperun__pb2
...
def add_RecipeRunServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListRecipeRuns': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_reciperun_dot_v1_dot_reciperun__pb2.ListRecipeRunsRequest.FromString,
                    response_serializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_reciperun_dot_v1_dot_reciperun__pb2.ListRecipeRunsResponse.SerializeToString,
            ),
            'CreateRecipeRun': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateRecipeRun,
                    request_deserializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_reciperun_dot_v1_dot_reciperun__pb2.CreateRecipeRunRequest.FromString,
                    response_serializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_reciperun_dot_v1_dot_reciperun__pb2.CreateRecipeRunResponse.SerializeToString,
            ),
            'GetRecipeRun': grpc.unary_unary_rpc_method_handler(
                    servicer.GetRecipeRun,
                    request_deserializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_reciperun_dot_v1_dot_reciperun__pb2.GetRecipeRunRequest.FromString,
                    response_serializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_reciperun_dot_v1_dot_reciperun__pb2.GetRecipeRunResponse.SerializeToString,
            ),
            'UpdateRecipeRun': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateRecipeRun,
                    request_deserializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_reciperun_dot_v1_dot_reciperun__pb2.UpdateRecipeRunRequest.FromString,
                    response_serializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_reciperun_dot_v1_dot_reciperun__pb2.UpdateRecipeRunResponse.SerializeToString,
            ),
            'DeleteRecipeRun': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteRecipeRun,
                    request_deserializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_reciperun_dot_v1_dot_reciperun__pb2.DeleteRecipeRunRequest.FromString,
                    response_serializer=github_dot_com_dot_metaprov_dot_modeldapi_dot_services_dot_reciperun_dot_v1_dot_reciperun__pb2.DeleteRecipeRunResponse.SerializeToString,
            ),
    }
