...
_OBJECTMETA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='clusterName', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMeta.clusterName', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='managedFields', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMeta.managedFields', index=15,
