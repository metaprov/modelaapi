...
namespace Github.Com.Metaprov.Modelaapi.Pkg.Apis.Catalog.V1Alpha1 {
  ...
  public static partial class GeneratedReflection {
    ...
    #region Descriptor
    /// <summary>File descriptor for github.com/metaprov/modelaapi/pkg/apis/catalog/v1alpha1/generated.proto</summary>
  ...
  /// +kubebuilder:resource:path=algorithms,singular=algorithm,categories={catalog,modela,all}
