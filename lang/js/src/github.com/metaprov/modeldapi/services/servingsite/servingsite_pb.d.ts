...
export class CreateServingSiteRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): CreateServingSiteRequest;

  getName(): string;
  setName(value: string): CreateServingSiteRequest;

  getLabelsMap(): jspb.Map<string, string>;
  clearLabelsMap(): CreateServingSiteRequest;

  getSpec(): github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSiteSpec | undefined;
  setSpec(value?: github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSiteSpec): CreateServingSiteRequest;
  hasSpec(): boolean;
...
export namespace CreateServingSiteRequest {
  export type AsObject = {
    ...
    name: string,
    labelsMap: Array<[string, string]>,
    spec?: github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSiteSpec.AsObject,
  }
}
...
export class UpdateServingSiteRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): UpdateServingSiteRequest;

  getName(): string;
  setName(value: string): UpdateServingSiteRequest;

  getLabelsMap(): jspb.Map<string, string>;
  clearLabelsMap(): UpdateServingSiteRequest;

  getSpec(): github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSiteSpec | undefined;
  setSpec(value?: github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSiteSpec): UpdateServingSiteRequest;
  hasSpec(): boolean;
...
export class GetServingSiteNamespacesRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): GetServingSiteNamespacesRequest;

  getName(): string;
  setName(value: string): GetServingSiteNamespacesRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetServingSiteNamespacesRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GetServingSiteNamespacesRequest): GetServingSiteNamespacesRequest.AsObject;
  static serializeBinaryToWriter(message: GetServingSiteNamespacesRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetServingSiteNamespacesRequest;
  static deserializeBinaryFromReader(message: GetServingSiteNamespacesRequest, reader: jspb.BinaryReader): GetServingSiteNamespacesRequest;
}

export namespace GetServingSiteNamespacesRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
...
export class GetServingSiteNamespacesResponse extends jspb.Message {
  getNamespacesList(): Array<github_com_metaprov_modeldapi_services_common_common_pb.NamespaceInfo>;
  setNamespacesList(value: Array<github_com_metaprov_modeldapi_services_common_common_pb.NamespaceInfo>): GetServingSiteNamespacesResponse;
  clearNamespacesList(): GetServingSiteNamespacesResponse;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetServingSiteNamespacesResponse.AsObject;
  static toObject(includeInstance: boolean, msg: GetServingSiteNamespacesResponse): GetServingSiteNamespacesResponse.AsObject;
  static serializeBinaryToWriter(message: GetServingSiteNamespacesResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetServingSiteNamespacesResponse;
  static deserializeBinaryFromReader(message: GetServingSiteNamespacesResponse, reader: jspb.BinaryReader): GetServingSiteNamespacesResponse;
}

export namespace GetServingSiteNamespacesResponse {
  export type AsObject = {
