...
export class GetModelProfileResponse extends jspb.Message {
  getProfile(): github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile | undefined;
  setProfile(value?: github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile): GetModelProfileResponse;
  hasProfile(): boolean;
...
export namespace GetModelProfileResponse {
  export type AsObject = {
    profile?: github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile.AsObject,
  }
}
...
export class CompareModelsResponse extends jspb.Message {
  ...
  getProfilesList(): Array<github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile>;
  setProfilesList(value: Array<github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile>): CompareModelsResponse;
  clearProfilesList(): CompareModelsResponse;
  addProfiles(value?: github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile, index?: number): github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile;
...
export namespace CompareModelsResponse {
  export type AsObject = {
    namespace: string,
    namesList: Array<string>,
    profilesList: Array<github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile.AsObject>,
  }
}
...
export class GetMisclassResponse extends jspb.Message {
  ...
  setTable(value?: github_com_metaprov_modeldapi_services_common_common_pb.TableView): GetMisclassResponse;
  hasTable(): boolean;
