...
export class ModelInfo extends jspb.Message {
  ...
  getTask(): string;
  setTask(value: string): ModelInfo;

  getRmse(): number;
  setRmse(value: number): ModelInfo;

  getAuc(): number;
  setAuc(value: number): ModelInfo;
  ...
  getImagename(): string;
  setImagename(value: string): ModelInfo;

  getDeploymentname(): string;
  setDeploymentname(value: string): ModelInfo;

  getServicename(): string;
  setServicename(value: string): ModelInfo;

  getHpaname(): string;
  setHpaname(value: string): ModelInfo;
...
export class ColumnInfo extends jspb.Message {
  ...
  getMin(): number;
  setMin(value: number): ColumnInfo;

  getMax(): number;
  setMax(value: number): ColumnInfo;

  getMinlength(): number;
  setMinlength(value: number): ColumnInfo;

  getMaxlength(): number;
  setMaxlength(value: number): ColumnInfo;

  getEnumList(): Array<string>;
  setEnumList(value: Array<string>): ColumnInfo;
  clearEnumList(): ColumnInfo;
  addEnum(value: string, index?: number): ColumnInfo;

  getNullable(): boolean;
  setNullable(value: boolean): ColumnInfo;
...
export class PredictRequest extends jspb.Message {
  ...
  getFormat(): PredictFormat;
  setFormat(value: PredictFormat): PredictRequest;
