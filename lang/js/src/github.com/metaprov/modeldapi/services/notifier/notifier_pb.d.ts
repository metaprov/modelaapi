...
export class GetNotifierNamespacesRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): GetNotifierNamespacesRequest;

  getName(): string;
  setName(value: string): GetNotifierNamespacesRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetNotifierNamespacesRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GetNotifierNamespacesRequest): GetNotifierNamespacesRequest.AsObject;
  static serializeBinaryToWriter(message: GetNotifierNamespacesRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetNotifierNamespacesRequest;
  static deserializeBinaryFromReader(message: GetNotifierNamespacesRequest, reader: jspb.BinaryReader): GetNotifierNamespacesRequest;
}

export namespace GetNotifierNamespacesRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
...
export class GetNotifierNamespacesResponse extends jspb.Message {
  getNamespacesList(): Array<github_com_metaprov_modeldapi_services_common_common_pb.NamespaceInfo>;
  setNamespacesList(value: Array<github_com_metaprov_modeldapi_services_common_common_pb.NamespaceInfo>): GetNotifierNamespacesResponse;
  clearNamespacesList(): GetNotifierNamespacesResponse;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetNotifierNamespacesResponse.AsObject;
  static toObject(includeInstance: boolean, msg: GetNotifierNamespacesResponse): GetNotifierNamespacesResponse.AsObject;
  static serializeBinaryToWriter(message: GetNotifierNamespacesResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetNotifierNamespacesResponse;
  static deserializeBinaryFromReader(message: GetNotifierNamespacesResponse, reader: jspb.BinaryReader): GetNotifierNamespacesResponse;
}

export namespace GetNotifierNamespacesResponse {
  export type AsObject = {
