...
export class PredictionsIngestRequest extends jspb.Message {
  ...
  setDataset(value?: github_com_metaprov_modelaapi_pkg_apis_data_v1alpha1_generated_pb.Dataset): PredictionsIngestRequest;
  hasDataset(): boolean;
  ...
  setConnection(value?: github_com_metaprov_modelaapi_pkg_apis_infra_v1alpha1_generated_pb.Connection): PredictionsIngestRequest;
