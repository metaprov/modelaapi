...
export class GetModelPipelineRunNamespacesRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): GetModelPipelineRunNamespacesRequest;

  getName(): string;
  setName(value: string): GetModelPipelineRunNamespacesRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetModelPipelineRunNamespacesRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GetModelPipelineRunNamespacesRequest): GetModelPipelineRunNamespacesRequest.AsObject;
  static serializeBinaryToWriter(message: GetModelPipelineRunNamespacesRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetModelPipelineRunNamespacesRequest;
  static deserializeBinaryFromReader(message: GetModelPipelineRunNamespacesRequest, reader: jspb.BinaryReader): GetModelPipelineRunNamespacesRequest;
}

export namespace GetModelPipelineRunNamespacesRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
...
export class GetModelPipelineRunNamespacesResponse extends jspb.Message {
  getNamespacesList(): Array<github_com_metaprov_modeldapi_services_common_common_pb.NamespaceInfo>;
  setNamespacesList(value: Array<github_com_metaprov_modeldapi_services_common_common_pb.NamespaceInfo>): GetModelPipelineRunNamespacesResponse;
  clearNamespacesList(): GetModelPipelineRunNamespacesResponse;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetModelPipelineRunNamespacesResponse.AsObject;
  static toObject(includeInstance: boolean, msg: GetModelPipelineRunNamespacesResponse): GetModelPipelineRunNamespacesResponse.AsObject;
  static serializeBinaryToWriter(message: GetModelPipelineRunNamespacesResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetModelPipelineRunNamespacesResponse;
  static deserializeBinaryFromReader(message: GetModelPipelineRunNamespacesResponse, reader: jspb.BinaryReader): GetModelPipelineRunNamespacesResponse;
}

export namespace GetModelPipelineRunNamespacesResponse {
  export type AsObject = {
