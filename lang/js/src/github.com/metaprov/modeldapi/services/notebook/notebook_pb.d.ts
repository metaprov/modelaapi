...
export class GetNotebookNamespacesRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): GetNotebookNamespacesRequest;

  getName(): string;
  setName(value: string): GetNotebookNamespacesRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetNotebookNamespacesRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GetNotebookNamespacesRequest): GetNotebookNamespacesRequest.AsObject;
  static serializeBinaryToWriter(message: GetNotebookNamespacesRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetNotebookNamespacesRequest;
  static deserializeBinaryFromReader(message: GetNotebookNamespacesRequest, reader: jspb.BinaryReader): GetNotebookNamespacesRequest;
}

export namespace GetNotebookNamespacesRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
...
export class GetNotebookNamespacesResponse extends jspb.Message {
  getNamespacesList(): Array<github_com_metaprov_modeldapi_services_common_common_pb.NamespaceInfo>;
  setNamespacesList(value: Array<github_com_metaprov_modeldapi_services_common_common_pb.NamespaceInfo>): GetNotebookNamespacesResponse;
  clearNamespacesList(): GetNotebookNamespacesResponse;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetNotebookNamespacesResponse.AsObject;
  static toObject(includeInstance: boolean, msg: GetNotebookNamespacesResponse): GetNotebookNamespacesResponse.AsObject;
  static serializeBinaryToWriter(message: GetNotebookNamespacesResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetNotebookNamespacesResponse;
  static deserializeBinaryFromReader(message: GetNotebookNamespacesResponse, reader: jspb.BinaryReader): GetNotebookNamespacesResponse;
}

export namespace GetNotebookNamespacesResponse {
  export type AsObject = {
