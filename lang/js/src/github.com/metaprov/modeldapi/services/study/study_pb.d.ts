...
export class GetStudyProfileResponse extends jspb.Message {
  getProfile(): github_com_metaprov_modeldapi_services_common_common_pb.StudyProfile | undefined;
  setProfile(value?: github_com_metaprov_modeldapi_services_common_common_pb.StudyProfile): GetStudyProfileResponse;
  hasProfile(): boolean;
  clearProfile(): GetStudyProfileResponse;

  getModelsprofileList(): Array<github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile>;
  setModelsprofileList(value: Array<github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile>): GetStudyProfileResponse;
  clearModelsprofileList(): GetStudyProfileResponse;
  addModelsprofile(value?: github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile, index?: number): github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile;
...
export namespace GetStudyProfileResponse {
  export type AsObject = {
    profile?: github_com_metaprov_modeldapi_services_common_common_pb.StudyProfile.AsObject,
    modelsprofileList: Array<github_com_metaprov_modeldapi_services_common_common_pb.ModelProfile.AsObject>,
  }
}
