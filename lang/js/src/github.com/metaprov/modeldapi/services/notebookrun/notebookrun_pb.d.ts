...
export class GetNotebookRunNamespacesRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): GetNotebookRunNamespacesRequest;

  getName(): string;
  setName(value: string): GetNotebookRunNamespacesRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetNotebookRunNamespacesRequest.AsObject;
  static toObject(includeInstance: boolean, msg: GetNotebookRunNamespacesRequest): GetNotebookRunNamespacesRequest.AsObject;
  static serializeBinaryToWriter(message: GetNotebookRunNamespacesRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetNotebookRunNamespacesRequest;
  static deserializeBinaryFromReader(message: GetNotebookRunNamespacesRequest, reader: jspb.BinaryReader): GetNotebookRunNamespacesRequest;
}

export namespace GetNotebookRunNamespacesRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
...
export class GetNotebookRunNamespacesResponse extends jspb.Message {
  getNamespacesList(): Array<github_com_metaprov_modeldapi_services_common_common_pb.NamespaceInfo>;
  setNamespacesList(value: Array<github_com_metaprov_modeldapi_services_common_common_pb.NamespaceInfo>): GetNotebookRunNamespacesResponse;
  clearNamespacesList(): GetNotebookRunNamespacesResponse;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetNotebookRunNamespacesResponse.AsObject;
  static toObject(includeInstance: boolean, msg: GetNotebookRunNamespacesResponse): GetNotebookRunNamespacesResponse.AsObject;
  static serializeBinaryToWriter(message: GetNotebookRunNamespacesResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetNotebookRunNamespacesResponse;
  static deserializeBinaryFromReader(message: GetNotebookRunNamespacesResponse, reader: jspb.BinaryReader): GetNotebookRunNamespacesResponse;
}

export namespace GetNotebookRunNamespacesResponse {
  export type AsObject = {
