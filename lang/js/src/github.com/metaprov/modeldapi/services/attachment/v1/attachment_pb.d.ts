...
export class ListAttachmentsResponse extends jspb.Message {
  getItems(): github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.AttachmentList | undefined;
  setItems(value?: github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.AttachmentList): ListAttachmentsResponse;
  hasItems(): boolean;
...
export namespace ListAttachmentsResponse {
  export type AsObject = {
    items?: github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.AttachmentList.AsObject,
  }
}
...
export class CreateAttachmentRequest extends jspb.Message {
  getItem(): github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.Attachment | undefined;
  setItem(value?: github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.Attachment): CreateAttachmentRequest;
  hasItem(): boolean;
  clearItem(): CreateAttachmentRequest;

  getPassword(): string;
  setPassword(value: string): CreateAttachmentRequest;
...
export namespace CreateAttachmentRequest {
  export type AsObject = {
    item?: github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.Attachment.AsObject,
    password: string,
  }
}
...
export class UpdateAttachmentRequest extends jspb.Message {
  getItem(): github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.Attachment | undefined;
  setItem(value?: github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.Attachment): UpdateAttachmentRequest;
  hasItem(): boolean;
...
export class GetAttachmentResponse extends jspb.Message {
  getItem(): github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.Attachment | undefined;
  setItem(value?: github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.Attachment): GetAttachmentResponse;
  hasItem(): boolean;
...
export class GetAttachmentNamespacesResponse extends jspb.Message {
  ...
  setNamespacesList(value: Array<github_com_metaprov_modeldapi_services_common_v1_common_pb.NamespaceInfo>): GetAttachmentNamespacesResponse;
...
export class AttachmentLoginRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): AttachmentLoginRequest;

  getName(): string;
  setName(value: string): AttachmentLoginRequest;

  getPassword(): string;
  setPassword(value: string): AttachmentLoginRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): AttachmentLoginRequest.AsObject;
  static toObject(includeInstance: boolean, msg: AttachmentLoginRequest): AttachmentLoginRequest.AsObject;
  static serializeBinaryToWriter(message: AttachmentLoginRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): AttachmentLoginRequest;
  static deserializeBinaryFromReader(message: AttachmentLoginRequest, reader: jspb.BinaryReader): AttachmentLoginRequest;
}

export namespace AttachmentLoginRequest {
  export type AsObject = {
    namespace: string,
    name: string,
    password: string,
...
export class AttachmentLoginResponse extends jspb.Message {
  getToken(): string;
  setToken(value: string): AttachmentLoginResponse;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): AttachmentLoginResponse.AsObject;
  static toObject(includeInstance: boolean, msg: AttachmentLoginResponse): AttachmentLoginResponse.AsObject;
  static serializeBinaryToWriter(message: AttachmentLoginResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): AttachmentLoginResponse;
  static deserializeBinaryFromReader(message: AttachmentLoginResponse, reader: jspb.BinaryReader): AttachmentLoginResponse;
}

export namespace AttachmentLoginResponse {
  export type AsObject = {
    token: string,
  }
}
