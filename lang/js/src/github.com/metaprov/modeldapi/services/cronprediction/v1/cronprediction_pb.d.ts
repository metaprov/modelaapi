...
export class DownloadCronPredictionRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): DownloadCronPredictionRequest;

  getName(): string;
  setName(value: string): DownloadCronPredictionRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): DownloadCronPredictionRequest.AsObject;
  static toObject(includeInstance: boolean, msg: DownloadCronPredictionRequest): DownloadCronPredictionRequest.AsObject;
  static serializeBinaryToWriter(message: DownloadCronPredictionRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): DownloadCronPredictionRequest;
  static deserializeBinaryFromReader(message: DownloadCronPredictionRequest, reader: jspb.BinaryReader): DownloadCronPredictionRequest;
}

export namespace DownloadCronPredictionRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
...
export class DownloadCronPredictionResponse extends jspb.Message {
  getRaw(): Uint8Array | string;
  getRaw_asU8(): Uint8Array;
  getRaw_asB64(): string;
  setRaw(value: Uint8Array | string): DownloadCronPredictionResponse;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): DownloadCronPredictionResponse.AsObject;
  static toObject(includeInstance: boolean, msg: DownloadCronPredictionResponse): DownloadCronPredictionResponse.AsObject;
  static serializeBinaryToWriter(message: DownloadCronPredictionResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): DownloadCronPredictionResponse;
  static deserializeBinaryFromReader(message: DownloadCronPredictionResponse, reader: jspb.BinaryReader): DownloadCronPredictionResponse;
}

export namespace DownloadCronPredictionResponse {
  export type AsObject = {
