...
export class ArchivedServiceClient {
  ...
  methodInfoRecordModelAutoBuilder = new grpcWeb.AbstractClientBase.MethodInfo(
    google_protobuf_empty_pb.Empty,
    (request: github_com_metaprov_modeldapi_services_archived_v1_archived_pb.RecordModelAutoBuilderRequest) => {
      return request.serializeBinary();
    },
    google_protobuf_empty_pb.Empty.deserializeBinary
  );

  recordModelAutoBuilder(
    request: github_com_metaprov_modeldapi_services_archived_v1_archived_pb.RecordModelAutoBuilderRequest,
    metadata: grpcWeb.Metadata | null): Promise<google_protobuf_empty_pb.Empty>;
  ...
  recordModelAutoBuilder(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        ...
        request,
        metadata || {},
        this.methodInfoRecordModelAutoBuilder,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
