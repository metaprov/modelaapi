...
export class CreateDatasetProfileResponse extends jspb.Message {
  ...
  setProfile(value?: github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile): CreateDatasetProfileResponse;
  hasProfile(): boolean;
...
export class CreateColumnProfileResponse extends jspb.Message {
  ...
  setPlot(value?: github_com_metaprov_modeldapi_services_common_common_pb.Plot): CreateColumnProfileResponse;
  hasPlot(): boolean;
...
export class GetDatasetProfileResponse extends jspb.Message {
  ...
  getProfile(): github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile | undefined;
  setProfile(value?: github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile): GetDatasetProfileResponse;
  hasProfile(): boolean;
...
export class CompareDatasetsResponse extends jspb.Message {
  ...
  getProfilesList(): Array<github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile>;
  setProfilesList(value: Array<github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile>): CompareDatasetsResponse;
  clearProfilesList(): CompareDatasetsResponse;
  addProfiles(value?: github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile, index?: number): github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile;
...
export namespace CompareDatasetsResponse {
  export type AsObject = {
    namespace: string,
    namesList: Array<string>,
    profilesList: Array<github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile.AsObject>,
  }
}
...
export class GenerateDatasetResponse extends jspb.Message {
  ...
  getProfilesList(): Array<github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile>;
  setProfilesList(value: Array<github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile>): GenerateDatasetResponse;
...
export class ValidateDatasetResponse extends jspb.Message {
  ...
  getProfilesList(): Array<github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile>;
  setProfilesList(value: Array<github_com_metaprov_modeldapi_services_common_common_pb.DatasetProfile>): ValidateDatasetResponse;
