...
export class InferSchemaResponse extends jspb.Message {
  getColumnsList(): Array<github_com_metaprov_modeldapi_services_common_common_pb.ColumnProfile>;
  setColumnsList(value: Array<github_com_metaprov_modeldapi_services_common_common_pb.ColumnProfile>): InferSchemaResponse;
  clearColumnsList(): InferSchemaResponse;
  addColumns(value?: github_com_metaprov_modeldapi_services_common_common_pb.ColumnProfile, index?: number): github_com_metaprov_modeldapi_services_common_common_pb.ColumnProfile;
...
export namespace InferSchemaResponse {
  export type AsObject = {
    columnsList: Array<github_com_metaprov_modeldapi_services_common_common_pb.ColumnProfile.AsObject>,
  }
}
...
export class GetTableViewResponse extends jspb.Message {
  ...
  setTable(value?: github_com_metaprov_modeldapi_services_common_common_pb.TableView): GetTableViewResponse;
  hasTable(): boolean;
