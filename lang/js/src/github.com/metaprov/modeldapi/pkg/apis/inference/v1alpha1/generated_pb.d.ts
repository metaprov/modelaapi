...
export class PredictorTemplate extends jspb.Message {
  getMetadata(): k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ObjectMeta | undefined;
  setMetadata(value?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ObjectMeta): PredictorTemplate;
  hasMetadata(): boolean;
  clearMetadata(): PredictorTemplate;

  getSpec(): PredictorTemplateSpec | undefined;
  setSpec(value?: PredictorTemplateSpec): PredictorTemplate;
  hasSpec(): boolean;
  clearSpec(): PredictorTemplate;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PredictorTemplate.AsObject;
  static toObject(includeInstance: boolean, msg: PredictorTemplate): PredictorTemplate.AsObject;
  static serializeBinaryToWriter(message: PredictorTemplate, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PredictorTemplate;
  static deserializeBinaryFromReader(message: PredictorTemplate, reader: jspb.BinaryReader): PredictorTemplate;
}

export namespace PredictorTemplate {
  export type AsObject = {
    metadata?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ObjectMeta.AsObject,
    spec?: PredictorTemplateSpec.AsObject,
  }
}

export class PredictorTemplateList extends jspb.Message {
  getMetadata(): k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ListMeta | undefined;
  setMetadata(value?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ListMeta): PredictorTemplateList;
  hasMetadata(): boolean;
  clearMetadata(): PredictorTemplateList;

  getItemsList(): Array<PredictorTemplate>;
  setItemsList(value: Array<PredictorTemplate>): PredictorTemplateList;
  clearItemsList(): PredictorTemplateList;
  addItems(value?: PredictorTemplate, index?: number): PredictorTemplate;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PredictorTemplateList.AsObject;
  static toObject(includeInstance: boolean, msg: PredictorTemplateList): PredictorTemplateList.AsObject;
  static serializeBinaryToWriter(message: PredictorTemplateList, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PredictorTemplateList;
  static deserializeBinaryFromReader(message: PredictorTemplateList, reader: jspb.BinaryReader): PredictorTemplateList;
}

export namespace PredictorTemplateList {
  export type AsObject = {
    metadata?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ListMeta.AsObject,
    itemsList: Array<PredictorTemplate.AsObject>,
  }
}

export class PredictorTemplateSpec extends jspb.Message {
  getMetadata(): k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ObjectMeta | undefined;
  setMetadata(value?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ObjectMeta): PredictorTemplateSpec;
  hasMetadata(): boolean;
  clearMetadata(): PredictorTemplateSpec;

  getSpec(): PredictorSpec | undefined;
  setSpec(value?: PredictorSpec): PredictorTemplateSpec;
  hasSpec(): boolean;
  clearSpec(): PredictorTemplateSpec;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PredictorTemplateSpec.AsObject;
  static toObject(includeInstance: boolean, msg: PredictorTemplateSpec): PredictorTemplateSpec.AsObject;
  static serializeBinaryToWriter(message: PredictorTemplateSpec, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PredictorTemplateSpec;
  static deserializeBinaryFromReader(message: PredictorTemplateSpec, reader: jspb.BinaryReader): PredictorTemplateSpec;
}

export namespace PredictorTemplateSpec {
  export type AsObject = {
    metadata?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ObjectMeta.AsObject,
    spec?: PredictorSpec.AsObject,
  }
