...
export class MachineImage extends jspb.Message {
  getMetadata(): k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ObjectMeta | undefined;
  setMetadata(value?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ObjectMeta): MachineImage;
  hasMetadata(): boolean;
  clearMetadata(): MachineImage;

  getSpec(): MachineImageSpec | undefined;
  setSpec(value?: MachineImageSpec): MachineImage;
  hasSpec(): boolean;
  clearSpec(): MachineImage;

  getStatus(): MachineImageStatus | undefined;
  setStatus(value?: MachineImageStatus): MachineImage;
  hasStatus(): boolean;
  clearStatus(): MachineImage;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MachineImage.AsObject;
  static toObject(includeInstance: boolean, msg: MachineImage): MachineImage.AsObject;
  static serializeBinaryToWriter(message: MachineImage, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MachineImage;
  static deserializeBinaryFromReader(message: MachineImage, reader: jspb.BinaryReader): MachineImage;
}

export namespace MachineImage {
  export type AsObject = {
    metadata?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ObjectMeta.AsObject,
    spec?: MachineImageSpec.AsObject,
    status?: MachineImageStatus.AsObject,
  }
}

export class MachineImageCondition extends jspb.Message {
  getType(): string;
  setType(value: string): MachineImageCondition;

  getStatus(): string;
  setStatus(value: string): MachineImageCondition;

  getLasttransitiontime(): k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.Time | undefined;
  setLasttransitiontime(value?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.Time): MachineImageCondition;
  hasLasttransitiontime(): boolean;
  clearLasttransitiontime(): MachineImageCondition;

  getReason(): string;
  setReason(value: string): MachineImageCondition;

  getMessage(): string;
  setMessage(value: string): MachineImageCondition;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MachineImageCondition.AsObject;
  static toObject(includeInstance: boolean, msg: MachineImageCondition): MachineImageCondition.AsObject;
  static serializeBinaryToWriter(message: MachineImageCondition, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MachineImageCondition;
  static deserializeBinaryFromReader(message: MachineImageCondition, reader: jspb.BinaryReader): MachineImageCondition;
}

export namespace MachineImageCondition {
  export type AsObject = {
    type: string,
    status: string,
    lasttransitiontime?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.Time.AsObject,
...
export class MachineImageList extends jspb.Message {
  getMetadata(): k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ListMeta | undefined;
  setMetadata(value?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ListMeta): MachineImageList;
  hasMetadata(): boolean;
  clearMetadata(): MachineImageList;

  getItemsList(): Array<MachineImage>;
  setItemsList(value: Array<MachineImage>): MachineImageList;
  clearItemsList(): MachineImageList;
  addItems(value?: MachineImage, index?: number): MachineImage;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MachineImageList.AsObject;
  static toObject(includeInstance: boolean, msg: MachineImageList): MachineImageList.AsObject;
  static serializeBinaryToWriter(message: MachineImageList, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MachineImageList;
  static deserializeBinaryFromReader(message: MachineImageList, reader: jspb.BinaryReader): MachineImageList;
}

export namespace MachineImageList {
  export type AsObject = {
    metadata?: k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.ListMeta.AsObject,
    itemsList: Array<MachineImage.AsObject>,
  }
}

export class MachineImageSpec extends jspb.Message {
  getContent(): string;
  setContent(value: string): MachineImageSpec;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MachineImageSpec.AsObject;
  static toObject(includeInstance: boolean, msg: MachineImageSpec): MachineImageSpec.AsObject;
  static serializeBinaryToWriter(message: MachineImageSpec, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MachineImageSpec;
  static deserializeBinaryFromReader(message: MachineImageSpec, reader: jspb.BinaryReader): MachineImageSpec;
}

export namespace MachineImageSpec {
  export type AsObject = {
    content: string,
  }
}

export class MachineImageStatus extends jspb.Message {
  getConditionsList(): Array<MachineImageCondition>;
  setConditionsList(value: Array<MachineImageCondition>): MachineImageStatus;
  clearConditionsList(): MachineImageStatus;
  addConditions(value?: MachineImageCondition, index?: number): MachineImageCondition;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MachineImageStatus.AsObject;
  static toObject(includeInstance: boolean, msg: MachineImageStatus): MachineImageStatus.AsObject;
  static serializeBinaryToWriter(message: MachineImageStatus, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MachineImageStatus;
  static deserializeBinaryFromReader(message: MachineImageStatus, reader: jspb.BinaryReader): MachineImageStatus;
}

export namespace MachineImageStatus {
  export type AsObject = {
    conditionsList: Array<MachineImageCondition.AsObject>,
  }
}
