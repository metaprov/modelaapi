...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.BotChannelSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    connectionname: jspb.Message.getField(msg, 1),
    notifiername: jspb.Message.getField(msg, 2)
  };
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.BucketChannelSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    connectionname: jspb.Message.getField(msg, 1),
    databaseconnectionname: jspb.Message.getField(msg, 2),
    inputkey: jspb.Message.getField(msg, 3),
    scaninterval: jspb.Message.getField(msg, 4)
  };
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.CurtainSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    servingsitename: jspb.Message.getField(msg, 3),
    datasetname: jspb.Message.getField(msg, 4),
    wizardsList: jspb.Message.getRepeatedField(msg, 5),
    question: jspb.Message.getField(msg, 6),
    owner: jspb.Message.getField(msg, 7)
  };
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.DriftCheckSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    cronexpr: jspb.Message.getField(msg, 1),
    treshold: jspb.Message.getOptionalFloatingPointField(msg, 2),
    notifiername: jspb.Message.getField(msg, 3),
    testdataset: jspb.Message.getField(msg, 4)
  };
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.ModelDeploymentSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    modelname: jspb.Message.getField(msg, 1),
    replicas: jspb.Message.getField(msg, 2),
    autoscale: jspb.Message.getField(msg, 3),
    weight: jspb.Message.getField(msg, 4),
    canary: jspb.Message.getField(msg, 5),
    shadow: jspb.Message.getField(msg, 6),
    filter: jspb.Message.getField(msg, 7),
    canarymetricsList: jspb.Message.getRepeatedField(msg, 8)
  };
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.ModelDeploymentStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    imagename: jspb.Message.getField(msg, 1),
    deploymentname: jspb.Message.getField(msg, 2),
    servicename: jspb.Message.getField(msg, 3),
    hpaname: jspb.Message.getField(msg, 4),
    current95: jspb.Message.getOptionalFloatingPointField(msg, 5),
    current99: jspb.Message.getOptionalFloatingPointField(msg, 6),
    lastprediction: (f = msg.getLastprediction()) && k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.Time.toObject(includeInstance, f),
    dailypredictionavg: jspb.Message.getField(msg, 8)
  };
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.ModelDeploymentStatus.prototype.clearLastprediction = function() {
  this.setLastprediction(undefined);
};
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.PredictionPipelineRunSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    labeled: jspb.Message.getField(msg, 2),
    objective: jspb.Message.getField(msg, 3),
    datasetname: jspb.Message.getField(msg, 4),
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.PredictionPipelineRunStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    score: jspb.Message.getOptionalFloatingPointField(msg, 2),
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.PredictorHealth.toObject = function(includeInstance, msg) {
  var f, obj = {
    totalpredictions: jspb.Message.getField(msg, 1),
    totalrequests: jspb.Message.getField(msg, 2),
    totalp95requests: jspb.Message.getField(msg, 3),
    medianresponsetime: jspb.Message.getField(msg, 4),
    lastdailypredictionsList: jspb.Message.getRepeatedField(msg, 5)
  };
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.PredictorHealth.prototype.clearLastdailypredictionsList = function() {
  this.setLastdailypredictionsList([]);
};
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.PredictorSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    path: jspb.Message.getField(msg, 6),
    accesstype: jspb.Message.getField(msg, 7),
    ...
    artifactsfolder: jspb.Message.getField(msg, 14),
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.PredictorSpec.prototype.clearServingsiteref = function() {
  this.setServingsiteref(undefined);
};
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.PredictorStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    monitorlastscore: jspb.Message.getOptionalFloatingPointField(msg, 4),
    monitorlastlatency: jspb.Message.getOptionalFloatingPointField(msg, 5),
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.PredictorStatus.prototype.clearMonitorlastattemptat = function() {
  this.setMonitorlastattemptat(undefined);
};
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.ProgressiveSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    warmup: jspb.Message.getField(msg, 1),
    trafficincrement: jspb.Message.getField(msg, 2),
    canarymetricsList: jspb.Message.getRepeatedField(msg, 3)
  };
...
proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.StreamingChannelSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    connectionname: jspb.Message.getField(msg, 1),
    inputkey: jspb.Message.getField(msg, 2)
  };
