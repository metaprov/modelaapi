...
export class PauseSqlQueryRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): PauseSqlQueryRequest;

  getName(): string;
  setName(value: string): PauseSqlQueryRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PauseSqlQueryRequest.AsObject;
  static toObject(includeInstance: boolean, msg: PauseSqlQueryRequest): PauseSqlQueryRequest.AsObject;
  static serializeBinaryToWriter(message: PauseSqlQueryRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PauseSqlQueryRequest;
  static deserializeBinaryFromReader(message: PauseSqlQueryRequest, reader: jspb.BinaryReader): PauseSqlQueryRequest;
}

export namespace PauseSqlQueryRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
...
export class PauseSqlQueryResponse extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PauseSqlQueryResponse.AsObject;
  static toObject(includeInstance: boolean, msg: PauseSqlQueryResponse): PauseSqlQueryResponse.AsObject;
  static serializeBinaryToWriter(message: PauseSqlQueryResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PauseSqlQueryResponse;
  static deserializeBinaryFromReader(message: PauseSqlQueryResponse, reader: jspb.BinaryReader): PauseSqlQueryResponse;
}

export namespace PauseSqlQueryResponse {
  export type AsObject = {
  }
}

export class ResumeSqlQueryRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): ResumeSqlQueryRequest;

  getName(): string;
  setName(value: string): ResumeSqlQueryRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ResumeSqlQueryRequest.AsObject;
  static toObject(includeInstance: boolean, msg: ResumeSqlQueryRequest): ResumeSqlQueryRequest.AsObject;
  static serializeBinaryToWriter(message: ResumeSqlQueryRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ResumeSqlQueryRequest;
  static deserializeBinaryFromReader(message: ResumeSqlQueryRequest, reader: jspb.BinaryReader): ResumeSqlQueryRequest;
}

export namespace ResumeSqlQueryRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
...
export class ResumeSqlQueryResponse extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ResumeSqlQueryResponse.AsObject;
  static toObject(includeInstance: boolean, msg: ResumeSqlQueryResponse): ResumeSqlQueryResponse.AsObject;
  static serializeBinaryToWriter(message: ResumeSqlQueryResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ResumeSqlQueryResponse;
  static deserializeBinaryFromReader(message: ResumeSqlQueryResponse, reader: jspb.BinaryReader): ResumeSqlQueryResponse;
}

export namespace ResumeSqlQueryResponse {
  export type AsObject = {
  }
}
