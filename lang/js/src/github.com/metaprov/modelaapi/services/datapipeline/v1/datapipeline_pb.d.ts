...
export class PauseDataPipelineResponse extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PauseDataPipelineResponse.AsObject;
  static toObject(includeInstance: boolean, msg: PauseDataPipelineResponse): PauseDataPipelineResponse.AsObject;
  static serializeBinaryToWriter(message: PauseDataPipelineResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PauseDataPipelineResponse;
  static deserializeBinaryFromReader(message: PauseDataPipelineResponse, reader: jspb.BinaryReader): PauseDataPipelineResponse;
}

export namespace PauseDataPipelineResponse {
  export type AsObject = {
  }
}

export class PauseDataPipelineRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): PauseDataPipelineRequest;

  getName(): string;
  setName(value: string): PauseDataPipelineRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PauseDataPipelineRequest.AsObject;
  static toObject(includeInstance: boolean, msg: PauseDataPipelineRequest): PauseDataPipelineRequest.AsObject;
  static serializeBinaryToWriter(message: PauseDataPipelineRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PauseDataPipelineRequest;
  static deserializeBinaryFromReader(message: PauseDataPipelineRequest, reader: jspb.BinaryReader): PauseDataPipelineRequest;
}

export namespace PauseDataPipelineRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
...
export class ResumeDataPipelineResponse extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ResumeDataPipelineResponse.AsObject;
  static toObject(includeInstance: boolean, msg: ResumeDataPipelineResponse): ResumeDataPipelineResponse.AsObject;
  static serializeBinaryToWriter(message: ResumeDataPipelineResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ResumeDataPipelineResponse;
  static deserializeBinaryFromReader(message: ResumeDataPipelineResponse, reader: jspb.BinaryReader): ResumeDataPipelineResponse;
}

export namespace ResumeDataPipelineResponse {
  export type AsObject = {
  }
}

export class ResumeDataPipelineRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): ResumeDataPipelineRequest;

  getName(): string;
  setName(value: string): ResumeDataPipelineRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ResumeDataPipelineRequest.AsObject;
  static toObject(includeInstance: boolean, msg: ResumeDataPipelineRequest): ResumeDataPipelineRequest.AsObject;
  static serializeBinaryToWriter(message: ResumeDataPipelineRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ResumeDataPipelineRequest;
  static deserializeBinaryFromReader(message: ResumeDataPipelineRequest, reader: jspb.BinaryReader): ResumeDataPipelineRequest;
}

export namespace ResumeDataPipelineRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
