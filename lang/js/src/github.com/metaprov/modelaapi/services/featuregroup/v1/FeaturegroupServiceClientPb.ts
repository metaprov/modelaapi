...
export class FeatureGroupServiceClient {
  ...
  methodDescriptorPauseFeatureGroup = new grpcWeb.MethodDescriptor(
  ...
  pauseFeatureGroup(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        ...
        request,
        metadata || {},
        this.methodDescriptorPauseFeatureGroup,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
  ...
  methodDescriptorResumeFeatureGroup = new grpcWeb.MethodDescriptor(
  ...
  resumeFeatureGroup(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        ...
        request,
        metadata || {},
        this.methodDescriptorResumeFeatureGroup,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
  ...
  methodDescriptorIngestNow = new grpcWeb.MethodDescriptor(
  ...
  ingestNow(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        ...
        request,
        metadata || {},
        this.methodDescriptorIngestNow,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
  ...
  methodDescriptorSyncNow = new grpcWeb.MethodDescriptor(
