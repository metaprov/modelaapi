...
export class VirtualVolumeServiceClient {
  ...
  methodInfoListVirtualVolumes = new grpcWeb.MethodDescriptor(
    ...
    github_com_metaprov_modelaapi_services_virtualvolume_v1_virtualvolume_pb.ListVirtualVolumesRequest,
  ...
  methodInfoCreateVirtualVolume = new grpcWeb.MethodDescriptor(
    ...
    grpcWeb.MethodType.UNARY,
    github_com_metaprov_modelaapi_services_virtualvolume_v1_virtualvolume_pb.CreateVirtualVolumeRequest,
  ...
  methodInfoGetVirtualVolume = new grpcWeb.MethodDescriptor(
    ...
    grpcWeb.MethodType.UNARY,
    github_com_metaprov_modelaapi_services_virtualvolume_v1_virtualvolume_pb.GetVirtualVolumeRequest,
  ...
  methodInfoUpdateVirtualVolume = new grpcWeb.MethodDescriptor(
    ...
    grpcWeb.MethodType.UNARY,
    github_com_metaprov_modelaapi_services_virtualvolume_v1_virtualvolume_pb.UpdateVirtualVolumeRequest,
  ...
  methodInfoDeleteVirtualVolume = new grpcWeb.MethodDescriptor(
    ...
    grpcWeb.MethodType.UNARY,
    github_com_metaprov_modelaapi_services_virtualvolume_v1_virtualvolume_pb.DeleteVirtualVolumeRequest,
