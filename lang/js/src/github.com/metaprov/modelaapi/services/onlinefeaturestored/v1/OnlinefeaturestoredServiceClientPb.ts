...
export class OnlineFeatureStoreServiceClient {
  ...
  methodDescriptorOnlineGet = new grpcWeb.MethodDescriptor(
  ...
  onlineGet(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        ...
        request,
        metadata || {},
        this.methodDescriptorOnlineGet,
        callback);
    }
  ...
  methodDescriptorPush = new grpcWeb.MethodDescriptor(
