/**
 * @fileoverview gRPC-Web generated client stub for github.com.metaprov.modelaapi.services.notebook.v1
 * @enhanceable
 * @public
 */
...
import * as github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb from '../../../../../../github.com/metaprov/modelaapi/services/notebook/v1/notebook_pb';
...
export class NotebookServiceClient {
  ...
  methodInfoListNotebooks = new grpcWeb.AbstractClientBase.MethodInfo(
    ...
    github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.ListNotebooksResponse.deserializeBinary
  );

  listNotebooks(
    request: github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.ListNotebooksRequest,
    metadata: grpcWeb.Metadata | null): Promise<github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.ListNotebooksResponse>;
  ...
  methodInfoCreateNotebook = new grpcWeb.AbstractClientBase.MethodInfo(
    ...
    github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.CreateNotebookResponse.deserializeBinary
  );

  createNotebook(
    request: github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.CreateNotebookRequest,
    metadata: grpcWeb.Metadata | null): Promise<github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.CreateNotebookResponse>;
  ...
  methodInfoGetNotebook = new grpcWeb.AbstractClientBase.MethodInfo(
    ...
    github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.GetNotebookResponse.deserializeBinary
  );

  getNotebook(
    request: github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.GetNotebookRequest,
    metadata: grpcWeb.Metadata | null): Promise<github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.GetNotebookResponse>;
  ...
  methodInfoUpdateNotebook = new grpcWeb.AbstractClientBase.MethodInfo(
    ...
    github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.UpdateNotebookResponse.deserializeBinary
  );

  updateNotebook(
    request: github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.UpdateNotebookRequest,
    metadata: grpcWeb.Metadata | null): Promise<github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.UpdateNotebookResponse>;
  ...
  methodInfoDeleteNotebook = new grpcWeb.AbstractClientBase.MethodInfo(
    ...
    github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.DeleteNotebookResponse.deserializeBinary
  );

  deleteNotebook(
    request: github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.DeleteNotebookRequest,
    metadata: grpcWeb.Metadata | null): Promise<github_com_metaprov_modelaapi_services_notebook_v1_notebook_pb.DeleteNotebookResponse>;
