...
export class PauseWebRequestRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): PauseWebRequestRequest;

  getName(): string;
  setName(value: string): PauseWebRequestRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PauseWebRequestRequest.AsObject;
  static toObject(includeInstance: boolean, msg: PauseWebRequestRequest): PauseWebRequestRequest.AsObject;
  static serializeBinaryToWriter(message: PauseWebRequestRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PauseWebRequestRequest;
  static deserializeBinaryFromReader(message: PauseWebRequestRequest, reader: jspb.BinaryReader): PauseWebRequestRequest;
}

export namespace PauseWebRequestRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
...
export class PauseWebRequestResponse extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PauseWebRequestResponse.AsObject;
  static toObject(includeInstance: boolean, msg: PauseWebRequestResponse): PauseWebRequestResponse.AsObject;
  static serializeBinaryToWriter(message: PauseWebRequestResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PauseWebRequestResponse;
  static deserializeBinaryFromReader(message: PauseWebRequestResponse, reader: jspb.BinaryReader): PauseWebRequestResponse;
}

export namespace PauseWebRequestResponse {
  export type AsObject = {
  }
}

export class ResumeWebRequestRequest extends jspb.Message {
  getNamespace(): string;
  setNamespace(value: string): ResumeWebRequestRequest;

  getName(): string;
  setName(value: string): ResumeWebRequestRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ResumeWebRequestRequest.AsObject;
  static toObject(includeInstance: boolean, msg: ResumeWebRequestRequest): ResumeWebRequestRequest.AsObject;
  static serializeBinaryToWriter(message: ResumeWebRequestRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ResumeWebRequestRequest;
  static deserializeBinaryFromReader(message: ResumeWebRequestRequest, reader: jspb.BinaryReader): ResumeWebRequestRequest;
}

export namespace ResumeWebRequestRequest {
  export type AsObject = {
    namespace: string,
    name: string,
  }
...
export class ResumeWebRequestResponse extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ResumeWebRequestResponse.AsObject;
  static toObject(includeInstance: boolean, msg: ResumeWebRequestResponse): ResumeWebRequestResponse.AsObject;
  static serializeBinaryToWriter(message: ResumeWebRequestResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ResumeWebRequestResponse;
  static deserializeBinaryFromReader(message: ResumeWebRequestResponse, reader: jspb.BinaryReader): ResumeWebRequestResponse;
}

export namespace ResumeWebRequestResponse {
  export type AsObject = {
  }
}
