...
export class ObjectstoreServiceClient {
  ...
  methodInfoArchive = new grpcWeb.MethodDescriptor(
  ...
  methodInfoRecover = new grpcWeb.MethodDescriptor(
  ...
  methodInfoExistInVirtualBucket = new grpcWeb.MethodDescriptor(
