...
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictionStatus.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getRunsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(15, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.ForecastRunResult.serializeBinaryToWriter);
  }
  f = message.getConditionsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
...
/**
 * map<string, ForecastRunResult> runs = 15;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.ForecastRunResult>}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictionStatus.prototype.getRunsMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictionStatus} returns this
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictionStatus.prototype.clearRunsMap = function() {
  this.getRunsMap().clear();
  return this;};
