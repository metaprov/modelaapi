...
goog.exportSymbol('proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus', null, global);
 ...
 * @constructor
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.displayName = 'proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
/**
 * optional int32 periodSeconds = 9;
 * @return {number}
 */
...
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      var value = new k8s_io_api_core_v1_generated_pb.ObjectReference;
      reader.readMessage(value,k8s_io_api_core_v1_generated_pb.ObjectReference.deserializeBinaryFromReader);
      msg.setFeedbackdatasetref(value);
      break;
    case 3:
      var value = new k8s_io_api_core_v1_generated_pb.ObjectReference;
      reader.readMessage(value,k8s_io_api_core_v1_generated_pb.ObjectReference.deserializeBinaryFromReader);
...
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getFeedbackdatasetref();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
...
/**
 * optional k8s.io.api.core.v1.ObjectReference feedbackDatasetRef = 2;
 * @return {?proto.k8s.io.api.core.v1.ObjectReference}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec.prototype.getFeedbackdatasetref = function() {
  return /** @type{?proto.k8s.io.api.core.v1.ObjectReference} */ (
    jspb.Message.getWrapperField(this, k8s_io_api_core_v1_generated_pb.ObjectReference, 2));
};
 ...
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec} returns this
*/
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec.prototype.setFeedbackdatasetref = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec} returns this
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec.prototype.clearFeedbackdatasetref = function() {
  return this.setFeedbackdatasetref(undefined);
};
 ...
 * @return {boolean}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec.prototype.hasFeedbackdatasetref = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {?proto.k8s.io.api.core.v1.ObjectReference}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec.prototype.getTrainingdatasetref = function() {
  return /** @type{?proto.k8s.io.api.core.v1.ObjectReference} */ (
    jspb.Message.getWrapperField(this, k8s_io_api_core_v1_generated_pb.ObjectReference, 3));
};
 ...
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec} returns this
*/
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec.prototype.setTrainingdatasetref = function(value) {
  return jspb.Message.setWrapperField(this, 3, value);
};
 ...
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec} returns this
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec.prototype.clearTrainingdatasetref = function() {
 ...
 * @return {boolean}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestSpec.prototype.hasTrainingdatasetref = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {!Object}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.prototype.toObject = function(opt_includeInstance) {
  return proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    results: (f = msg.getResults()) && github_com_metaprov_modelaapi_pkg_apis_catalog_v1alpha1_generated_pb.TestSuiteResult.toObject(includeInstance, f),
    lastrun: (f = msg.getLastrun()) && k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.Time.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus;
  return proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getResults();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.github.com.metaprov.modelaapi.pkg.apis.catalog.v1alpha1.TestSuiteResult}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.prototype.getResults = function() {
  return /** @type{?proto.github.com.metaprov.modelaapi.pkg.apis.catalog.v1alpha1.TestSuiteResult} */ (
    jspb.Message.getWrapperField(this, github_com_metaprov_modelaapi_pkg_apis_catalog_v1alpha1_generated_pb.TestSuiteResult, 1));
};
...
/**
 * @param {?proto.github.com.metaprov.modelaapi.pkg.apis.catalog.v1alpha1.TestSuiteResult|undefined} value
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus} returns this
*/
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.prototype.setResults = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus} returns this
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.prototype.clearResults = function() {
  return this.setResults(undefined);
};
 ...
 * @return {boolean}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.prototype.hasResults = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {?proto.k8s.io.apimachinery.pkg.apis.meta.v1.Time}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.prototype.getLastrun = function() {
  return /** @type{?proto.k8s.io.apimachinery.pkg.apis.meta.v1.Time} */ (
    jspb.Message.getWrapperField(this, k8s_io_apimachinery_pkg_apis_meta_v1_generated_pb.Time, 2));
};
 ...
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus} returns this
*/
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.prototype.setLastrun = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus} returns this
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.prototype.clearLastrun = function() {
  return this.setLastrun(undefined);
};
 ...
 * @return {boolean}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.prototype.hasLastrun = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    feedbacktests: (f = msg.getFeedbacktests()) && proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.toObject(includeInstance, f),
    driftstatus: (f = msg.getDriftstatus()) && proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.DriftDetectionStatus.toObject(includeInstance, f),
    conditionsList: jspb.Message.toObjectList(msg.getConditionsList(),
...
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 13:
      ...
      break;
    case 14:
      var value = new proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus;
      reader.readMessage(value,proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.deserializeBinaryFromReader);
      msg.setFeedbacktests(value);
      break;
    case 15:
...
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getFeedbacktests();
  if (f != null) {
    writer.writeMessage(
      14,
      f,
      proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus.serializeBinaryToWriter
    );
  }
  f = message.getDriftstatus();
  if (f != null) {
    writer.writeMessage(
      15,
      f,
...
/**
 * optional FeedbackTestStatus feedbackTests = 14;
 * @return {?proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus.prototype.getFeedbacktests = function() {
  return /** @type{?proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus} */ (
    jspb.Message.getWrapperField(this, proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus, 14));
};


/**
 * @param {?proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.FeedbackTestStatus|undefined} value
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus} returns this
*/
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus.prototype.setFeedbacktests = function(value) {
  return jspb.Message.setWrapperField(this, 14, value);
};
 ...
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus} returns this
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus.prototype.clearFeedbacktests = function() {
  return this.setFeedbacktests(undefined);
};
 ...
 * @return {boolean}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus.prototype.hasFeedbacktests = function() {
  return jspb.Message.getField(this, 14) != null;
};


/**
 * optional DriftDetectionStatus driftStatus = 15;
 * @return {?proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.DriftDetectionStatus}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus.prototype.getDriftstatus = function() {
 ...
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus} returns this
*/
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus.prototype.setDriftstatus = function(value) {
  return jspb.Message.setWrapperField(this, 15, value);
};
 ...
 * @return {!proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus} returns this
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus.prototype.clearDriftstatus = function() {
  return this.setDriftstatus(undefined);
};
 ...
 * @return {boolean}
 */
proto.github.com.metaprov.modelaapi.pkg.apis.inference.v1alpha1.PredictorStatus.prototype.hasDriftstatus = function() {
  return jspb.Message.getField(this, 15) != null;
};
