...
proto.k8s.io.apimachinery.pkg.apis.meta.v1.ExportOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    pb_export: (f = jspb.Message.getBooleanField(msg, 1)) == null ? undefined : f,
    exact: (f = jspb.Message.getBooleanField(msg, 2)) == null ? undefined : f
  };
...
/**
 * @param {boolean} value
 * @return {!proto.k8s.io.apimachinery.pkg.apis.meta.v1.ExportOptions} returns this
 */
