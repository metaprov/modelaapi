...
goog.exportSymbol('proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse', null, global);
 ...
 * @constructor
 */
proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse = function (opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
    /**
     * @public
     * @override
     */
    proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse.displayName = 'proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (jspb.Message.GENERATE_TO_OBJECT) {
     ...
     * @return {!Object}
     */
    proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse.prototype.toObject = function (opt_includeInstance) {
        return proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse.toObject(opt_includeInstance, this);
    };
    /**
     * Static version of the {@see toObject} method.
     * @param {boolean|undefined} includeInstance Deprecated. Whether to include
     *     the JSPB instance for transitional soy proto support:
     *     http://goto/soy-param-migration
     * @param {!proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse} msg The msg instance to transform.
     * @return {!Object}
     * @suppress {unusedLocalVariables} f is only used for nested messages
     */
    proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse.toObject = function (includeInstance, msg) {
        var f, obj = {};
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse}
 */
proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse.deserializeBinary = function (bytes) {
    var reader = new jspb.BinaryReader(bytes);
    var msg = new proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse;
    return proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse.deserializeBinaryFromReader(msg, reader);
};
/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse}
 */
proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse.deserializeBinaryFromReader = function (msg, reader) {
    while (reader.nextField()) {
        if (reader.isEndGroup()) {
            break;
        }
 ...
 * @return {!Uint8Array}
 */
proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse.prototype.serializeBinary = function () {
    var writer = new jspb.BinaryWriter();
    proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse.serializeBinaryToWriter(this, writer);
    return writer.getResultBuffer();
};
/**
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.github.com.metaprov.modeldapi.services.archived.v1.RecordForecastResponse.serializeBinaryToWriter = function (message, writer) {
    var f = undefined;
};
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
...
//# sourceMappingURL=archived_pb.js.map