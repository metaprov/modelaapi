...
var LabelingPipelineRunServiceClient = /** @class */ (function () {
    function LabelingPipelineRunServiceClient(hostname, credentials, options) {
        this.methodInfoListLabelingPipelineRuns = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_labelingpipelinerun_v1_labelingpipelinerun_pb.ListLabelingPipelineRunResponse, function (request) {
        ...
        this.methodInfoCreateLabelingPipelineRun = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_labelingpipelinerun_v1_labelingpipelinerun_pb.CreateLabelingPipelineRunResponse, function (request) {
            return request.serializeBinary();
        ...
        this.methodInfoGetLabelingPipelineRun = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_labelingpipelinerun_v1_labelingpipelinerun_pb.GetLabelingPipelineRunResponse, function (request) {
            return request.serializeBinary();
        ...
        this.methodInfoUpdateLabelingPipelineRun = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_labelingpipelinerun_v1_labelingpipelinerun_pb.UpdateLabelingPipelineRunResponse, function (request) {
            return request.serializeBinary();
        ...
        this.methodInfoDeleteLabelingPipelineRun = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_labelingpipelinerun_v1_labelingpipelinerun_pb.DeleteLabelingPipelineRunResponse, function (request) {
            return request.serializeBinary();
    ...
    LabelingPipelineRunServiceClient.prototype.listLabelingPipelineRuns = function (request, metadata, callback) {
    ...
    LabelingPipelineRunServiceClient.prototype.createLabelingPipelineRun = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
    ...
    LabelingPipelineRunServiceClient.prototype.getLabelingPipelineRun = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
    ...
    LabelingPipelineRunServiceClient.prototype.updateLabelingPipelineRun = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
    ...
    LabelingPipelineRunServiceClient.prototype.deleteLabelingPipelineRun = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
    ...
    return LabelingPipelineRunServiceClient;
}());
export { LabelingPipelineRunServiceClient };
//# sourceMappingURL=LabelingpipelinerunServiceClientPb.js.map