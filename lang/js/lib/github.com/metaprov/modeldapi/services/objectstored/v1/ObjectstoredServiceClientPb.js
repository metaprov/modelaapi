...
export class ObjectstoreServiceClient {
    constructor(hostname, credentials, options) {
        this.methodInfoIngest = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_objectstored_v1_objectstored_pb.ObjectResponse, (request) => {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_objectstored_v1_objectstored_pb.ObjectResponse.deserializeBinary);
        this.methodInfoArchive = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_objectstored_v1_objectstored_pb.ObjectResponse, (request) => {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_objectstored_v1_objectstored_pb.ObjectResponse.deserializeBinary);
        this.methodInfoRecover = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_objectstored_v1_objectstored_pb.ObjectResponse, (request) => {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_objectstored_v1_objectstored_pb.ObjectResponse.deserializeBinary);
        this.methodInfoExistInVirtualBucket = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_objectstored_v1_objectstored_pb.ExistInVirtualBucketResponse, (request) => {
            return request.serializeBinary();
    ...
    archive(request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
    ...
    recover(request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
    ...
    existInVirtualBucket(request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
