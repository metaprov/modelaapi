...
export class PredictionStoreServiceClient {
    constructor(hostname, credentials, options) {
        this.methodInfoIngest = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_predictionstore_v1_predictionstore_pb.PredictionIngestResponse, (request) => {
