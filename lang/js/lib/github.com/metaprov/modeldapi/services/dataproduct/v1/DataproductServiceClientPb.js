...
var DataProductServiceClient = /** @class */ (function () {
    function DataProductServiceClient(hostname, credentials, options) {
        this.methodInfoListDataProducts = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_dataproduct_v1_dataproduct_pb.ListDataProductsResponse, function (request) {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_dataproduct_v1_dataproduct_pb.ListDataProductsResponse.deserializeBinary);
        this.methodInfoCreateDataProduct = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_dataproduct_v1_dataproduct_pb.CreateDataProductResponse, function (request) {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_dataproduct_v1_dataproduct_pb.CreateDataProductResponse.deserializeBinary);
        this.methodInfoGetDataProduct = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_dataproduct_v1_dataproduct_pb.GetDataProductResponse, function (request) {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_dataproduct_v1_dataproduct_pb.GetDataProductResponse.deserializeBinary);
        this.methodInfoUpdateDataProduct = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_dataproduct_v1_dataproduct_pb.UpdateDataProductResponse, function (request) {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_dataproduct_v1_dataproduct_pb.UpdateDataProductResponse.deserializeBinary);
        this.methodInfoDeleteDataProduct = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_dataproduct_v1_dataproduct_pb.DeleteDataProductResponse, function (request) {
            return request.serializeBinary();
    ...
    DataProductServiceClient.prototype.listDataProducts = function (request, metadata, callback) {
    ...
    DataProductServiceClient.prototype.createDataProduct = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
    ...
    DataProductServiceClient.prototype.getDataProduct = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
    ...
    DataProductServiceClient.prototype.updateDataProduct = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
    ...
    DataProductServiceClient.prototype.deleteDataProduct = function (request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
...
export { DataProductServiceClient };
//# sourceMappingURL=DataproductServiceClientPb.js.map