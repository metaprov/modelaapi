...
proto.github.com.metaprov.modeldapi.services.predictionpipelinerun.v1.ListPredictionPipelineRunsResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getItems();
    if (f != null) {
        writer.writeMessage(1, f, github_com_metaprov_modeldapi_pkg_apis_inference_v1alpha1_generated_pb.PredictionPipelineRunList.serializeBinaryToWriter);
    }
};
/**
...
proto.github.com.metaprov.modeldapi.services.predictionpipelinerun.v1.ListPredictionPipelineRunsResponse.prototype.getItems = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.PredictionPipelineRunList} */ (jspb.Message.getWrapperField(this, github_com_metaprov_modeldapi_pkg_apis_inference_v1alpha1_generated_pb.PredictionPipelineRunList, 1));
};
/**
...
proto.github.com.metaprov.modeldapi.services.predictionpipelinerun.v1.CreatePredictionPipelineRunRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getSpec();
    if (f != null) {
        writer.writeMessage(5, f, github_com_metaprov_modeldapi_pkg_apis_inference_v1alpha1_generated_pb.PredictionPipelineRunSpec.serializeBinaryToWriter);
    }
};
/**
 * optional string namespace = 1;
...
proto.github.com.metaprov.modeldapi.services.predictionpipelinerun.v1.CreatePredictionPipelineRunRequest.prototype.getSpec = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.PredictionPipelineRunSpec} */ (jspb.Message.getWrapperField(this, github_com_metaprov_modeldapi_pkg_apis_inference_v1alpha1_generated_pb.PredictionPipelineRunSpec, 5));
};
/**
...
proto.github.com.metaprov.modeldapi.services.predictionpipelinerun.v1.GetPredictionPipelineRunResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getItem();
    if (f != null) {
        writer.writeMessage(1, f, github_com_metaprov_modeldapi_pkg_apis_inference_v1alpha1_generated_pb.PredictionPipelineRun.serializeBinaryToWriter);
    }
    f = message.getYaml();
    if (f.length > 0) {
        writer.writeString(2, f);
...
proto.github.com.metaprov.modeldapi.services.predictionpipelinerun.v1.GetPredictionPipelineRunResponse.prototype.getItem = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.pkg.apis.inference.v1alpha1.PredictionPipelineRun} */ (jspb.Message.getWrapperField(this, github_com_metaprov_modeldapi_pkg_apis_inference_v1alpha1_generated_pb.PredictionPipelineRun, 1));
};
/**
...
//# sourceMappingURL=predictionpipelinerun_pb.js.map