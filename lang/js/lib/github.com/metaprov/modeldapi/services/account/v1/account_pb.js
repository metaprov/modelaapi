...
proto.github.com.metaprov.modeldapi.services.account.v1.ListAccountsResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getItems();
    if (f != null) {
        writer.writeMessage(1, f, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.AccountList.serializeBinaryToWriter);
    }
};
/**
...
proto.github.com.metaprov.modeldapi.services.account.v1.ListAccountsResponse.prototype.getItems = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.pkg.apis.infra.v1alpha1.AccountList} */ (jspb.Message.getWrapperField(this, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.AccountList, 1));
};
/**
...
proto.github.com.metaprov.modeldapi.services.account.v1.CreateAccountRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getSpec();
    if (f != null) {
        writer.writeMessage(4, f, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.AccountSpec.serializeBinaryToWriter);
    }
...
proto.github.com.metaprov.modeldapi.services.account.v1.CreateAccountRequest.prototype.getSpec = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.pkg.apis.infra.v1alpha1.AccountSpec} */ (jspb.Message.getWrapperField(this, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.AccountSpec, 4));
};
/**
...
proto.github.com.metaprov.modeldapi.services.account.v1.UpdateAccountRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getSpec();
    if (f != null) {
        writer.writeMessage(5, f, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.AccountSpec.serializeBinaryToWriter);
    }
};
/**
 * optional string namespace = 1;
...
proto.github.com.metaprov.modeldapi.services.account.v1.UpdateAccountRequest.prototype.getSpec = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.pkg.apis.infra.v1alpha1.AccountSpec} */ (jspb.Message.getWrapperField(this, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.AccountSpec, 5));
};
/**
 * @param {?proto.github.com.metaprov.modeldapi.pkg.apis.infra.v1alpha1.AccountSpec|undefined} value
 * @return {!proto.github.com.metaprov.modeldapi.services.account.v1.UpdateAccountRequest} returns this
...
proto.github.com.metaprov.modeldapi.services.account.v1.GetAccountResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getItem();
    if (f != null) {
        writer.writeMessage(1, f, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.Account.serializeBinaryToWriter);
    }
    f = message.getYaml();
    if (f.length > 0) {
        writer.writeString(2, f);
...
proto.github.com.metaprov.modeldapi.services.account.v1.GetAccountResponse.prototype.getItem = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.pkg.apis.infra.v1alpha1.Account} */ (jspb.Message.getWrapperField(this, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.Account, 1));
};
/**
