...
proto.github.com.metaprov.modeldapi.services.servingsite.v1.ListServingSitesResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getItems();
    if (f != null) {
        writer.writeMessage(1, f, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSiteList.serializeBinaryToWriter);
    }
};
/**
...
proto.github.com.metaprov.modeldapi.services.servingsite.v1.ListServingSitesResponse.prototype.getItems = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.pkg.apis.infra.v1alpha1.ServingSiteList} */ (jspb.Message.getWrapperField(this, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSiteList, 1));
};
/**
...
proto.github.com.metaprov.modeldapi.services.servingsite.v1.CreateServingSiteRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getSpec();
    if (f != null) {
        writer.writeMessage(4, f, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSiteSpec.serializeBinaryToWriter);
    }
};
/**
 * optional string namespace = 1;
...
proto.github.com.metaprov.modeldapi.services.servingsite.v1.CreateServingSiteRequest.prototype.getSpec = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.pkg.apis.infra.v1alpha1.ServingSiteSpec} */ (jspb.Message.getWrapperField(this, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSiteSpec, 4));
};
/**
...
proto.github.com.metaprov.modeldapi.services.servingsite.v1.UpdateServingSiteRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getSpec();
    if (f != null) {
        writer.writeMessage(5, f, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSiteSpec.serializeBinaryToWriter);
    }
};
/**
 * optional string namespace = 1;
...
proto.github.com.metaprov.modeldapi.services.servingsite.v1.UpdateServingSiteRequest.prototype.getSpec = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.pkg.apis.infra.v1alpha1.ServingSiteSpec} */ (jspb.Message.getWrapperField(this, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSiteSpec, 5));
};
/**
 * @param {?proto.github.com.metaprov.modeldapi.pkg.apis.infra.v1alpha1.ServingSiteSpec|undefined} value
 * @return {!proto.github.com.metaprov.modeldapi.services.servingsite.v1.UpdateServingSiteRequest} returns this
...
proto.github.com.metaprov.modeldapi.services.servingsite.v1.GetServingSiteResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getItem();
    if (f != null) {
        writer.writeMessage(1, f, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSite.serializeBinaryToWriter);
    }
    f = message.getYaml();
    if (f.length > 0) {
        writer.writeString(2, f);
...
proto.github.com.metaprov.modeldapi.services.servingsite.v1.GetServingSiteResponse.prototype.getItem = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.pkg.apis.infra.v1alpha1.ServingSite} */ (jspb.Message.getWrapperField(this, github_com_metaprov_modeldapi_pkg_apis_infra_v1alpha1_generated_pb.ServingSite, 1));
};
/**
...
//# sourceMappingURL=servingsite_pb.js.map