...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.github.com.metaprov.modeldapi.services.common.v1.DatasetProfile.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            plotsList: jspb.Message.toObjectList(msg.getPlotsList(), proto.github.com.metaprov.modeldapi.services.common.v1.Plot.toObject, includeInstance),
            columnsList: jspb.Message.toObjectList(msg.getColumnsList(), proto.github.com.metaprov.modeldapi.services.common.v1.ColumnProfile.toObject, includeInstance),
...
proto.github.com.metaprov.modeldapi.services.common.v1.DatasetProfile.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(5, f, proto.github.com.metaprov.modeldapi.services.common.v1.Plot.serializeBinaryToWriter);
    }
    f = message.getColumnsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(6, f, proto.github.com.metaprov.modeldapi.services.common.v1.ColumnProfile.serializeBinaryToWriter);
    }
    f = message.getTable();
    if (f != null) {
        writer.writeMessage(7, f, proto.github.com.metaprov.modeldapi.services.common.v1.TableView.serializeBinaryToWriter);
    }
};
/**
...
proto.github.com.metaprov.modeldapi.services.common.v1.DatasetProfile.prototype.getPlotsList = function () {
    return /** @type{!Array<!proto.github.com.metaprov.modeldapi.services.common.v1.Plot>} */ (jspb.Message.getRepeatedWrapperField(this, proto.github.com.metaprov.modeldapi.services.common.v1.Plot, 5));
};
/**
...
proto.github.com.metaprov.modeldapi.services.common.v1.DatasetProfile.prototype.getColumnsList = function () {
    return /** @type{!Array<!proto.github.com.metaprov.modeldapi.services.common.v1.ColumnProfile>} */ (jspb.Message.getRepeatedWrapperField(this, proto.github.com.metaprov.modeldapi.services.common.v1.ColumnProfile, 6));
};
/**
...
proto.github.com.metaprov.modeldapi.services.common.v1.DatasetProfile.prototype.getTable = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.services.common.v1.TableView} */ (jspb.Message.getWrapperField(this, proto.github.com.metaprov.modeldapi.services.common.v1.TableView, 7));
};
/**
...
proto.github.com.metaprov.modeldapi.services.common.v1.ModelProfile.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getPlotsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.github.com.metaprov.modeldapi.services.common.v1.Plot.serializeBinaryToWriter);
    }
};
/**
...
proto.github.com.metaprov.modeldapi.services.common.v1.ModelProfile.prototype.getPlotsList = function () {
    return /** @type{!Array<!proto.github.com.metaprov.modeldapi.services.common.v1.Plot>} */ (jspb.Message.getRepeatedWrapperField(this, proto.github.com.metaprov.modeldapi.services.common.v1.Plot, 2));
};
/**
 * @param {!Array<!proto.github.com.metaprov.modeldapi.services.common.v1.Plot>} value
 * @return {!proto.github.com.metaprov.modeldapi.services.common.v1.ModelProfile} returns this
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.github.com.metaprov.modeldapi.services.common.v1.StudyProfile.toObject = function (includeInstance, msg) {
        var f, obj = {
            plotsList: jspb.Message.toObjectList(msg.getPlotsList(), proto.github.com.metaprov.modeldapi.services.common.v1.Plot.toObject, includeInstance),
            modelsList: jspb.Message.toObjectList(msg.getModelsList(), proto.github.com.metaprov.modeldapi.services.common.v1.ModelProfile.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.github.com.metaprov.modeldapi.services.common.v1.StudyProfile.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getPlotsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.github.com.metaprov.modeldapi.services.common.v1.Plot.serializeBinaryToWriter);
    }
    f = message.getModelsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.github.com.metaprov.modeldapi.services.common.v1.ModelProfile.serializeBinaryToWriter);
    }
};
/**
...
proto.github.com.metaprov.modeldapi.services.common.v1.StudyProfile.prototype.getPlotsList = function () {
    return /** @type{!Array<!proto.github.com.metaprov.modeldapi.services.common.v1.Plot>} */ (jspb.Message.getRepeatedWrapperField(this, proto.github.com.metaprov.modeldapi.services.common.v1.Plot, 1));
};
/**
 * @param {!Array<!proto.github.com.metaprov.modeldapi.services.common.v1.Plot>} value
...
proto.github.com.metaprov.modeldapi.services.common.v1.StudyProfile.prototype.getModelsList = function () {
    return /** @type{!Array<!proto.github.com.metaprov.modeldapi.services.common.v1.ModelProfile>} */ (jspb.Message.getRepeatedWrapperField(this, proto.github.com.metaprov.modeldapi.services.common.v1.ModelProfile, 2));
};
/**
...
proto.github.com.metaprov.modeldapi.services.common.v1.Plot.prototype.getImg_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getImg()));
};
/**
 * optional bytes img = 3;
...
proto.github.com.metaprov.modeldapi.services.common.v1.Plot.prototype.getImg_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getImg()));
};
/**
...
proto.github.com.metaprov.modeldapi.services.common.v1.ColumnProfile.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(29, f, proto.github.com.metaprov.modeldapi.services.common.v1.Histogram.serializeBinaryToWriter);
    }
};
/**
 * optional string name = 1;
...
proto.github.com.metaprov.modeldapi.services.common.v1.ColumnProfile.prototype.getHistogram = function () {
    return /** @type{?proto.github.com.metaprov.modeldapi.services.common.v1.Histogram} */ (jspb.Message.getWrapperField(this, proto.github.com.metaprov.modeldapi.services.common.v1.Histogram, 29));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.github.com.metaprov.modeldapi.services.common.v1.Histogram.toObject = function (includeInstance, msg) {
        var f, obj = {
            valuesList: jspb.Message.toObjectList(msg.getValuesList(), proto.github.com.metaprov.modeldapi.services.common.v1.HistogramValue.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.github.com.metaprov.modeldapi.services.common.v1.Histogram.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.github.com.metaprov.modeldapi.services.common.v1.HistogramValue.serializeBinaryToWriter);
    }
};
/**
...
proto.github.com.metaprov.modeldapi.services.common.v1.Histogram.prototype.getValuesList = function () {
    return /** @type{!Array<!proto.github.com.metaprov.modeldapi.services.common.v1.HistogramValue>} */ (jspb.Message.getRepeatedWrapperField(this, proto.github.com.metaprov.modeldapi.services.common.v1.HistogramValue, 1));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.github.com.metaprov.modeldapi.services.common.v1.TableView.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            rowsList: jspb.Message.toObjectList(msg.getRowsList(), proto.github.com.metaprov.modeldapi.services.common.v1.TableViewRow.toObject, includeInstance),
            profilesList: jspb.Message.toObjectList(msg.getProfilesList(), proto.github.com.metaprov.modeldapi.services.common.v1.ColumnProfile.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.github.com.metaprov.modeldapi.services.common.v1.TableView.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.github.com.metaprov.modeldapi.services.common.v1.TableViewRow.serializeBinaryToWriter);
    }
    f = message.getProfilesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.github.com.metaprov.modeldapi.services.common.v1.ColumnProfile.serializeBinaryToWriter);
    }
};
/**
...
proto.github.com.metaprov.modeldapi.services.common.v1.TableView.prototype.getRowsList = function () {
    return /** @type{!Array<!proto.github.com.metaprov.modeldapi.services.common.v1.TableViewRow>} */ (jspb.Message.getRepeatedWrapperField(this, proto.github.com.metaprov.modeldapi.services.common.v1.TableViewRow, 2));
};
/**
...
proto.github.com.metaprov.modeldapi.services.common.v1.TableView.prototype.getProfilesList = function () {
    return /** @type{!Array<!proto.github.com.metaprov.modeldapi.services.common.v1.ColumnProfile>} */ (jspb.Message.getRepeatedWrapperField(this, proto.github.com.metaprov.modeldapi.services.common.v1.ColumnProfile, 3));
};
/**
 * @param {!Array<!proto.github.com.metaprov.modeldapi.services.common.v1.ColumnProfile>} value
 * @return {!proto.github.com.metaprov.modeldapi.services.common.v1.TableView} returns this
