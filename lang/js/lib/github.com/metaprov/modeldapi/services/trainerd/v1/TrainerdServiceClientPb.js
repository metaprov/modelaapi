...
export class TrainerdServiceClient {
    constructor(hostname, credentials, options) {
        this.methodInfoTrain = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_trainerd_v1_trainerd_pb.TrainResponse, (request) => {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_trainerd_v1_trainerd_pb.TrainResponse.deserializeBinary);
        this.methodInfoForecast = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_trainerd_v1_trainerd_pb.ForecastResponse, (request) => {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_trainerd_v1_trainerd_pb.ForecastResponse.deserializeBinary);
        this.methodInfoTest = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_trainerd_v1_trainerd_pb.TestResponse, (request) => {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_trainerd_v1_trainerd_pb.TestResponse.deserializeBinary);
        this.methodInfoTrainEnsemble = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_trainerd_v1_trainerd_pb.TrainResponse, (request) => {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_trainerd_v1_trainerd_pb.TrainResponse.deserializeBinary);
        this.methodInfoTestEnsemble = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_trainerd_v1_trainerd_pb.TestResponse, (request) => {
            return request.serializeBinary();
        }, github_com_metaprov_modeldapi_services_trainerd_v1_trainerd_pb.TestResponse.deserializeBinary);
        this.methodInfoShutdown = new grpcWeb.AbstractClientBase.MethodInfo(github_com_metaprov_modeldapi_services_trainerd_v1_trainerd_pb.ShutdownResponse, (request) => {
            return request.serializeBinary();
    ...
    train(request, metadata, callback) {
    ...
    forecast(request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
    ...
    trainEnsemble(request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
    ...
    testEnsemble(request, metadata, callback) {
        if (callback !== undefined) {
            return this.client_.rpcCall(this.hostname_ +
