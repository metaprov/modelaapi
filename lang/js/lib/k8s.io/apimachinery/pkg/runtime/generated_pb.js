...
proto.k8s.io.apimachinery.pkg.runtime.Unknown.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.k8s.io.apimachinery.pkg.runtime.TypeMeta.serializeBinaryToWriter);
    }
...
proto.k8s.io.apimachinery.pkg.runtime.Unknown.prototype.getTypemeta = function () {
    return /** @type{?proto.k8s.io.apimachinery.pkg.runtime.TypeMeta} */ (jspb.Message.getWrapperField(this, proto.k8s.io.apimachinery.pkg.runtime.TypeMeta, 1));
};
/**
