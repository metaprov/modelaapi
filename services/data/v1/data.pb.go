...
import (
	context "context"
	_ "github.com/metaprov/modelaapi/pkg/apis/catalog/v1alpha1/v1alpha1"
...
var file_github_com_metaprov_modelaapi_services_data_v1_data_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x32, 0x8d, 0x34, 0x0a, 0x0b, 0x44, 0x61, 0x74, 0x61, 0x53, 0x65, 0x72,
	...
	,
...
var file_github_com_metaprov_modelaapi_services_data_v1_data_proto_depIdxs = []int32{
	...
	49,  // 298: github.com.metaprov.modelaapi.services.data.v1.DataService.AskFE:input_type -> github.com.metaprov.modelaapi.services.data.v1.AskModelRequest
	53,  // 299: github.com.metaprov.modelaapi.services.data.v1.DataService.TellFE:input_type -> github.com.metaprov.modelaapi.services.data.v1.TellModelRequest
	...
	51,  // 301: github.com.metaprov.modelaapi.services.data.v1.DataService.AskAllModelsForTask:input_type -> github.com.metaprov.modelaapi.services.data.v1.AskAllModelsForTaskRequest
	53,  // 302: github.com.metaprov.modelaapi.services.data.v1.DataService.TellModel:input_type -> github.com.metaprov.modelaapi.services.data.v1.TellModelRequest
	...
	57,  // 305: github.com.metaprov.modelaapi.services.data.v1.DataService.ValidateModel:input_type -> github.com.metaprov.modelaapi.services.data.v1.ValidateModelRequest
	59,  // 306: github.com.metaprov.modelaapi.services.data.v1.DataService.DsTestConnection:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsTestConnectionRequest
	55,  // 307: github.com.metaprov.modelaapi.services.data.v1.DataService.ShutDown:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsShutdownRequest
	61,  // 308: github.com.metaprov.modelaapi.services.data.v1.DataService.StudyEnded:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsStudyEndedRequest
	63,  // 309: github.com.metaprov.modelaapi.services.data.v1.DataService.SaveOptimizerDB:input_type -> github.com.metaprov.modelaapi.services.data.v1.SaveOptimizerDBRequest
	65,  // 310: github.com.metaprov.modelaapi.services.data.v1.DataService.GetDatabases:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetDatabasesRequest
	67,  // 311: github.com.metaprov.modelaapi.services.data.v1.DataService.GetTables:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetTablesRequest
	69,  // 312: github.com.metaprov.modelaapi.services.data.v1.DataService.ExecuteSql:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsExecuteSqlRequest
	71,  // 313: github.com.metaprov.modelaapi.services.data.v1.DataService.Snapshot:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsSnapshotRequest
	73,  // 314: github.com.metaprov.modelaapi.services.data.v1.DataService.EngineerFeatures:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsEngineerFeaturesRequest
	...
	26,  // 321: github.com.metaprov.modelaapi.services.data.v1.DataService.ValidateDataset:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsValidateDatasetResponse
	28,  // 322: github.com.metaprov.modelaapi.services.data.v1.DataService.GenerateDataset:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsGenerateDatasetResponse
	32,  // 323: github.com.metaprov.modelaapi.services.data.v1.DataService.SplitDataset:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsSplitDatasetResponse
	34,  // 324: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateColumnProfile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateColumnProfileResponse
	38,  // 325: github.com.metaprov.modelaapi.services.data.v1.DataService.InferSchema:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsInferSchemaResponse
	40,  // 326: github.com.metaprov.modelaapi.services.data.v1.DataService.GetTableView:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetTableViewResponse
	42,  // 327: github.com.metaprov.modelaapi.services.data.v1.DataService.GetMisclassTableView:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetMisclassTableViewResponse
	31,  // 328: github.com.metaprov.modelaapi.services.data.v1.DataService.SplitDatasetToRungs:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsSplitDatasetToRungsResponse
	15,  // 329: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateDatasetProfile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateDatasetProfileResponse
	17,  // 330: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateModelProfile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateModelProfileResponse
	24,  // 331: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateStudyProfile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateStudyProfileResponse
	11,  // 332: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateRecipeProfile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateRecipeProfileResponse
	46,  // 333: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateModelReport:output_type -> github.com.metaprov.modelaapi.services.data.v1.CreateReportResponse
	46,  // 334: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateStudyReport:output_type -> github.com.metaprov.modelaapi.services.data.v1.CreateReportResponse
	46,  // 335: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateDatasetReport:output_type -> github.com.metaprov.modelaapi.services.data.v1.CreateReportResponse
	46,  // 336: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateForecastReport:output_type -> github.com.metaprov.modelaapi.services.data.v1.CreateReportResponse
	46,  // 337: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateSummaryReport:output_type -> github.com.metaprov.modelaapi.services.data.v1.CreateReportResponse
	50,  // 338: github.com.metaprov.modelaapi.services.data.v1.DataService.AskFE:output_type -> github.com.metaprov.modelaapi.services.data.v1.AskModelResponse
	54,  // 339: github.com.metaprov.modelaapi.services.data.v1.DataService.TellFE:output_type -> github.com.metaprov.modelaapi.services.data.v1.TellModelResponse
	50,  // 340: github.com.metaprov.modelaapi.services.data.v1.DataService.AskModel:output_type -> github.com.metaprov.modelaapi.services.data.v1.AskModelResponse
	52,  // 341: github.com.metaprov.modelaapi.services.data.v1.DataService.AskAllModelsForTask:output_type -> github.com.metaprov.modelaapi.services.data.v1.AskAllModelsForTaskResponse
	54,  // 342: github.com.metaprov.modelaapi.services.data.v1.DataService.TellModel:output_type -> github.com.metaprov.modelaapi.services.data.v1.TellModelResponse
	19,  // 343: github.com.metaprov.modelaapi.services.data.v1.DataService.PartitionForecastFile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateForecastPartitionFilesResponse
	22,  // 344: github.com.metaprov.modelaapi.services.data.v1.DataService.MergeForecastFile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsMergeForecastFileResponse
	58,  // 345: github.com.metaprov.modelaapi.services.data.v1.DataService.ValidateModel:output_type -> github.com.metaprov.modelaapi.services.data.v1.ValidateModelResponse
	60,  // 346: github.com.metaprov.modelaapi.services.data.v1.DataService.DsTestConnection:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsTestConnectionResponse
	56,  // 347: github.com.metaprov.modelaapi.services.data.v1.DataService.ShutDown:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsShutdownResponse
	62,  // 348: github.com.metaprov.modelaapi.services.data.v1.DataService.StudyEnded:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsStudyEndedResponse
	64,  // 349: github.com.metaprov.modelaapi.services.data.v1.DataService.SaveOptimizerDB:output_type -> github.com.metaprov.modelaapi.services.data.v1.SaveOptimizerDBResponse
	66,  // 350: github.com.metaprov.modelaapi.services.data.v1.DataService.GetDatabases:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetDatabasesResponse
	68,  // 351: github.com.metaprov.modelaapi.services.data.v1.DataService.GetTables:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetTablesResponse
	70,  // 352: github.com.metaprov.modelaapi.services.data.v1.DataService.ExecuteSql:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsExecuteSqlResponse
	72,  // 353: github.com.metaprov.modelaapi.services.data.v1.DataService.Snapshot:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsSnapshotResponse
	74,  // 354: github.com.metaprov.modelaapi.services.data.v1.DataService.EngineerFeatures:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsEngineerFeaturesResponse
	315, // [315:355] is the sub-list for method output_type
	275, // [275:315] is the sub-list for method input_type
