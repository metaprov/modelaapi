...
type SyncOnlineStoreRequest struct {
	...
	DbSecret          map[string][]byte            `protobuf:"bytes,7,rep,name=dbSecret,proto3" json:"dbSecret,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Model             *v1alpha12.ModelClass        `protobuf:"bytes,8,opt,name=model,proto3" json:"model,omitempty"`
	Fg                *v1alpha1.FeatureGroup       `protobuf:"bytes,9,opt,name=fg,proto3" json:"fg,omitempty"`
	Location          *v1alpha1.DataLocation       `protobuf:"bytes,10,opt,name=location,proto3" json:"location,omitempty"`
}
...
var file_github_com_metaprov_modelaapi_services_data_v1_data_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0x9f, 0x09, 0x0a, 0x16,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x42, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x70, 0x72, 0x6f, 0x76, 0x2e, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x61, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x6b, 0x67, 0x2e, 0x61, 0x70, 0x69, 0x73, 0x2e,
	0x64, 0x61, 0x74, 0x61, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x46, 0x65,
	0x61, 0x74, 0x75, 0x72, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x02, 0x66, 0x67, 0x12, 0x5e,
	...
	0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x6f,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x32, 0xeb, 0x3d, 0x0a, 0x0b, 0x44, 0x61, 0x74, 0x61, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x61, 0x73, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x30,
...
var file_github_com_metaprov_modelaapi_services_data_v1_data_proto_depIdxs = []int32{
	...
	149, // 316: github.com.metaprov.modelaapi.services.data.v1.SyncOnlineStoreRequest.fg:type_name -> github.com.metaprov.modelaapi.pkg.apis.data.v1alpha1.FeatureGroup
	143, // 317: github.com.metaprov.modelaapi.services.data.v1.SyncOnlineStoreRequest.location:type_name -> github.com.metaprov.modelaapi.pkg.apis.data.v1alpha1.DataLocation
	125, // 318: github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.product:type_name -> github.com.metaprov.modelaapi.pkg.apis.data.v1alpha1.DataProduct
	126, // 319: github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.version:type_name -> github.com.metaprov.modelaapi.pkg.apis.data.v1alpha1.DataProductVersion
	127, // 320: github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.storageConnection:type_name -> github.com.metaprov.modelaapi.pkg.apis.infra.v1alpha1.Connection
	128, // 321: github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.storageBucket:type_name -> github.com.metaprov.modelaapi.pkg.apis.infra.v1alpha1.VirtualBucket
	123, // 322: github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.storageSecret:type_name -> github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.StorageSecretEntry
	127, // 323: github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.dbConnection:type_name -> github.com.metaprov.modelaapi.pkg.apis.infra.v1alpha1.Connection
	124, // 324: github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.dbSecret:type_name -> github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.DbSecretEntry
	147, // 325: github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.model:type_name -> github.com.metaprov.modelaapi.pkg.apis.training.v1alpha1.ModelClass
	148, // 326: github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.entities:type_name -> github.com.metaprov.modelaapi.pkg.apis.data.v1alpha1.Entity
	149, // 327: github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest.groups:type_name -> github.com.metaprov.modelaapi.pkg.apis.data.v1alpha1.FeatureGroup
	143, // 328: github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetResponse.location:type_name -> github.com.metaprov.modelaapi.pkg.apis.data.v1alpha1.DataLocation
	0,   // 329: github.com.metaprov.modelaapi.services.data.v1.DataService.ReadFile:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsReadFileRequest
	1,   // 330: github.com.metaprov.modelaapi.services.data.v1.DataService.ReadFeature:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsReadFeatureRequest
	3,   // 331: github.com.metaprov.modelaapi.services.data.v1.DataService.ReadAudio:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsReadAudioRequest
	6,   // 332: github.com.metaprov.modelaapi.services.data.v1.DataService.RunDataPipeline:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsRunDataPipelineRequest
	8,   // 333: github.com.metaprov.modelaapi.services.data.v1.DataService.RunRecipe:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsRunRecipeRequest
	2,   // 334: github.com.metaprov.modelaapi.services.data.v1.DataService.WriteFile:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsWriteFileRequest
	24,  // 335: github.com.metaprov.modelaapi.services.data.v1.DataService.GenerateDataset:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsGenerateDatasetRequest
	26,  // 336: github.com.metaprov.modelaapi.services.data.v1.DataService.SplitDataset:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsSplitDatasetRequest
	30,  // 337: github.com.metaprov.modelaapi.services.data.v1.DataService.Transform:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsTransformRequest
	32,  // 338: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateColumnProfile:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateColumnProfileRequest
	38,  // 339: github.com.metaprov.modelaapi.services.data.v1.DataService.InferSchema:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsInferSchemaRequest
	40,  // 340: github.com.metaprov.modelaapi.services.data.v1.DataService.GetTableView:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetTableViewRequest
	28,  // 341: github.com.metaprov.modelaapi.services.data.v1.DataService.SplitDatasetToRungs:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsSplitDatasetToRungsRequest
	14,  // 342: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateDatasetProfile:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateDatasetProfileRequest
	16,  // 343: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateModelProfile:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateModelProfileRequest
	20,  // 344: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateStudyProfile:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateStudyProfileRequest
	10,  // 345: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateRecipeProfile:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateRecipeProfileRequest
	42,  // 346: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateModelReport:input_type -> github.com.metaprov.modelaapi.services.data.v1.CreateModelReportRequest
	47,  // 347: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateStudyReport:input_type -> github.com.metaprov.modelaapi.services.data.v1.CreateStudyReportRequest
	46,  // 348: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateDatasetReport:input_type -> github.com.metaprov.modelaapi.services.data.v1.CreateDatasetReportRequest
	43,  // 349: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateForecastReport:input_type -> github.com.metaprov.modelaapi.services.data.v1.CreateForecastReportRequest
	44,  // 350: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateSummaryReport:input_type -> github.com.metaprov.modelaapi.services.data.v1.CreateSummaryReportRequest
	48,  // 351: github.com.metaprov.modelaapi.services.data.v1.DataService.AskFE:input_type -> github.com.metaprov.modelaapi.services.data.v1.AskModelRequest
	55,  // 352: github.com.metaprov.modelaapi.services.data.v1.DataService.AskBaseline:input_type -> github.com.metaprov.modelaapi.services.data.v1.AskBaselineRequest
	53,  // 353: github.com.metaprov.modelaapi.services.data.v1.DataService.AskEnsemble:input_type -> github.com.metaprov.modelaapi.services.data.v1.AskEnsembleRequest
	51,  // 354: github.com.metaprov.modelaapi.services.data.v1.DataService.AskForecastModel:input_type -> github.com.metaprov.modelaapi.services.data.v1.AskForecastModelRequest
	48,  // 355: github.com.metaprov.modelaapi.services.data.v1.DataService.AskModel:input_type -> github.com.metaprov.modelaapi.services.data.v1.AskModelRequest
	57,  // 356: github.com.metaprov.modelaapi.services.data.v1.DataService.AskAllModelsForTask:input_type -> github.com.metaprov.modelaapi.services.data.v1.AskAllModelsForTaskRequest
	59,  // 357: github.com.metaprov.modelaapi.services.data.v1.DataService.TellPartialModel:input_type -> github.com.metaprov.modelaapi.services.data.v1.TellModelRequest
	59,  // 358: github.com.metaprov.modelaapi.services.data.v1.DataService.TellModel:input_type -> github.com.metaprov.modelaapi.services.data.v1.TellModelRequest
	18,  // 359: github.com.metaprov.modelaapi.services.data.v1.DataService.MergeForecastFile:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsMergeForecastFileRequest
	63,  // 360: github.com.metaprov.modelaapi.services.data.v1.DataService.DsTestConnection:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsTestConnectionRequest
	61,  // 361: github.com.metaprov.modelaapi.services.data.v1.DataService.ShutDown:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsShutdownRequest
	65,  // 362: github.com.metaprov.modelaapi.services.data.v1.DataService.StudyEnded:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsStudyEndedRequest
	67,  // 363: github.com.metaprov.modelaapi.services.data.v1.DataService.SaveOptimizerDB:input_type -> github.com.metaprov.modelaapi.services.data.v1.SaveOptimizerDBRequest
	69,  // 364: github.com.metaprov.modelaapi.services.data.v1.DataService.GetDatabases:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetDatabasesRequest
	71,  // 365: github.com.metaprov.modelaapi.services.data.v1.DataService.GetTables:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetTablesRequest
	73,  // 366: github.com.metaprov.modelaapi.services.data.v1.DataService.ExecuteSql:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsExecuteSqlRequest
	75,  // 367: github.com.metaprov.modelaapi.services.data.v1.DataService.Snapshot:input_type -> github.com.metaprov.modelaapi.services.data.v1.DsSnapshotRequest
	22,  // 368: github.com.metaprov.modelaapi.services.data.v1.DataService.UnitTestDataset:input_type -> github.com.metaprov.modelaapi.services.data.v1.RunTestSuiteRequest
	22,  // 369: github.com.metaprov.modelaapi.services.data.v1.DataService.UnitTestModel:input_type -> github.com.metaprov.modelaapi.services.data.v1.RunTestSuiteRequest
	22,  // 370: github.com.metaprov.modelaapi.services.data.v1.DataService.UnitTestFeedback:input_type -> github.com.metaprov.modelaapi.services.data.v1.RunTestSuiteRequest
	22,  // 371: github.com.metaprov.modelaapi.services.data.v1.DataService.UnitTestFeatureHistogram:input_type -> github.com.metaprov.modelaapi.services.data.v1.RunTestSuiteRequest
	22,  // 372: github.com.metaprov.modelaapi.services.data.v1.DataService.UnitTestPredictor:input_type -> github.com.metaprov.modelaapi.services.data.v1.RunTestSuiteRequest
	34,  // 373: github.com.metaprov.modelaapi.services.data.v1.DataService.GroupByDataset:input_type -> github.com.metaprov.modelaapi.services.data.v1.GroupByDatasetRequest
	80,  // 374: github.com.metaprov.modelaapi.services.data.v1.DataService.SyncOnlineStore:input_type -> github.com.metaprov.modelaapi.services.data.v1.SyncOnlineStoreRequest
	78,  // 375: github.com.metaprov.modelaapi.services.data.v1.DataService.GenTrainingData:input_type -> github.com.metaprov.modelaapi.services.data.v1.GenTrainingDataRequest
	82,  // 376: github.com.metaprov.modelaapi.services.data.v1.DataService.GenOnlineStoreDataset:input_type -> github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetRequest
	5,   // 377: github.com.metaprov.modelaapi.services.data.v1.DataService.ReadFile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsReadFromStoreResponse
	5,   // 378: github.com.metaprov.modelaapi.services.data.v1.DataService.ReadFeature:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsReadFromStoreResponse
	5,   // 379: github.com.metaprov.modelaapi.services.data.v1.DataService.ReadAudio:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsReadFromStoreResponse
	7,   // 380: github.com.metaprov.modelaapi.services.data.v1.DataService.RunDataPipeline:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsRunDataPipelineResponse
	9,   // 381: github.com.metaprov.modelaapi.services.data.v1.DataService.RunRecipe:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsRunRecipeResponse
	5,   // 382: github.com.metaprov.modelaapi.services.data.v1.DataService.WriteFile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsReadFromStoreResponse
	25,  // 383: github.com.metaprov.modelaapi.services.data.v1.DataService.GenerateDataset:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsGenerateDatasetResponse
	27,  // 384: github.com.metaprov.modelaapi.services.data.v1.DataService.SplitDataset:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsSplitDatasetResponse
	31,  // 385: github.com.metaprov.modelaapi.services.data.v1.DataService.Transform:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsTransformResponse
	33,  // 386: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateColumnProfile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateColumnProfileResponse
	39,  // 387: github.com.metaprov.modelaapi.services.data.v1.DataService.InferSchema:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsInferSchemaResponse
	41,  // 388: github.com.metaprov.modelaapi.services.data.v1.DataService.GetTableView:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetTableViewResponse
	29,  // 389: github.com.metaprov.modelaapi.services.data.v1.DataService.SplitDatasetToRungs:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsSplitDatasetToRungsResponse
	15,  // 390: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateDatasetProfile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateDatasetProfileResponse
	17,  // 391: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateModelProfile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateModelProfileResponse
	21,  // 392: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateStudyProfile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateStudyProfileResponse
	11,  // 393: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateRecipeProfile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsCreateRecipeProfileResponse
	45,  // 394: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateModelReport:output_type -> github.com.metaprov.modelaapi.services.data.v1.CreateReportResponse
	45,  // 395: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateStudyReport:output_type -> github.com.metaprov.modelaapi.services.data.v1.CreateReportResponse
	45,  // 396: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateDatasetReport:output_type -> github.com.metaprov.modelaapi.services.data.v1.CreateReportResponse
	45,  // 397: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateForecastReport:output_type -> github.com.metaprov.modelaapi.services.data.v1.CreateReportResponse
	45,  // 398: github.com.metaprov.modelaapi.services.data.v1.DataService.CreateSummaryReport:output_type -> github.com.metaprov.modelaapi.services.data.v1.CreateReportResponse
	77,  // 399: github.com.metaprov.modelaapi.services.data.v1.DataService.AskFE:output_type -> github.com.metaprov.modelaapi.services.data.v1.AskModelResponse
	56,  // 400: github.com.metaprov.modelaapi.services.data.v1.DataService.AskBaseline:output_type -> github.com.metaprov.modelaapi.services.data.v1.AskBaselineResponse
	54,  // 401: github.com.metaprov.modelaapi.services.data.v1.DataService.AskEnsemble:output_type -> github.com.metaprov.modelaapi.services.data.v1.AskEnsembleResponse
	52,  // 402: github.com.metaprov.modelaapi.services.data.v1.DataService.AskForecastModel:output_type -> github.com.metaprov.modelaapi.services.data.v1.AskForecastModelResponse
	77,  // 403: github.com.metaprov.modelaapi.services.data.v1.DataService.AskModel:output_type -> github.com.metaprov.modelaapi.services.data.v1.AskModelResponse
	58,  // 404: github.com.metaprov.modelaapi.services.data.v1.DataService.AskAllModelsForTask:output_type -> github.com.metaprov.modelaapi.services.data.v1.AskAllModelsForTaskResponse
	60,  // 405: github.com.metaprov.modelaapi.services.data.v1.DataService.TellPartialModel:output_type -> github.com.metaprov.modelaapi.services.data.v1.TellModelResponse
	60,  // 406: github.com.metaprov.modelaapi.services.data.v1.DataService.TellModel:output_type -> github.com.metaprov.modelaapi.services.data.v1.TellModelResponse
	19,  // 407: github.com.metaprov.modelaapi.services.data.v1.DataService.MergeForecastFile:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsMergeForecastFileResponse
	64,  // 408: github.com.metaprov.modelaapi.services.data.v1.DataService.DsTestConnection:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsTestConnectionResponse
	62,  // 409: github.com.metaprov.modelaapi.services.data.v1.DataService.ShutDown:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsShutdownResponse
	66,  // 410: github.com.metaprov.modelaapi.services.data.v1.DataService.StudyEnded:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsStudyEndedResponse
	68,  // 411: github.com.metaprov.modelaapi.services.data.v1.DataService.SaveOptimizerDB:output_type -> github.com.metaprov.modelaapi.services.data.v1.SaveOptimizerDBResponse
	70,  // 412: github.com.metaprov.modelaapi.services.data.v1.DataService.GetDatabases:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetDatabasesResponse
	72,  // 413: github.com.metaprov.modelaapi.services.data.v1.DataService.GetTables:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsGetTablesResponse
	74,  // 414: github.com.metaprov.modelaapi.services.data.v1.DataService.ExecuteSql:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsExecuteSqlResponse
	76,  // 415: github.com.metaprov.modelaapi.services.data.v1.DataService.Snapshot:output_type -> github.com.metaprov.modelaapi.services.data.v1.DsSnapshotResponse
	23,  // 416: github.com.metaprov.modelaapi.services.data.v1.DataService.UnitTestDataset:output_type -> github.com.metaprov.modelaapi.services.data.v1.RunTestSuiteResponse
	23,  // 417: github.com.metaprov.modelaapi.services.data.v1.DataService.UnitTestModel:output_type -> github.com.metaprov.modelaapi.services.data.v1.RunTestSuiteResponse
	23,  // 418: github.com.metaprov.modelaapi.services.data.v1.DataService.UnitTestFeedback:output_type -> github.com.metaprov.modelaapi.services.data.v1.RunTestSuiteResponse
	23,  // 419: github.com.metaprov.modelaapi.services.data.v1.DataService.UnitTestFeatureHistogram:output_type -> github.com.metaprov.modelaapi.services.data.v1.RunTestSuiteResponse
	23,  // 420: github.com.metaprov.modelaapi.services.data.v1.DataService.UnitTestPredictor:output_type -> github.com.metaprov.modelaapi.services.data.v1.RunTestSuiteResponse
	35,  // 421: github.com.metaprov.modelaapi.services.data.v1.DataService.GroupByDataset:output_type -> github.com.metaprov.modelaapi.services.data.v1.GroupByDatasetResponse
	81,  // 422: github.com.metaprov.modelaapi.services.data.v1.DataService.SyncOnlineStore:output_type -> github.com.metaprov.modelaapi.services.data.v1.SyncOnlineStoreResponse
	79,  // 423: github.com.metaprov.modelaapi.services.data.v1.DataService.GenTrainingData:output_type -> github.com.metaprov.modelaapi.services.data.v1.GenTrainingDataResponse
	83,  // 424: github.com.metaprov.modelaapi.services.data.v1.DataService.GenOnlineStoreDataset:output_type -> github.com.metaprov.modelaapi.services.data.v1.GenOnlineStoreDatasetResponse
	377, // [377:425] is the sub-list for method output_type
	329, // [329:377] is the sub-list for method input_type
