...
func (c *tenantServiceClient) ListTenantAlerts(ctx context.Context, in *ListTenantAlertsRequest, opts ...grpc.CallOption) (*ListTenantAlertsResponse, error) {
	out := new(ListTenantAlertsResponse)
	err := c.cc.Invoke(ctx, "/github.com.metaprov.modelaapi.services.tenant.v1.TenantService/ListTenantAlerts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTenantServiceServer) ListTenantAlerts(context.Context, *ListTenantAlertsRequest) (*ListTenantAlertsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListTenantAlerts not implemented")
}
...
func _TenantService_ListTenantAlerts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListTenantAlertsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TenantServiceServer).ListTenantAlerts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.metaprov.modelaapi.services.tenant.v1.TenantService/ListTenantAlerts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TenantServiceServer).ListTenantAlerts(ctx, req.(*ListTenantAlertsRequest))
	}
