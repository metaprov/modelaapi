...
import (
	context "context"
	v1alpha13 "github.com/metaprov/modelaapi/pkg/apis/catalog/v1alpha1/v1alpha1"
	...
	v1alpha12 "github.com/metaprov/modelaapi/pkg/apis/training/v1alpha1/v1alpha1"
	grpc "google.golang.org/grpc"
	codes "google.golang.org/grpc/codes"
	status "google.golang.org/grpc/status"
	protoreflect "google.golang.org/protobuf/reflect/protoreflect"
	protoimpl "google.golang.org/protobuf/runtime/protoimpl"
	_ "k8s.io/apimachinery/pkg/api/core/v1"
	reflect "reflect"
	sync "sync"
)
...
var file_github_com_metaprov_modelaapi_services_trainerd_v1_trainerd_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xba, 0x08, 0x0a, 0x0f, 0x54, 0x72, 0x61, 0x69, 0x6e, 0x65,
	...
	0x22, 0x00, 0x12, 0x94, 0x01, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x70, 0x69, 0x6c, 0x65, 0x12, 0x42,
	0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x65, 0x74, 0x61,
	0x70, 0x72, 0x6f, 0x76, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x61, 0x61, 0x70, 0x69, 0x2e, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x64,
...
var file_github_com_metaprov_modelaapi_services_trainerd_v1_trainerd_proto_depIdxs = []int32{
	...
	2,  // 67: github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService.Compile:input_type -> github.com.metaprov.modelaapi.services.trainerd.v1.CompileRequest
	6,  // 68: github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService.TrainEnsemble:input_type -> github.com.metaprov.modelaapi.services.trainerd.v1.TrainEnsembleRequest
	7,  // 69: github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService.TestEnsemble:input_type -> github.com.metaprov.modelaapi.services.trainerd.v1.TestEnsembleRequest
	10, // 70: github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService.Shutdown:input_type -> github.com.metaprov.modelaapi.services.trainerd.v1.ShutdownRequest
	...
	9,  // 72: github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService.Forecast:output_type -> github.com.metaprov.modelaapi.services.trainerd.v1.ForecastResponse
	5,  // 73: github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService.Test:output_type -> github.com.metaprov.modelaapi.services.trainerd.v1.TestResponse
	3,  // 74: github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService.Compile:output_type -> github.com.metaprov.modelaapi.services.trainerd.v1.CompileResponse
	1,  // 75: github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService.TrainEnsemble:output_type -> github.com.metaprov.modelaapi.services.trainerd.v1.TrainResponse
	5,  // 76: github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService.TestEnsemble:output_type -> github.com.metaprov.modelaapi.services.trainerd.v1.TestResponse
	11, // 77: github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService.Shutdown:output_type -> github.com.metaprov.modelaapi.services.trainerd.v1.ShutdownResponse
...
func (c *trainerdServiceClient) Compile(ctx context.Context, in *CompileRequest, opts ...grpc.CallOption) (*CompileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService/Compile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TrainerdService_Compile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.metaprov.modelaapi.services.trainerd.v1.TrainerdService/Compile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
