...
# Copy our patched betterproto models to fix comment generation
cp hack/patch* venv/lib/py*/site-packages/betterproto/plugin/models.py
...
python3 -m grpc_tools.protoc \
    ...
    --python_betterproto_out=${PROJECT_ROOT}/lang/python_betterproto \
