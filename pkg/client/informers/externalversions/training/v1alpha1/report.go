	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrainingV1alpha1().Reports(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrainingV1alpha1().Reports(namespace).Watch(context.TODO(), options)
			},
		},
		&trainingv1alpha1.Report{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *reportInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&trainingv1alpha1.Report{}, f.defaultInformer)
}
