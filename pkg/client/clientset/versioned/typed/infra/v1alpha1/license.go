...
func newLicenses(c *InfraV1alpha1Client, namespace string) *licenses {
	return &licenses{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *licenses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.License, err error) {
	result = &v1alpha1.License{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("licenses").
		Name(name).
...
func (c *licenses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LicenseList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LicenseList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("licenses").
...
func (c *licenses) Create(ctx context.Context, license *v1alpha1.License, opts v1.CreateOptions) (result *v1alpha1.License, err error) {
	result = &v1alpha1.License{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("licenses").
...
func (c *licenses) Update(ctx context.Context, license *v1alpha1.License, opts v1.UpdateOptions) (result *v1alpha1.License, err error) {
	result = &v1alpha1.License{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("licenses").
...
func (c *licenses) UpdateStatus(ctx context.Context, license *v1alpha1.License, opts v1.UpdateOptions) (result *v1alpha1.License, err error) {
	result = &v1alpha1.License{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("licenses").
...
func (c *licenses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.License, err error) {
	result = &v1alpha1.License{}
