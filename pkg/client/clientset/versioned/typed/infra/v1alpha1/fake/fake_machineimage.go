...
func (c *FakeMachineImages) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MachineImage, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineImages) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MachineImageList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineImages) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeMachineImages) Create(ctx context.Context, machineImage *v1alpha1.MachineImage, opts v1.CreateOptions) (result *v1alpha1.MachineImage, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineImages) Update(ctx context.Context, machineImage *v1alpha1.MachineImage, opts v1.UpdateOptions) (result *v1alpha1.MachineImage, err error) {
	obj, err := c.Fake.
...
func (c *FakeMachineImages) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeMachineImages) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(machineimagesResource, c.ns, listOpts)
...
func (c *FakeMachineImages) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MachineImage, err error) {
	obj, err := c.Fake.
