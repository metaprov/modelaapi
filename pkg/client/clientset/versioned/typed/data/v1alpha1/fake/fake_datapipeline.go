...
func (c *FakeDataPipelines) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataPipeline, err error) {
	obj, err := c.Fake.
...
func (c *FakeDataPipelines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataPipelineList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDataPipelines) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeDataPipelines) Create(ctx context.Context, dataPipeline *v1alpha1.DataPipeline, opts v1.CreateOptions) (result *v1alpha1.DataPipeline, err error) {
	obj, err := c.Fake.
...
func (c *FakeDataPipelines) Update(ctx context.Context, dataPipeline *v1alpha1.DataPipeline, opts v1.UpdateOptions) (result *v1alpha1.DataPipeline, err error) {
	obj, err := c.Fake.
...
func (c *FakeDataPipelines) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeDataPipelines) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(datapipelinesResource, c.ns, listOpts)
...
func (c *FakeDataPipelines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataPipeline, err error) {
	obj, err := c.Fake.
