...
var datasetsResource = schema.GroupVersionResource{Group: "data.modeld.io", Version: "v1alpha1", Resource: "datasets"}

var datasetsKind = schema.GroupVersionKind{Group: "data.modeld.io", Version: "v1alpha1", Kind: "Dataset"}
