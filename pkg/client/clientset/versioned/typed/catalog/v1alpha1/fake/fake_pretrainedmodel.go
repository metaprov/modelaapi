...
func (c *FakePretrainedModels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PretrainedModel, err error) {
	obj, err := c.Fake.
...
func (c *FakePretrainedModels) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PretrainedModelList, err error) {
	obj, err := c.Fake.
...
func (c *FakePretrainedModels) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakePretrainedModels) Create(ctx context.Context, pretrainedModel *v1alpha1.PretrainedModel, opts v1.CreateOptions) (result *v1alpha1.PretrainedModel, err error) {
	obj, err := c.Fake.
...
func (c *FakePretrainedModels) Update(ctx context.Context, pretrainedModel *v1alpha1.PretrainedModel, opts v1.UpdateOptions) (result *v1alpha1.PretrainedModel, err error) {
	obj, err := c.Fake.
...
func (c *FakePretrainedModels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakePretrainedModels) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(pretrainedmodelsResource, c.ns, listOpts)
...
func (c *FakePretrainedModels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PretrainedModel, err error) {
	obj, err := c.Fake.
