...
func (c *FakeUserRoleClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UserRoleClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeUserRoleClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UserRoleClassList, err error) {
	obj, err := c.Fake.
...
func (c *FakeUserRoleClasses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeUserRoleClasses) Create(ctx context.Context, userRoleClass *v1alpha1.UserRoleClass, opts v1.CreateOptions) (result *v1alpha1.UserRoleClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeUserRoleClasses) Update(ctx context.Context, userRoleClass *v1alpha1.UserRoleClass, opts v1.UpdateOptions) (result *v1alpha1.UserRoleClass, err error) {
	obj, err := c.Fake.
...
func (c *FakeUserRoleClasses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeUserRoleClasses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(userroleclassesResource, c.ns, listOpts)
...
func (c *FakeUserRoleClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UserRoleClass, err error) {
	obj, err := c.Fake.
