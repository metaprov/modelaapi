...
func (c *FakeAlgorithms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Algorithm, err error) {
	obj, err := c.Fake.
...
func (c *FakeAlgorithms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AlgorithmList, err error) {
	obj, err := c.Fake.
...
func (c *FakeAlgorithms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAlgorithms) Create(ctx context.Context, algorithm *v1alpha1.Algorithm, opts v1.CreateOptions) (result *v1alpha1.Algorithm, err error) {
	obj, err := c.Fake.
...
func (c *FakeAlgorithms) Update(ctx context.Context, algorithm *v1alpha1.Algorithm, opts v1.UpdateOptions) (result *v1alpha1.Algorithm, err error) {
	obj, err := c.Fake.
...
func (c *FakeAlgorithms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeAlgorithms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(algorithmsResource, c.ns, listOpts)
...
func (c *FakeAlgorithms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Algorithm, err error) {
	obj, err := c.Fake.
