...
type ReportInterface interface {
	...
	UpdateStatus(ctx context.Context, report *v1alpha1.Report, opts v1.UpdateOptions) (*v1alpha1.Report, error)
...
func (c *reports) UpdateStatus(ctx context.Context, report *v1alpha1.Report, opts v1.UpdateOptions) (result *v1alpha1.Report, err error) {
	result = &v1alpha1.Report{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("reports").
