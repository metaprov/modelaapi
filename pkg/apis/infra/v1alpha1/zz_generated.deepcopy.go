...
func (in *LabSpec) DeepCopyInto(out *LabSpec) {
	*out = *in
	...
	if in.PackageStorage != nil {
		in, out := &in.PackageStorage, &out.PackageStorage
		*out = new(VolumeStorageSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *LabStatus) DeepCopyInto(out *LabStatus) {
	*out = *in
	if in.VolumeClaimName != nil {
		in, out := &in.VolumeClaimName, &out.VolumeClaimName
		*out = new(string)
		**out = **in
	}
	if in.UpdatedAt != nil {
...
func (in *ServingSiteStatus) DeepCopyInto(out *ServingSiteStatus) {
	*out = *in
	...
	if in.GrpcIngressName != nil {
		in, out := &in.GrpcIngressName, &out.GrpcIngressName
		*out = new(string)
		**out = **in
	}
	if in.HttpIngressName != nil {
		in, out := &in.HttpIngressName, &out.HttpIngressName
		*out = new(string)
		**out = **in
	}
	if in.Conditions != nil {
