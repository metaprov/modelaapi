...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DermioSpec) DeepCopyInto(out *DermioSpec) {
	*out = *in
	if in.Host != nil {
		in, out := &in.Host, &out.Host
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DermioSpec.
func (in *DermioSpec) DeepCopy() *DermioSpec {
	if in == nil {
		return nil
	}
	out := new(DermioSpec)
