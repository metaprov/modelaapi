...
type ServingSiteStatus struct {
	...
	//+optional
	Conditions []ServingSiteCondition `json:"conditions,omitempty" protobuf:"bytes,3,rep,name=conditions"`
	// active predictors
	ActivePredictors int32 `json:"activePredictors,omitempty" protobuf:"varint,4,rep,name=activePredictors"`
	// inactive predictors
	InactivePredictors int32 `json:"inactivePredictors,omitempty" protobuf:"varint,5,rep,name=inactivePredictors"`
	// total predictors service failed
	TotalPredictorServiceFailed int32 `json:"totalPredictorServiceFailed,omitempty" protobuf:"varint,6,rep,name=totalPredictorServiceFailed"`
	// total predictors with data drift failed
	TotalPredictorDataDriftFailed int32 `json:"totalPredictorDataDriftFailed,omitempty" protobuf:"varint,7,rep,name=totalPredictorDataDriftFailed"`
	// total predictors accuracy failed
	TotalPredictorAccuracyFailed int32 `json:"totalPredictorAccuracyFailed,omitempty" protobuf:"varint,8,rep,name=totalPredictorAccuracyFailed"`
