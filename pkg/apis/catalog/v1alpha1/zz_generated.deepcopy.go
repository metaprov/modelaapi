...
func (in *RunScheduleStatus) DeepCopyInto(out *RunScheduleStatus) {
	*out = *in
	if in.LastRunCreationAt != nil {
		in, out := &in.LastRunCreationAt, &out.LastRunCreationAt
		*out = (*in).DeepCopy()
	}
	if in.LastRunCompletionAt != nil {
		in, out := &in.LastRunCompletionAt, &out.LastRunCompletionAt
		*out = (*in).DeepCopy()
	}
	if in.LastRunFailureMessage != nil {
		in, out := &in.LastRunFailureMessage, &out.LastRunFailureMessage
		*out = new(string)
		**out = **in
	}
	if in.LastRunVersion != nil {
		in, out := &in.LastRunVersion, &out.LastRunVersion
		*out = new(int32)
		**out = **in
	}
	if in.LastRunLogs != nil {
		in, out := &in.LastRunLogs, &out.LastRunLogs
		*out = make(ContainerLogs, len(*in))
		copy(*out, *in)
	}
}
