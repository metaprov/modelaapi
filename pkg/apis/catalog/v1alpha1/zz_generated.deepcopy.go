...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MLSubtaskTaskSpec) DeepCopyInto(out *MLSubtaskTaskSpec) {
	*out = *in
	if in.NLPSubtask != nil {
		in, out := &in.NLPSubtask, &out.NLPSubtask
		*out = new(NLPTask)
		**out = **in
	}
	if in.VisionSubtask != nil {
		in, out := &in.VisionSubtask, &out.VisionSubtask
		*out = new(VisionTask)
		**out = **in
	}
	if in.VideoSubtask != nil {
		in, out := &in.VideoSubtask, &out.VideoSubtask
		*out = new(VideoTask)
		**out = **in
	}
	if in.AudioSubtask != nil {
		in, out := &in.AudioSubtask, &out.AudioSubtask
		*out = new(AudioTask)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MLSubtaskTaskSpec.
func (in *MLSubtaskTaskSpec) DeepCopy() *MLSubtaskTaskSpec {
	if in == nil {
		return nil
	}
	out := new(MLSubtaskTaskSpec)
	in.DeepCopyInto(out)
	return out
}
