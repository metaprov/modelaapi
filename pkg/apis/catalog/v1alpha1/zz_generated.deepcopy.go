...
func (in *DataTestCase) DeepCopyInto(out *DataTestCase) {
	*out = *in
	...
	if in.ExpectedValueMin != nil {
		in, out := &in.ExpectedValueMin, &out.ExpectedValueMin
		*out = new(float64)
		**out = **in
	}
	if in.ExpectedValueMax != nil {
		in, out := &in.ExpectedValueMax, &out.ExpectedValueMax
		*out = new(float64)
		**out = **in
	}
