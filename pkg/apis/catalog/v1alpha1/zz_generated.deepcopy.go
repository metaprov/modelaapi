...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModelValidationRule) DeepCopyInto(out *ModelValidationRule) {
	*out = *in
	if in.Column != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModelValidationRule.
func (in *ModelValidationRule) DeepCopy() *ModelValidationRule {
	if in == nil {
		return nil
	}
	out := new(ModelValidationRule)
	in.DeepCopyInto(out)
	return out
}
