...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PredictorAccessSpec) DeepCopyInto(out *PredictorAccessSpec) {
	*out = *in
	if in.Port != nil {
		in, out := &in.Port, &out.Port
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PredictorAccessSpec.
func (in *PredictorAccessSpec) DeepCopy() *PredictorAccessSpec {
	if in == nil {
		return nil
	}
	out := new(PredictorAccessSpec)
	in.DeepCopyInto(out)
	return out
}
