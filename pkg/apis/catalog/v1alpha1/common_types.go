...
type TestSuite struct {
	// +kubebuilder:validation:Optional
	Tests []TestCase `json:"tests" protobuf:"bytes,1,opt,name=tests"`
}
...
type TestCase struct {
	...
	// +kubebuilder:validation:Optional
	StrictMax *bool `json:"strictMax,omitempty" protobuf:"varint,10,opt,name=strictMax"`
	// Indicates if this validation rule was automatically generated by the system
	// +kubebuilder:validation:Optional
	Generated *bool `json:"generated,omitempty" protobuf:"varint,11,opt,name=generated"`
	// +kubebuilder:validation:Optional
...
type TestSuiteResult struct {
	// +kubebuilder:validation:Optional
	Failures int32 `json:"failures" protobuf:"bytes,1,opt,name=faiures"`
	// +kubebuilder:validation:Optional
	Success int32 `json:"success" protobuf:"bytes,2,opt,name=success"`
	// +kubebuilder:validation:Optional
	Started *metav1.Time `json:"started" protobuf:"bytes,3,opt,name=started"`
	// +kubebuilder:validation:Optional
	Ended *metav1.Time `json:"ended" protobuf:"bytes,4,opt,name=ended"`
	// +kubebuilder:validation:Optional
	Tests []TestCaseResult `json:"tests" protobuf:"bytes,5,opt,name=tests"`
}
...
type TestCaseResult struct {
	...
	// +kubebuilder:validation:Optional
	TotalValues int32 `json:"totalValues" protobuf:"bytes,5,opt,name=totalValues"`
	// +kubebuilder:validation:Optional
	FailedValues int32 `json:"failedValues" protobuf:"bytes,6,opt,name=failedValues"`
	// +kubebuilder:validation:Optional
	SampleFailedValues string `json:"sampleFailedValues" protobuf:"bytes,7,opt,name=sampleFailedValues"`
}
