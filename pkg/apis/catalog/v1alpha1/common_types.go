...
type DataTestCase struct {
	...
	Type DataTestType `json:"type,omitempty" protobuf:"bytes,6,opt,name=type"`
	// +kubebuilder:validation:Optional
	Metric Metric `json:"metric,omitempty" protobuf:"bytes,7,opt,name=metric"`
	// The expected numerical value
	// +kubebuilder:validation:Optional
	ExpectedValue *float64 `json:"expectedValue,omitempty" protobuf:"bytes,8,opt,name=expectedValue"`
	// The expected value
	// +kubebuilder:validation:Optional
	ExpectedCategory *string `json:"expectedCategory,omitempty" protobuf:"bytes,9,opt,name=expectedCategory"`
	// For range based tests.
	// +kubebuilder:validation:Format=float
	// +kubebuilder:validation:Optional
	Lower *float64 `json:"lower,omitempty" protobuf:"bytes,10,opt,name=lower"`
	// +kubebuilder:validation:Format=float
	// +kubebuilder:validation:Optional
	Upper *float64 `json:"upper,omitempty" protobuf:"bytes,11,opt,name=upper"`
	// Expected set of values,if the assertion
	// +kubebuilder:validation:Optional
	ExpectedSet []string `json:"expectedSetSet,omitempty" protobuf:"bytes,12,rep,name=expectedSet"`
	// +kubebuilder:validation:Optional
	LowerInclusive *bool `json:"lowerInclusive,omitempty" protobuf:"varint,13,opt,name=lowerInclusive"`
	// +kubebuilder:validation:Optional
	UpperInclusive *bool `json:"upperInclusive,omitempty" protobuf:"varint,14,opt,name=upperInclusive"`
	// Indicates if this validation rule was automatically generated by the system
	// +kubebuilder:validation:Optional
	Generated *bool `json:"generated,omitempty" protobuf:"varint,15,opt,name=generated"`
	...
	// +kubebuilder:validation:Optional
	Column2 *string `json:"column2,omitempty" protobuf:"bytes,17,opt,name=column2"`
	// Reference to an entity.
	// +kubebuilder:validation:Optional
	EntityRef2 v1.ObjectReference `json:"entityRef2,omitempty" protobuf:"bytes,18,opt,name=entityRef2"`
}
