...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ColumnAssertion) DeepCopyInto(out *ColumnAssertion) {
	*out = *in
	if in.ValueSet != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ColumnAssertion.
func (in *ColumnAssertion) DeepCopy() *ColumnAssertion {
	if in == nil {
		return nil
	}
	out := new(ColumnAssertion)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatasetAssertion) DeepCopyInto(out *DatasetAssertion) {
	*out = *in
	if in.ValueSet != nil {
		in, out := &in.ValueSet, &out.ValueSet
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatasetAssertion.
func (in *DatasetAssertion) DeepCopy() *DatasetAssertion {
	if in == nil {
		return nil
	}
	out := new(DatasetAssertion)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiColumnAssertion) DeepCopyInto(out *MultiColumnAssertion) {
	*out = *in
	if in.Columns != nil {
		in, out := &in.Columns, &out.Columns
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiColumnAssertion.
func (in *MultiColumnAssertion) DeepCopy() *MultiColumnAssertion {
	if in == nil {
		return nil
	}
	out := new(MultiColumnAssertion)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiDatasetAssertion) DeepCopyInto(out *MultiDatasetAssertion) {
	*out = *in
	if in.Datasets != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiDatasetAssertion.
func (in *MultiDatasetAssertion) DeepCopy() *MultiDatasetAssertion {
	if in == nil {
		return nil
	}
	out := new(MultiDatasetAssertion)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ValidationSpec) DeepCopyInto(out *ValidationSpec) {
	*out = *in
	if in.MultiDatasetAssertions != nil {
		...
		*out = make([]MultiDatasetAssertion, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DatasetAssertions != nil {
		...
		*out = make([]DatasetAssertion, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.MultiColumnAssertions != nil {
		...
		*out = make([]MultiColumnAssertion, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ColumnAssertions != nil {
		...
		*out = make([]ColumnAssertion, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
