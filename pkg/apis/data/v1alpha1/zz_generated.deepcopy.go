...
func (in *DatasetSnapshotList) DeepCopyInto(out *DatasetSnapshotList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]DatasetSnapshot, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DatasetSnapshotStatus) DeepCopyInto(out *DatasetSnapshotStatus) {
	*out = *in
	out.DatasetManifestLocation = in.DatasetManifestLocation
	out.DataSourceManifestLocation = in.DataSourceManifestLocation
...
func (in *DatasetSnapshotStatus) DeepCopy() *DatasetSnapshotStatus {
	if in == nil {
		return nil
	}
	out := new(DatasetSnapshotStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GroupDatasetLocationStatus) DeepCopyInto(out *GroupDatasetLocationStatus) {
	*out = *in
	...
	if in.GroupDataIndex != nil {
		in, out := &in.GroupDataIndex, &out.GroupDataIndex
		*out = new(string)
		**out = **in
	}
	...
	if in.GroupReportIndex != nil {
		in, out := &in.GroupReportIndex, &out.GroupReportIndex
		*out = new(string)
		**out = **in
	}
...
func (in *GroupDatasetLocationStatus) DeepCopy() *GroupDatasetLocationStatus {
	if in == nil {
		return nil
	}
	out := new(GroupDatasetLocationStatus)
	in.DeepCopyInto(out)
	return out
}
