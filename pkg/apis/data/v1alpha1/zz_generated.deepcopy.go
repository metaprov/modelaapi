...
func (in *DataPipelineSpec) DeepCopyInto(out *DataPipelineSpec) {
	*out = *in
	...
	if in.OutputDatasetName != nil {
		in, out := &in.OutputDatasetName, &out.OutputDatasetName
		*out = new(string)
		**out = **in
	}
	if in.Schedule != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (run *FeaturePipelineRun) DeepCopyInto(out *FeaturePipelineRun) {
	*out = *run
...
func (run *FeaturePipelineRun) DeepCopy() *FeaturePipelineRun {
	if run == nil {
		return nil
	}
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (run *FeaturePipelineRun) DeepCopyObject() runtime.Object {
...
func (in *FeatureStatus) DeepCopyInto(out *FeatureStatus) {
	*out = *in
	...
	if in.Zeros != nil {
		in, out := &in.Zeros, &out.Zeros
		*out = new(int32)
		**out = **in
	}
	if in.Nulls != nil {
		in, out := &in.Nulls, &out.Nulls
		*out = new(int32)
		**out = **in
	}
	if in.P01 != nil {
		in, out := &in.P01, &out.P01
		*out = new(float64)
		**out = **in
	}
	if in.P99 != nil {
