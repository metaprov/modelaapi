...
func (in *FeatureHistogramSpec) DeepCopyInto(out *FeatureHistogramSpec) {
	*out = *in
	...
	if in.FeatureHistogramColumn != nil {
		in, out := &in.FeatureHistogramColumn, &out.FeatureHistogramColumn
		*out = new(string)
		**out = **in
	}
	...
	if in.FeatureHistogramPipelineName != nil {
		in, out := &in.FeatureHistogramPipelineName, &out.FeatureHistogramPipelineName
		*out = new(string)
		**out = **in
	}
}
