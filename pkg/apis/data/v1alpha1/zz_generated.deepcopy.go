...
func (in *ColumnHistogram) DeepCopyInto(out *ColumnHistogram) {
	*out = *in
	in.Historgram.DeepCopyInto(&out.Historgram)
}
...
func (in *DatasetSpec) DeepCopyInto(out *DatasetSpec) {
	*out = *in
	...
	in.Sample.DeepCopyInto(&out.Sample)
	in.Syntactic.DeepCopyInto(&out.Syntactic)
	if in.Task != nil {
		in, out := &in.Task, &out.Task
		*out = new(catalogv1alpha1.MLTask)
		**out = **in
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiColumnTest) DeepCopyInto(out *MultiColumnTest) {
	*out = *in
	if in.Type != nil {
		in, out := &in.Type, &out.Type
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiColumnTest.
func (in *MultiColumnTest) DeepCopy() *MultiColumnTest {
	if in == nil {
		return nil
	}
	out := new(MultiColumnTest)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TestSpec) DeepCopyInto(out *TestSpec) {
	*out = *in
	if in.MultiDatasetTests != nil {
		in, out := &in.MultiDatasetTests, &out.MultiDatasetTests
		*out = make([]MultiDatasetTest, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DatasetTests != nil {
		in, out := &in.DatasetTests, &out.DatasetTests
		*out = make([]DatasetTest, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.MultiColumnTests != nil {
		in, out := &in.MultiColumnTests, &out.MultiColumnTests
		*out = make([]MultiColumnTest, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ColumnTests != nil {
		in, out := &in.ColumnTests, &out.ColumnTests
	...
	if in.FileTests != nil {
		in, out := &in.FileTests, &out.FileTests
