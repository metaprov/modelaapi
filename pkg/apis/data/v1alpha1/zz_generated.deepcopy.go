...
func (in *CompilerSpec) DeepCopyInto(out *CompilerSpec) {
	*out = *in
	...
	if in.Targets != nil {
		...
		*out = make([]catalogv1alpha1.HardwareTarget, len(*in))
		copy(*out, *in)
	}
}
...
func (in *DataPipelineSpec) DeepCopyInto(out *DataPipelineSpec) {
	*out = *in
	...
	if in.DefaultCompilerSpec != nil {
		in, out := &in.DefaultCompilerSpec, &out.DefaultCompilerSpec
...
func (in *DatasetSpec) DeepCopyInto(out *DatasetSpec) {
	*out = *in
	...
	in.SampleSpec.DeepCopyInto(&out.SampleSpec)
}
