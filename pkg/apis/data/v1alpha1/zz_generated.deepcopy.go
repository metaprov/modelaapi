...
func (in *ValidationSpec) DeepCopyInto(out *ValidationSpec) {
	*out = *in
	if in.MultiDatasetAssertions != nil {
		in, out := &in.MultiDatasetAssertions, &out.MultiDatasetAssertions
		*out = make([]MultiDatasetValidation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DatasetAssertions != nil {
		in, out := &in.DatasetAssertions, &out.DatasetAssertions
		*out = make([]DatasetValidation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.MultiColumnAssertions != nil {
		in, out := &in.MultiColumnAssertions, &out.MultiColumnAssertions
		*out = make([]MultiColumnValidation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ColumnAssertions != nil {
		in, out := &in.ColumnAssertions, &out.ColumnAssertions
