...
func (sc *DataSource) HaveValidationRules() bool {
	return len(sc.Spec.Schema.Tests.DatasetTests.Tests) > 0 ||
		len(sc.Spec.Schema.Tests.MultiDatasetTests.Tests) > 0 ||
		len(sc.Spec.Schema.Tests.ColumnTests.Tests) > 0 ||
		len(sc.Spec.Schema.Tests.FileTests.Tests) > 0
