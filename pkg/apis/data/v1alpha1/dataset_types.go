...
type DatasetSpec struct {
	...
	// +kubebuilder:validation:Optional
	SubTask *catalog.MLSubtaskTaskSpec `json:"subtask,omitempty" protobuf:"bytes,20,opt,name=subtask"`
	...
	// +kubebuilder:validation:Optional
	Correlation CorrelationSpec `json:"correlation,omitempty" protobuf:"bytes,22,opt,name=correlation"`
	...
	// +kubebuilder:validation:Optional
	LabRef v1.ObjectReference `json:"labRef,omitempty" protobuf:"bytes,24,opt,name=labRef"`
}
