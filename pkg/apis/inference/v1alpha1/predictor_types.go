...
type ModelServingSpec struct {
	...
	// Do not start the model until they are prediction
...
type PredictionLoggingSpec struct {
	...
	// +kubebuilder:validation:Optional
	SamplePercent *int32 `json:"samplePercent,omitempty" protobuf:"varint,2,opt,name=samplePercent"`
	// Log requests (incoming prediction traffic)
...
type PredictorSpec struct {
	...
	// The data location where artifacts generated by the Predictor will be stored
	// +kubebuilder:validation:Optional
	Access AccessSpec `json:"access,omitempty" protobuf:"bytes,9,opt,name=access"`
	// The data location where artifacts generated by the Predictor will be stored
	// +kubebuilder:validation:Optional
	Replicas *int32 `json:"replicas,omitempty" protobuf:"varint,10,opt,name=replicas"`
	// AutoScaling specifies the auto-scaling policy
	// +kubebuilder:validation:Optional
	AutoScaling AutoScalingSpec `json:"autoScaling,omitempty" protobuf:"bytes,11,opt,name=autoScaling"`
	...
	// +kubebuilder:validation:Optional
	Resources catalog.ResourceSpec `json:"resources,omitempty" protobuf:"bytes,13,opt,name=resources"`

	// Cache is the specification of prediction cache (currently unimplemented)
	// +kubebuilder:validation:Optional
	Cache PredictionCacheSpec `json:"cache,omitempty" protobuf:"bytes,14,opt,name=cache"`
	// Store is the specification of the online data store (currently unimplemented)
	// +kubebuilder:validation:Optional
	Store OnlineFeatureStoreSpec `json:"store,omitempty" protobuf:"bytes,15,opt,name=store"`
	// Define the actual serving spec.
	Serving ModelServingSpec `json:"serving,omitempty" protobuf:"bytes,16,opt,name=serving"`
