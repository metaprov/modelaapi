...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlatFileChannelSpec) DeepCopyInto(out *FlatFileChannelSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FlatFileChannelSpec.
func (in *FlatFileChannelSpec) DeepCopy() *FlatFileChannelSpec {
	if in == nil {
		return nil
	}
	out := new(FlatFileChannelSpec)
	in.DeepCopyInto(out)
	return out
}
