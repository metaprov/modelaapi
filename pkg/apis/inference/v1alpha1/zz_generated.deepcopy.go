...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PredictorMonitorSpec) DeepCopyInto(out *PredictorMonitorSpec) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PredictorMonitorSpec.
func (in *PredictorMonitorSpec) DeepCopy() *PredictorMonitorSpec {
	if in == nil {
		return nil
	}
	out := new(PredictorMonitorSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PredictorStatus) DeepCopyInto(out *PredictorStatus) {
	*out = *in
	...
	in.LastMonitorResults.DeepCopyInto(&out.LastMonitorResults)
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
