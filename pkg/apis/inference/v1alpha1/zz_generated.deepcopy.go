...
func (in *PredictionLoggingSpec) DeepCopyInto(out *PredictionLoggingSpec) {
	*out = *in
	...
	if in.UploadIntervalMinutes != nil {
		in, out := &in.UploadIntervalMinutes, &out.UploadIntervalMinutes
		*out = new(int32)
		**out = **in
	}
}
...
func (in *PredictorStatus) DeepCopyInto(out *PredictorStatus) {
	*out = *in
	...
	if in.GroundTrueMetrics != nil {
		in, out := &in.GroundTrueMetrics, &out.GroundTrueMetrics
		*out = make([]catalogv1alpha1.Metric, len(*in))
		copy(*out, *in)
	}
	if in.Conditions != nil {
