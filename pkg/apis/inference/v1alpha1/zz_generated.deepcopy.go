...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (run *PredictionPipelineRun) DeepCopyInto(out *PredictionPipelineRun) {
	*out = *run
	out.TypeMeta = run.TypeMeta
	run.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	run.Spec.DeepCopyInto(&out.Spec)
	run.Status.DeepCopyInto(&out.Status)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PredictionPipelineRun.
func (run *PredictionPipelineRun) DeepCopy() *PredictionPipelineRun {
	if run == nil {
		return nil
	}
	out := new(PredictionPipelineRun)
	run.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (run *PredictionPipelineRun) DeepCopyObject() runtime.Object {
	if c := run.DeepCopy(); c != nil {
		return c
	}
	return nil
}
