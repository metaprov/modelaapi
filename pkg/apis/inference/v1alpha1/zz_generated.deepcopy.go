...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Forecast) DeepCopyInto(out *Forecast) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Forecast.
func (in *Forecast) DeepCopy() *Forecast {
	if in == nil {
		return nil
	}
	out := new(Forecast)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *Forecast) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ForecastCondition) DeepCopyInto(out *ForecastCondition) {
	*out = *in
	if in.LastTransitionTime != nil {
		in, out := &in.LastTransitionTime, &out.LastTransitionTime
		*out = (*in).DeepCopy()
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForecastCondition.
func (in *ForecastCondition) DeepCopy() *ForecastCondition {
	if in == nil {
		return nil
	}
	out := new(ForecastCondition)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ForecastList) DeepCopyInto(out *ForecastList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]Forecast, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForecastList.
func (in *ForecastList) DeepCopy() *ForecastList {
	if in == nil {
		return nil
	}
	out := new(ForecastList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ForecastList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ForecastRunResult) DeepCopyInto(out *ForecastRunResult) {
	*out = *in
	if in.Features != nil {
		in, out := &in.Features, &out.Features
		*out = make(map[trainingv1alpha1.TSFeature]float64, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForecastRunResult.
func (in *ForecastRunResult) DeepCopy() *ForecastRunResult {
	if in == nil {
		return nil
	}
	out := new(ForecastRunResult)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ForecastSpec) DeepCopyInto(out *ForecastSpec) {
	*out = *in
	...
	if in.PredictionRef != nil {
		in, out := &in.PredictionRef, &out.PredictionRef
		*out = new(v1.ObjectReference)
		**out = **in
	}
...
func (in *ForecastStatus) DeepCopyInto(out *ForecastStatus) {
	*out = *in
	...
	if in.Runs != nil {
		in, out := &in.Runs, &out.Runs
		*out = make(map[string]ForecastRunResult, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]ForecastCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
