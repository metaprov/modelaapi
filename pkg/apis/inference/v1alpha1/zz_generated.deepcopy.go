...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PartitionPredictionLocationsSpec) DeepCopyInto(out *PartitionPredictionLocationsSpec) {
	*out = *in
...
func (in *PartitionPredictionLocationsSpec) DeepCopy() *PartitionPredictionLocationsSpec {
	if in == nil {
		return nil
	}
	out := new(PartitionPredictionLocationsSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PredictionSpec) DeepCopyInto(out *PredictionSpec) {
	*out = *in
	...
	in.PartitionLocation.DeepCopyInto(&out.PartitionLocation)
	if in.Workers != nil {
