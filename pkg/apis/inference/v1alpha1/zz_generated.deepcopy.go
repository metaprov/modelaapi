...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ForecastForecastSpec) DeepCopyInto(out *ForecastForecastSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForecastForecastSpec.
func (in *ForecastForecastSpec) DeepCopy() *ForecastForecastSpec {
	if in == nil {
		return nil
	}
	out := new(ForecastForecastSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ForecastSpec) DeepCopyInto(out *ForecastSpec) {
	*out = *in
	...
	if in.CronForecastName != nil {
		in, out := &in.CronForecastName, &out.CronForecastName
		*out = new(string)
		**out = **in
	}
