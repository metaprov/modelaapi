...
type EntityInterface interface {
	Create(*v1alpha1.Entity) (*v1alpha1.Entity, error)
	Update(*v1alpha1.Entity) (*v1alpha1.Entity, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.Entity, error)
	List(opts v1.ListOptions) (*v1alpha1.EntityList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Entity, err error)
	EntityExpansion
}
...
func (c *entities) Get(name string, options v1.GetOptions) (result *v1alpha1.Entity, err error) {
...
func (c *entities) List(opts v1.ListOptions) (result *v1alpha1.EntityList, err error) {
...
func (c *entities) Create(entity *v1alpha1.Entity) (result *v1alpha1.Entity, err error) {
	result = &v1alpha1.Entity{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("entities").
...
func (c *entities) Update(entity *v1alpha1.Entity) (result *v1alpha1.Entity, err error) {
	result = &v1alpha1.Entity{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("entities").
...
func (c *entities) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Entity, err error) {
	result = &v1alpha1.Entity{}
