	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.InfraV1alpha1().Notifiers(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InfraV1alpha1().Notifiers(namespace).Watch(options)
			},
		},
		&infrav1alpha1.Notifier{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *notifierInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&infrav1alpha1.Notifier{}, f.defaultInformer)
}
