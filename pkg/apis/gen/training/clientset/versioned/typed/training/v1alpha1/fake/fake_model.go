...
var modelsResource = schema.GroupVersionResource{Group: "training.modeld.io", Version: "v1alpha1", Resource: "models"}

var modelsKind = schema.GroupVersionKind{Group: "training.modeld.io", Version: "v1alpha1", Kind: "Model"}

// Get takes name of the model, and returns the corresponding model object, and an error if there is any.
func (c *FakeModels) Get(name string, options v1.GetOptions) (result *v1alpha1.Model, err error) {
	obj, err := c.Fake.
...
func (c *FakeModels) List(opts v1.ListOptions) (result *v1alpha1.ModelList, err error) {
	obj, err := c.Fake.
...
func (c *FakeModels) Create(model *v1alpha1.Model) (result *v1alpha1.Model, err error) {
	obj, err := c.Fake.
...
func (c *FakeModels) Update(model *v1alpha1.Model) (result *v1alpha1.Model, err error) {
	obj, err := c.Fake.
...
func (c *FakeModels) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Model, err error) {
	obj, err := c.Fake.
