...
func (in *MeetingSpec) DeepCopyInto(out *MeetingSpec) {
	*out = *in
	...
	if in.ActionItems != nil {
		in, out := &in.ActionItems, &out.ActionItems
		*out = make([]ActionItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.CalendarURL != nil {
		in, out := &in.CalendarURL, &out.CalendarURL
		*out = new(string)
		**out = **in
	}
}
...
func (in *PostMortemSpec) DeepCopyInto(out *PostMortemSpec) {
	*out = *in
	...
	if in.DetectionTime != nil {
		in, out := &in.DetectionTime, &out.DetectionTime
		*out = (*in).DeepCopy()
	}
	if in.EndTime != nil {
