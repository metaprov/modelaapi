...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DroppedFeature) DeepCopyInto(out *DroppedFeature) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DroppedFeature.
func (in *DroppedFeature) DeepCopy() *DroppedFeature {
	if in == nil {
		return nil
	}
	out := new(DroppedFeature)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FeatureEngineeringStatus) DeepCopyInto(out *FeatureEngineeringStatus) {
	*out = *in
	...
	if in.Dropped != nil {
		...
		*out = make([]DroppedFeature, len(*in))
		copy(*out, *in)
	}
}
...
func (in *StudySpec) DeepCopyInto(out *StudySpec) {
	*out = *in
	...
	if in.StudyFeatureFilter != nil {
		in, out := &in.StudyFeatureFilter, &out.StudyFeatureFilter
...
func (in *StudyStatus) DeepCopyInto(out *StudyStatus) {
	*out = *in
	...
	if in.FeatureGenStartTime != nil {
		in, out := &in.FeatureGenStartTime, &out.FeatureGenStartTime
		*out = (*in).DeepCopy()
	}
	if in.FeatureGenEndTime != nil {
		in, out := &in.FeatureGenEndTime, &out.FeatureGenEndTime
		*out = (*in).DeepCopy()
	}
	if in.FeatureSelectionStartTime != nil {
		in, out := &in.FeatureSelectionStartTime, &out.FeatureSelectionStartTime
		*out = (*in).DeepCopy()
	}
	if in.FeatureSelectionEndTime != nil {
		in, out := &in.FeatureSelectionEndTime, &out.FeatureSelectionEndTime
		*out = (*in).DeepCopy()
	}
	if in.TrainingStartTime != nil {
		in, out := &in.TrainingStartTime, &out.TrainingStartTime
