...
func (in *StudySpec) DeepCopyInto(out *StudySpec) {
	*out = *in
	...
	if in.FeatureGeneration != nil {
		in, out := &in.FeatureGeneration, &out.FeatureGeneration
		*out = new(catalogv1alpha1.FeatureGenerationSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.FeatureSelection != nil {
		in, out := &in.FeatureSelection, &out.FeatureSelection
		*out = new(catalogv1alpha1.FeatureSelectionSpec)
		(*in).DeepCopyInto(*out)
	}
