...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ForecastHyperParametersSpec) DeepCopyInto(out *ForecastHyperParametersSpec) {
	*out = *in
	...
	if in.ChangePriorScale != nil {
		in, out := &in.ChangePriorScale, &out.ChangePriorScale
		*out = new(float64)
		**out = **in
	}
	if in.SeasonalityPriorScale != nil {
		in, out := &in.SeasonalityPriorScale, &out.SeasonalityPriorScale
		*out = new(float64)
		**out = **in
	}
	if in.HolidaysPriorScale != nil {
		in, out := &in.HolidaysPriorScale, &out.HolidaysPriorScale
		*out = new(float64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForecastHyperParametersSpec.
func (in *ForecastHyperParametersSpec) DeepCopy() *ForecastHyperParametersSpec {
	if in == nil {
		return nil
	}
	out := new(ForecastHyperParametersSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TimeSeriesDataSpec) DeepCopyInto(out *TimeSeriesDataSpec) {
	*out = *in
	...
	if in.Level3 != nil {
		in, out := &in.Level3, &out.Level3
		*out = new(string)
		**out = **in
	}
	if in.HistoricalPeriod != nil {
		in, out := &in.HistoricalPeriod, &out.HistoricalPeriod
		*out = new(PeriodSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.ForecastPeriod != nil {
		in, out := &in.ForecastPeriod, &out.ForecastPeriod
		*out = new(PeriodSpec)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.ExtraSeasonalities != nil {
		in, out := &in.ExtraSeasonalities, &out.ExtraSeasonalities
		*out = make([]SeasonalitySpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
