...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EnsembleForecasterSpec) DeepCopyInto(out *EnsembleForecasterSpec) {
	*out = *in
	if in.Base != nil {
		in, out := &in.Base, &out.Base
		*out = make(map[string]ForecasterSpec, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnsembleForecasterSpec.
func (in *EnsembleForecasterSpec) DeepCopy() *EnsembleForecasterSpec {
	if in == nil {
		return nil
	}
	out := new(EnsembleForecasterSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ForecasterPipelineSpec) DeepCopyInto(out *ForecasterPipelineSpec) {
	*out = *in
	...
	if in.Forecaster != nil {
		in, out := &in.Forecaster, &out.Forecaster
		*out = new(ForecasterSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.EnsembleForecaster != nil {
		in, out := &in.EnsembleForecaster, &out.EnsembleForecaster
		*out = new(EnsembleForecasterSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ForecasterSpec) DeepCopyInto(out *ForecasterSpec) {
	*out = *in
	out.AlgorithmRef = in.AlgorithmRef
	if in.HyperParameters != nil {
		in, out := &in.HyperParameters, &out.HyperParameters
		*out = make([]HyperParameterValue, len(*in))
		copy(*out, *in)
	}
	in.Reduction.DeepCopyInto(&out.Reduction)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReducedForecasterSpec) DeepCopyInto(out *ReducedForecasterSpec) {
	*out = *in
	in.Estimator.DeepCopyInto(&out.Estimator)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReducedForecasterSpec.
func (in *ReducedForecasterSpec) DeepCopy() *ReducedForecasterSpec {
	if in == nil {
		return nil
	}
	out := new(ReducedForecasterSpec)
	in.DeepCopyInto(out)
	return out
}
