...
func (in *FeatureServiceSpec) DeepCopyInto(out *FeatureServiceSpec) {
	*out = *in
	if in.Views != nil {
		...
		*out = make([]FeatureViewRef, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FeatureViewRef) DeepCopyInto(out *FeatureViewRef) {
	*out = *in
	if in.Include != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FeatureViewRef.
func (in *FeatureViewRef) DeepCopy() *FeatureViewRef {
	if in == nil {
		return nil
	}
	out := new(FeatureViewRef)
	in.DeepCopyInto(out)
	return out
}
