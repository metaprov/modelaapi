...
func (in *FeatureEngineeringPipeline) DeepCopyInto(out *FeatureEngineeringPipeline) {
	*out = *in
	...
	if in.TimeSeries != nil {
		...
		*out = new(TimeSeriesPipelineSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Generated != nil {
...
func (in *ForecasterTrainingSpec) DeepCopyInto(out *ForecasterTrainingSpec) {
	*out = *in
	...
	if in.KeyColumns != nil {
		in, out := &in.KeyColumns, &out.KeyColumns
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TimeSeriesPipelineSpec) DeepCopyInto(out *TimeSeriesPipelineSpec) {
	*out = *in
	if in.All != nil {
		in, out := &in.All, &out.All
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TimeSeriesPipelineSpec.
func (in *TimeSeriesPipelineSpec) DeepCopy() *TimeSeriesPipelineSpec {
	if in == nil {
		return nil
	}
	out := new(TimeSeriesPipelineSpec)
