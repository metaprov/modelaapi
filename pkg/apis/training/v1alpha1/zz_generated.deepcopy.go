...
func (in *AcceptanceStageSpec) DeepCopyInto(out *AcceptanceStageSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AcceptanceStageSpec.
func (in *AcceptanceStageSpec) DeepCopy() *AcceptanceStageSpec {
	if in == nil {
		return nil
	}
	out := new(AcceptanceStageSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Hierarchy) DeepCopyInto(out *Hierarchy) {
	*out = *in
	...
	in.ItemLevel.DeepCopyInto(&out.ItemLevel)
...
func (in *ModelPipelineSpec) DeepCopyInto(out *ModelPipelineSpec) {
	*out = *in
	...
	if in.AcceptanceStage != nil {
		in, out := &in.AcceptanceStage, &out.AcceptanceStage
		*out = new(AcceptanceStageSpec)
		(*in).DeepCopyInto(*out)
	}
...
func (in *NotebookSpec) DeepCopyInto(out *NotebookSpec) {
	*out = *in
	...
	if in.ImageRepoRef != nil {
		in, out := &in.ImageRepoRef, &out.ImageRepoRef
		*out = new(v1.ObjectReference)
		**out = **in
	}
	if in.Vars != nil {
...
func (in *PreprocessingSpec) DeepCopyInto(out *PreprocessingSpec) {
	*out = *in
	...
	in.Numeric.DeepCopyInto(&out.Numeric)
	if in.Text != nil {
