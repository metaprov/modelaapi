...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EnsembleSearchSpec) DeepCopyInto(out *EnsembleSearchSpec) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnsembleSearchSpec.
func (in *EnsembleSearchSpec) DeepCopy() *EnsembleSearchSpec {
	if in == nil {
		return nil
	}
	out := new(EnsembleSearchSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ForecastSpec) DeepCopyInto(out *ForecastSpec) {
	*out = *in
	...
	if in.PostPrecessing != nil {
		in, out := &in.PostPrecessing, &out.PostPrecessing
		*out = new(ForecastPostProcessingSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Plot != nil {
...
func (in *StudySpec) DeepCopyInto(out *StudySpec) {
	*out = *in
	...
	if in.FeatureEngineeringSearch != nil {
		in, out := &in.FeatureEngineeringSearch, &out.FeatureEngineeringSearch
		*out = new(FeatureEngineeringSearchSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Baseline != nil {
	...
	if in.TrainingTemplate != nil {
		in, out := &in.TrainingTemplate, &out.TrainingTemplate
		*out = new(TrainingSpec)
		(*in).DeepCopyInto(*out)
	}
...
func (in *StudyStatus) DeepCopyInto(out *StudyStatus) {
	*out = *in
	...
	if in.BaselineStartTime != nil {
		in, out := &in.BaselineStartTime, &out.BaselineStartTime
		*out = (*in).DeepCopy()
	}
	if in.BaselineEndTime != nil {
		in, out := &in.BaselineEndTime, &out.BaselineEndTime
		*out = (*in).DeepCopy()
	}
	if in.SearcStartTime != nil {
		in, out := &in.SearcStartTime, &out.SearcStartTime
		*out = (*in).DeepCopy()
	}
	if in.SearchEndTime != nil {
		in, out := &in.SearchEndTime, &out.SearchEndTime
		*out = (*in).DeepCopy()
	}
	if in.EnsembleStartTime != nil {
		in, out := &in.EnsembleStartTime, &out.EnsembleStartTime
		*out = (*in).DeepCopy()
	}
	if in.EnsembleEndTime != nil {
		in, out := &in.EnsembleEndTime, &out.EnsembleEndTime
		*out = (*in).DeepCopy()
	}
	if in.TestingStartTime != nil {
		in, out := &in.TestingStartTime, &out.TestingStartTime
...
func (in *TimeSeriesDataSpec) DeepCopyInto(out *TimeSeriesDataSpec) {
	*out = *in
	...
	if in.YearlySeasonality != nil {
		in, out := &in.YearlySeasonality, &out.YearlySeasonality
		*out = new(PeriodSeasonalitySpec)
		(*in).DeepCopyInto(*out)
	}
	if in.WeeklySeasonality != nil {
		in, out := &in.WeeklySeasonality, &out.WeeklySeasonality
		*out = new(PeriodSeasonalitySpec)
		(*in).DeepCopyInto(*out)
	}
	if in.DailySeasonality != nil {
		in, out := &in.DailySeasonality, &out.DailySeasonality
		*out = new(PeriodSeasonalitySpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Growth != nil {
