...
func (in *FeatureEngineeringSpec) DeepCopyInto(out *FeatureEngineeringSpec) {
	*out = *in
	...
	if in.DerivedColumns != nil {
		in, out := &in.DerivedColumns, &out.DerivedColumns
...
func (in *FeatureEngineeringStatus) DeepCopyInto(out *FeatureEngineeringStatus) {
	*out = *in
	in.BestPipeline.DeepCopyInto(&out.BestPipeline)
}
...
func (in *GeneratedColumnSpec) DeepCopyInto(out *GeneratedColumnSpec) {
	*out = *in
	if in.GeneratedName != nil {
		in, out := &in.GeneratedName, &out.GeneratedName
		*out = new(string)
		**out = **in
	}
}
