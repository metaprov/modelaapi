...
func (in *AlgorithmSearchSpace) DeepCopyInto(out *AlgorithmSearchSpace) {
	*out = *in
	if in.Ranges != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlgorithmSearchSpace.
func (in *AlgorithmSearchSpace) DeepCopy() *AlgorithmSearchSpace {
	if in == nil {
		return nil
	}
	out := new(AlgorithmSearchSpace)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AlgorithmSearchSpaceSpec) DeepCopyInto(out *AlgorithmSearchSpaceSpec) {
	*out = *in
	...
	if in.Custom != nil {
		...
		*out = make([]AlgorithmSearchSpace, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
