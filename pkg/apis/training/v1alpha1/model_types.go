...
type ModelSpec struct {
	...
	// +kubebuilder:default:=false
	// +kubebuilder:validation:Optional
	Explained *bool `json:"explained,omitempty" protobuf:"varint,31,opt,name=explained"`
	// Not implemented. For future use. If true,generate code when model trained
	// +kubebuilder:default:=false
	// +kubebuilder:validation:Optional
	CodeGenerated *bool `json:"codeGenerated,omitempty" protobuf:"varint,32,opt,name=codeGenerated"`
	// Baseline indicates if the Model was produced by the baseline phase of a Study
	// +kubebuilder:default:=false
	// +kubebuilder:validation:Optional
	Baseline *bool `json:"baseline,omitempty" protobuf:"varint,33,opt,name=baseline"`
	// GenDriftDetector indicates if we should generate a drift detector model for this model
	// +kubebuilder:default:=false
	// +kubebuilder:validation:Optional
	GenDriftDetector *bool `json:"genDriftDetector,omitempty" protobuf:"varint,34,opt,name=genDriftDetector"`
	// Fast indicates if the Model should skip profiling, explaining, and reporting
	// +kubebuilder:default:=false
	// +kubebuilder:validation:Optional
	Fast *bool `json:"fast,omitempty" protobuf:"varint,35,opt,name=fast"`
	// Indicate if this model should be unit tested.
	// +kubebuilder:default:=false
	// +kubebuilder:validation:Optional
	UnitTested *bool `json:"unitTested,omitempty" protobuf:"varint,36,opt,name=unitTested"`
	// The reference to the lated feedback dataset
	// +kubebuilder:validation:Optional
	FeedbackDatasetRef *v1.ObjectReference `json:"feedbackDatasetRef,omitempty" protobuf:"varint,37,opt,name=feedbackDatasetRef"`
	// Indicates if the model is flagged
	// +kubebuilder:default:=false
	// +kubebuilder:validation:Optional
	Flagged *bool `json:"flagged,omitempty" protobuf:"varint,38,opt,name=flagged"`
	// The data location where artifacts (metadata, reports, and estimators) generated by the Model will be stored
	// +kubebuilder:validation:Optional
	Location *data.DataLocation `json:"location,omitempty" protobuf:"bytes,39,opt,name=location"`
	// Forecasting specifies the configuration to train a forecasting model
	// +kubebuilder:validation:Optional
	Forecasting ForecasterTrainingSpec `json:"forecasting,omitempty" protobuf:"bytes,40,opt,name=forecasting"`
	// Compilation specifies the configuration to compile a model to a binary (currently unimplemented)
	// +kubebuilder:validation:Optional
	Compilation *catalog.CompilerSpec `json:"compilation,omitempty" protobuf:"bytes,41,opt,name=compilation"`
	// The deadline for any Jobs associated with the Model to be completed in seconds
	// +kubebuilder:default:=600
	// +kubebuilder:validation:Optional
	ActiveDeadlineSeconds *int64 `json:"activeDeadlineSeconds,omitempty" protobuf:"varint,42,opt,name=activeDeadlineSeconds"`
	// ModelType is the type of model for this estimator
	// +kubebuilder:default:=classical
	// +kubebuilder:validation:Optional
	EstimatorType *catalog.ModelType `json:"estimatorType,omitempty" protobuf:"bytes,43,opt,name=estimatorType"`
	// The time-to-live of the Model, after which the Model will be archived
	// +kubebuilder:default:=0
	// +kubebuilder:validation:Optional
	TTL *int32 `json:"ttl,omitempty" protobuf:"varint,44,opt,name=ttl"`
	// The model class, which is derived from the phase of the Study that the Model was created for
	// +kubebuilder:validation:Optional
	ModelClass catalog.ModelClassType `json:"modelClass,omitempty" protobuf:"bytes,45,opt,name=modelClass"`
	// The trial ID, which is incremented for each Model produced by the data plane
	// +kubebuilder:default:=0
	// +kubebuilder:validation:Optional
	TrialID *int32 `json:"trialID,omitempty" protobuf:"varint,46,opt,name=trialID"`
	// Governance specifies the model governance requirements (currently unimplemented)
	// +kubebuilder:validation:Optional
	Governance *data.GovernanceSpec `json:"governance,omitempty" protobuf:"bytes,47,opt,name=governance"`
	// Interpretability specifies the configuration to generate model interpretability visualizations
	// +kubebuilder:validation:Optional
	Interpretability InterpretabilitySpec `json:"interpretability,omitempty" protobuf:"bytes,48,opt,name=interpretability"`
	// The set of unit tests for this model.
	// +kubebuilder:validation:Optional
	UnitTests catalog.TestSuite `json:"unitTests,omitempty" protobuf:"bytes,49,opt,name=unitTests"`
	// The set of unit tests to test this models against the feedback.
	// +kubebuilder:validation:Optional
	FeedbackTests catalog.TestSuite `json:"feedbackTests,omitempty" protobuf:"bytes,50,opt,name=feedbackTests"`
	// In case of forecasting Contain the list of time series for this model
	// +kubebuilder:validation:Optional
	TimeSeriesItems map[string]TimeSeriesItem `json:"timeSeriesItems,omitempty" protobuf:"bytes,51,opt,name=timeSeriesItems"`
}
...
type ModelStatus struct {
	...
	// +kubebuilder:validation:Optional
	Feedback []catalog.Measurement `json:"feedback,omitempty" protobuf:"bytes,15,rep,name=feedback"`
	// The last feedback dataset
	// +kubebuilder:validation:Optional
	LastFeedbackDatasetRef v1.ObjectReference `json:"lastFeedbackDatasetRef,omitempty" protobuf:"bytes,16,rep,name=lastFeedbackDatasetRef"`
	// The phase of the Model
	// +kubebuilder:default:="Pending"
	// +kubebuilder:validation:Optional
	Phase ModelPhase `json:"phase" protobuf:"bytes,17,opt,name=phase"`
	// The name of the Report resource produced by the Model
	// +kubebuilder:validation:Optional
	ReportName string `json:"reportName,omitempty" protobuf:"bytes,18,opt,name=reportName"`
	// The URI of the Report
	// +kubebuilder:validation:Optional
	ReportUri string `json:"reportUri,omitempty" protobuf:"bytes,19,opt,name=reportUri"`
	// The URI of the Model manifest
	// +kubebuilder:validation:Optional
	ManifestUri string `json:"manifestUri,omitempty" protobuf:"bytes,20,opt,name=manifestUri"`
	// The URI of the model weights binary file
	// +kubebuilder:validation:Optional
	WeightsUri string `json:"weightsUri,omitempty" protobuf:"bytes,21,opt,name=weightsUri"`
	// The URI of the label encoder binary file, if it exists
	// +kubebuilder:validation:Optional
	LabelEncoderUri string `json:"labelEncoderUri,omitempty" protobuf:"bytes,22,opt,name=labelEncoderUri"`
	// The URI of the logs file
	// +kubebuilder:validation:Optional
	LogsUri string `json:"logsUri,omitempty" protobuf:"bytes,23,opt,name=logsUri"`
	// The URI of the model profile, which contains visualizations produced during the profiling phase
	// +kubebuilder:validation:Optional
	ProfileUri string `json:"profileUri" protobuf:"bytes,24,opt,name=profileUri"`
	// The URI to the misclassification file produced during the testing phase
	// +kubebuilder:validation:Optional
	MisclassificationUri string `json:"misclassificationUri" protobuf:"bytes,25,opt,name=misclassificationUri"`
	// The URI to the model tarbell file
	// +kubebuilder:validation:Optional
	TarUri string `json:"tarUri" protobuf:"bytes,26,opt,name=tarUri"`
	// The URI to the model application file
	// +kubebuilder:validation:Optional
	AppUri string `json:"appUri" protobuf:"bytes,27,opt,name=appUri"`
	// The name of the Docker image produced by the Model
	// +kubebuilder:validation:Optional
	ImageName string `json:"imageName" protobuf:"bytes,28,opt,name=imageName"`
	...
	// +kubebuilder:validation:Optional
	ImpurityImportance []FeatureImportance `json:"impurityImportance,,omitempty" protobuf:"bytes,29,rep,name=importance"`
	// The collection of features and their importance, sorted by the greatest importance first
	// The collection is measured using permutation importance
	// +kubebuilder:validation:Optional
	PermutationImportance []FeatureImportance `json:"permutationImportance,omitempty" protobuf:"bytes,30,rep,name=permutationImportance"`
	// The URI of the model forecast
	// +kubebuilder:validation:Optional
	ForecastUri string `json:"forecastUri,omitempty" protobuf:"bytes,31,opt,name=forecastUri"`
	// The runtime training details.
	// +kubebuilder:validation:Optional
	Runtime RuntimeStatus `json:"runtime,omitempty" protobuf:"bytes,32,opt,name=runtime"`
	// TrainDatasetLocation specifies the location of the training dataset
	// +kubebuilder:validation:Optional
	TrainDatasetLocation data.DataLocation `json:"trainDataset,omitempty" protobuf:"bytes,33,opt,name=trainDataset"`
	// TestDatasetLocation specifies the location of the testing dataset
	// +kubebuilder:validation:Optional
	TestDatasetLocation data.DataLocation `json:"testDataset,omitempty" protobuf:"bytes,34,opt,name=testDataset"`
	// ValidationDataset specifies the location of the validation dataset
	// +kubebuilder:validation:Optional
	ValidationDataset data.DataLocation `json:"validationDataset,omitempty" protobuf:"bytes,35,opt,name=validationDataset"`
	// ObservedGeneration is the last generation that was acted on
	//+kubebuilder:validation:Optional
	ObservedGeneration int64 `json:"observedGeneration,omitempty" protobuf:"varint,36,opt,name=observedGeneration"`
	// The number of rows in the training dataset
	// +kubebuilder:validation:Optional
	TrainingRows int32 `json:"trainingRows" protobuf:"varint,37,opt,name=trainingRows"`
	// The number of rows in the testing dataset
	// +kubebuilder:validation:Optional
	TestingRows int32 `json:"testingRows" protobuf:"varint,38,opt,name=testingRows"`
	// The number of rows in the validation dataset, if applicable
	// +kubebuilder:validation:Optional
	ValidationRows int32 `json:"validationRows" protobuf:"varint,39,opt,name=validationRows"`
	// In the case of failure, the Model resource controller will set this field with a failure reason
	//+kubebuilder:validation:Optional
	FailureReason *catalog.StatusError `json:"failureReason,omitempty" protobuf:"bytes,40,opt,name=failureReason"`
	// In the case of failure, the Model resource controller will set this field with a failure message
	//+kubebuilder:validation:Optional
	FailureMessage *string `json:"failureMessage,omitempty" protobuf:"bytes,41,opt,name=failureMessage"`
	// The progress percentage of the Model, which is derived from the Model's current phase
	// +kubebuilder:validation:Optional
	Progress int32 `json:"progress,omitempty" protobuf:"varint,42,opt,name=progress"`
	// The size of the model binary in bytes
	// +kubebuilder:validation:Optional
	SizeInBytes int32 `json:"sizeInBytes,omitempty" protobuf:"varint,43,opt,name=sizeInBytes"`
	// The measured prediction latency
	// +kubebuilder:validation:Optional
	Latency float64 `json:"latency,omitempty" protobuf:"bytes,44,opt,name=latency"`
	// The URL to the released model
	// +kubebuilder:validation:Optional
	URL string `json:"url,omitempty" protobuf:"bytes,45,opt,name=url"`
	// The name of the Predictor in the case that the Model has been released and deployed
	// +kubebuilder:validation:Optional
	PredictorName string `json:"predictorName,omitempty" protobuf:"bytes,46,opt,name=predictorName"`
	// The time at which the Model was set to release
	// +kubebuilder:validation:Optional
	ReleasedAt *metav1.Time `json:"releasedAt,omitempty" protobuf:"bytes,47,opt,name=releasedAt"`
	// The time at which the Model was set to release
	// +kubebuilder:validation:Optional
	PredictedAt *metav1.Time `json:"predictedAt,omitempty" protobuf:"bytes,48,opt,name=predictedAt"`
	// Sha256 of the model tar file
	// +kubebuilder:validation:Optional
	TarFileHash string `json:"tarFileHash,omitempty" protobuf:"bytes,49,opt,name=tarFileHash"`
	// Sha256 of the model image
	// +kubebuilder:validation:Optional
	ImageHash string `json:"imageHash,omitempty" protobuf:"bytes,50,opt,name=imageHash"`
	// TrainingDataHash specifies the hashes for datasets used by the Model
	// +kubebuilder:validation:Optional
	TrainingDataHash DataHashes `json:"trainingDataHash,omitempty" protobuf:"bytes,51,opt,name=trainingDataHash"`
	// TrainingResources details the resources that were consumed by the training workload
	// +kubebuilder:validation:Optional
	TrainingResources ResourceConsumption `json:"trainingResources,omitempty" protobuf:"bytes,52,opt,name=trainingResources"`
	// TestingResources details the resources that were consumed by the testing workload
	// +kubebuilder:validation:Optional
	TestingResources ResourceConsumption `json:"testingResources,omitempty" protobuf:"bytes,53,opt,name=testingResources"`
	// The Account which trained the model, derived from the parent Study
	// +kubebuilder:validation:Optional
	TrainedBy string `json:"trainedBy,omitempty" protobuf:"bytes,54,opt,name=trainedBy"`
	// The team of the Account which trained the model, derived from the parent Study
	// +kubebuilder:validation:Optional
	Team string `json:"team,omitempty" protobuf:"bytes,55,opt,name=team"`
