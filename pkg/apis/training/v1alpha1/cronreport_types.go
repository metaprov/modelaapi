...
// +kubebuilder:resource:path=cronreports,shortName=cpred,singular=cronreport,categories={training,modeld}
...
type CronReportStatus struct {
	...
	// +listMapKey=type
	//+kubebuilder:validation:Optional
	Conditions []CronReportCondition `json:"conditions,omitempty" patchStrategy:"merge" patchMergeKey:"type" protobuf:"bytes,4,rep,name=conditions"`
}
