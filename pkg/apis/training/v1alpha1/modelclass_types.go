...
type ModelClassDeploymentSpec struct {
	...
	// Prediction schedule
	// +kubebuilder:validation:Optional
	BatchPredictAt catalog.RunSchedule `json:"batchPredictAt,omitempty" protobuf:"bytes,8,opt,name=batchPredictAt"`
	// Schedule for computing drift
	// +kubebuilder:validation:Optional
	MonitorDriftAt catalog.RunSchedule `json:"monitorDriftAt,omitempty" protobuf:"bytes,9,opt,name=monitorDriftAt"`
