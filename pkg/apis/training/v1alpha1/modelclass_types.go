...
type ModelClassSpec struct {
	...
	// +kubebuilder:validation:Optional
	ReportAt catalog.RunSchedule `json:"reportAt,omitempty" protobuf:"bytes,13,opt,name=reportAt"`
}
...
type ModelClassTrainingSpec struct {
	...
	// +kubebuilder:validation:Optional
	RetrainAt catalog.RunSchedule `json:"retrainAt,omitempty" protobuf:"bytes,8,opt,name=retrainAt"`
}
