...
type ModelClassSpec struct {
	...
	// +kubebuilder:validation:Optional
	Prediction ModelClassPredictionSpec `json:"prediction,omitempty" protobuf:"bytes,9,opt,name=prediction"`
	// Define the labeling procedure for this model class
	// +kubebuilder:validation:Optional
	Labeling ModelClassLabelingSpec `json:"labeling,omitempty" protobuf:"bytes,10,opt,name=labeling"`
...
type LabelsDataSpec struct {
	...
	// +kubebuilder:validation:Optional
	JoinKey []string `json:"trainingPK,omitempty" protobuf:"bytes,3,opt,name=trainingPK"`
...
type ModelClassDeploymentSpec struct {
	...
	PredictionLocation data.DataLocation `json:"predictionLocation,omitempty" protobuf:"bytes,10,opt,name=predictionLocation"`
}
