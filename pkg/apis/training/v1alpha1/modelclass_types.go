...
type ModelClassSpec struct {
	...
	// +kubebuilder:validation:Optional
	BatchPrediction ModelClassBatchPredictionSpec `json:"batchPrediction,omitempty" protobuf:"bytes,10,opt,name=batchPrediction"`
...
type LabelsDataSpec struct {
	...
	// Tests to run on the labels file before training.
	// +kubebuilder:validation:Optional
...
type ModelClassBatchPredictionSpec struct {
