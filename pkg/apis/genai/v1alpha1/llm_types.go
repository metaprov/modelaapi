...
type LLMConditionType string

const (
	LLMSaved    LLMConditionType = "Saved"
	LLMDeployed LLMConditionType = "Deployed"
)
...
type LLMList struct {
	...
	Items           []LLM `json:"items" protobuf:"bytes,2,rep,name=items"`
}
...
type ModelServingSpec struct {
	...
	// The name of the query engine used to augment requests to the LLM.
