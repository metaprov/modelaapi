...
type NodePostProcessor struct {
	...
	// Rerank the nodes through a specialized API
	APIRerank *APIRerankSpec `json:"apiRerank,omitempty" protobuf:"bytes,6,opt,name=apiRerank"`
...
type APIRerankSpec struct {
	// The connection to a reranking API
