...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *APIRerankSpec) DeepCopyInto(out *APIRerankSpec) {
	*out = *in
	if in.TopN != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APIRerankSpec.
func (in *APIRerankSpec) DeepCopy() *APIRerankSpec {
	if in == nil {
		return nil
	}
	out := new(APIRerankSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KnowledgeBaseSpec) DeepCopyInto(out *KnowledgeBaseSpec) {
	*out = *in
	...
	if in.MaxConcurrentReaders != nil {
		in, out := &in.MaxConcurrentReaders, &out.MaxConcurrentReaders
		*out = new(int32)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LLMServerStatus) DeepCopyInto(out *LLMServerStatus) {
	*out = *in
	if in.Endpoints != nil {
		in, out := &in.Endpoints, &out.Endpoints
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LLMServerStatus.
func (in *LLMServerStatus) DeepCopy() *LLMServerStatus {
	if in == nil {
		return nil
	}
	out := new(LLMServerStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeParserSpec) DeepCopyInto(out *NodeParserSpec) {
	*out = *in
	...
	if in.Semantic != nil {
		...
		*out = new(SemanticNodeParserSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *NodePostProcessor) DeepCopyInto(out *NodePostProcessor) {
	*out = *in
	...
	if in.APIRerank != nil {
		in, out := &in.APIRerank, &out.APIRerank
		*out = new(APIRerankSpec)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QueryEngineTool) DeepCopyInto(out *QueryEngineTool) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QueryEngineTool.
func (in *QueryEngineTool) DeepCopy() *QueryEngineTool {
	if in == nil {
		return nil
	}
	out := new(QueryEngineTool)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RepositoryReaderSpec) DeepCopyInto(out *RepositoryReaderSpec) {
	*out = *in
	if in.UseDefaultReader != nil {
		in, out := &in.UseDefaultReader, &out.UseDefaultReader
		*out = new(bool)
		**out = **in
	}
	if in.Readers != nil {
...
func (in *RouterQueryEngineSpec) DeepCopyInto(out *RouterQueryEngineSpec) {
	*out = *in
	if in.Tools != nil {
		...
		*out = make([]QueryEngineTool, len(*in))
		copy(*out, *in)
	}
	if in.Selector != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SemanticNodeParserSpec) DeepCopyInto(out *SemanticNodeParserSpec) {
	*out = *in
	in.EmbeddingModel.DeepCopyInto(&out.EmbeddingModel)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SemanticNodeParserSpec.
func (in *SemanticNodeParserSpec) DeepCopy() *SemanticNodeParserSpec {
	if in == nil {
		return nil
	}
	out := new(SemanticNodeParserSpec)
