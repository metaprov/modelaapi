...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConcreteQueryEngineSpec) DeepCopyInto(out *ConcreteQueryEngineSpec) {
	*out = *in
	if in.Retriever != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConcreteQueryEngineSpec.
func (in *ConcreteQueryEngineSpec) DeepCopy() *ConcreteQueryEngineSpec {
	if in == nil {
		return nil
	}
	out := new(ConcreteQueryEngineSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConcreteRetrieverSpec) DeepCopyInto(out *ConcreteRetrieverSpec) {
	*out = *in
	if in.Vector != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConcreteRetrieverSpec.
func (in *ConcreteRetrieverSpec) DeepCopy() *ConcreteRetrieverSpec {
	if in == nil {
		return nil
	}
	out := new(ConcreteRetrieverSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FusionRetrieverSpec) DeepCopyInto(out *FusionRetrieverSpec) {
	*out = *in
	if in.Retrievers != nil {
		...
		*out = make([]ConcreteRetrieverSpec, len(*in))
		for i := range *in {
...
func (in *QueryEngineSpec) DeepCopyInto(out *QueryEngineSpec) {
	*out = *in
	in.ConcreteQueryEngineSpec.DeepCopyInto(&out.ConcreteQueryEngineSpec)
	if in.Router != nil {
...
func (in *RetrieverQueryEngine) DeepCopyInto(out *RetrieverQueryEngine) {
	*out = *in
	...
	in.Retriever.DeepCopyInto(&out.Retriever)
...
func (in *RetrieverSpec) DeepCopyInto(out *RetrieverSpec) {
	*out = *in
	in.ConcreteRetrieverSpec.DeepCopyInto(&out.ConcreteRetrieverSpec)
	if in.Router != nil {
		in, out := &in.Router, &out.Router
