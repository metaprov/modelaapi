...
func (in *APIKeyMetrics) DeepCopyInto(out *APIKeyMetrics) {
	*out = *in
	...
	if in.AverageDailyTokens != nil {
		in, out := &in.AverageDailyTokens, &out.AverageDailyTokens
		*out = new(int)
		**out = **in
	}
	if in.AverageDailyRequests != nil {
		in, out := &in.AverageDailyRequests, &out.AverageDailyRequests
		*out = new(int)
		**out = **in
	}
	if in.AverageDailyCost != nil {
		in, out := &in.AverageDailyCost, &out.AverageDailyCost
		*out = new(float32)
		**out = **in
	}
}
...
func (in *APIKeyStatus) DeepCopyInto(out *APIKeyStatus) {
	*out = *in
	...
	if in.QuotaRefreshedDate != nil {
		in, out := &in.QuotaRefreshedDate, &out.QuotaRefreshedDate
		*out = (*in).DeepCopy()
	}
	if in.KeyGenerated != nil {
		in, out := &in.KeyGenerated, &out.KeyGenerated
		*out = new(bool)
		**out = **in
	}
	if in.Metrics != nil {
